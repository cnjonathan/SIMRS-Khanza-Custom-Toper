                                                            ...
                                                            if($interval<0){
                                                                ...
                                                                if ($sisakuota < $jadwal['kuota']) {
                                                                    ...
                                                                    if ($querybooking) {
                                                                        ...
                                                                        // update umur
                                                                        $query_get_umur = getOneRow("select pasien.tgl_lahir from pasien where pasien.no_ktp='".validTeks4($decode['nik'],20)."' limit 1");
                                                                        if($query_get_umur){
                                                                            $tgl_lahir = $query_get_umur["tgl_lahir"];
                                                                            $tanggal_sekarang = validTeks4($decode['tanggalperiksa'],20);
                                                                            $lahir = new DateTime($tgl_lahir);
                                                                            $sekarang = new DateTime($tanggal_sekarang);
                                                                            $diff = $lahir->diff($sekarang);
                                                                            $umur_baru = $diff->y . " Th " . $diff->m . " Bl " . $diff->d . " Hr";
                                                                            $update=bukaquery2("update pasien set umur='$umur_baru' where no_ktp='".validTeks4($decode['nik'],20)."'");
                                                                        }
