...
public class DlgPilihPoli extends javax.swing.JDialog {
    ...
    private void tbAdminMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAdminMouseClicked
        if(tabmode.getRowCount()!=0){
            ...
            String query_kuota = "SELECT kuota FROM `jadwal` WHERE hari_kerja = '"+hari+"' AND kd_poli = '"+tbAdmin.getValueAt(tbAdmin.getSelectedRow(),0).toString()+"';";
            System.out.println("query_kuota: "+query_kuota);
            String query_jml = "SELECT COUNT(kd_poli) AS jml FROM reg_periksa WHERE tgl_registrasi = '"+formattedDate+"' AND kd_poli = '"+tbAdmin.getValueAt(tbAdmin.getSelectedRow(),0).toString()+"';";
            int jml = Sequel.cariInteger(query_jml);
            System.out.println("query_jml: "+query_jml);
            int quota = Sequel.cariInteger(query_kuota);
            int sisa = quota-jml;
            ...
            if(sisa <= 0){
                ...
                JOptionPane optionPane = new JOptionPane("<html><div align='center'><font size='5' face='Tahoma' color='#825082'>Kuota poli yang anda pilih sudah penuh, silahkan mendaftar di lain hari melalui aplikasi online (SiDol), supaya mendapatkan kuota pelayanan. </font></div></html>",
                ...
                Timer timer = new Timer(10000, new ActionListener() { // 10000 ms = 10 detik
                    @Override
    ...
    public void tampil(){
        ...
        try{
            ...
            try{                
                ...
                rs=ps.executeQuery(); 
                while(rs.next()){
                    // Mengecek apakah "semangka" ada di dalam array buah
                    if (Arrays.asList(blacklist_poli).contains(rs.getString(1))) {
                        System.out.println("kode poli blacklist: "+rs.getString(1));
                    } else {
