            ...
            if(TabRawatJalan.getSelectedIndex()==0){
                if(akses.getberi_obat()==true){
                    if(tabMode.getRowCount()==0){
                        ...
                        Sequel.queryu2("update view_anjungan set trace_progress= 'penyerahan_obat', penyerahan_obat_at=CURRENT_TIMESTAMP() where param_2=?",1,new String[]{
                            NoRawat
                        });
                        Sequel.queryu2("update view_anjungan set trace_progress= 'pulang', pulang_at=CURRENT_TIMESTAMP() where param_2=?",1,new String[]{
                            NoRawat
                        });
                        //############################//
                        //                            //
                        // kalau bpjs langsung pulang //
                        //                            //
                        //############################//
                        String kdpj = Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat = '"+NoRawat+"'; ");
                        if(kdpj == "001" ||
                           kdpj == "21"  ||
                           kdpj == "22"  ||
                           kdpj == "BP"  ||
                           kdpj == "BPJ")
                        {
                            System.out.println("BPJS langsung pulang");
                        }
                        JOptionPane.showMessageDialog(null,"Obat berhasil diserahkan");
                    }
                }else{
                    JOptionPane.showMessageDialog(null,"Maaf, Anda tidak punya hak akses untuk mengvalidasi...!!!!");
                    TCari.requestFocus();
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select \n" +
                                            ...
                                            "    'Belum Terlayani', 'Sudah Terlayani'\n" +
                                            "  ) as status, \n" +
                                            "  poliklinik.nm_poli, \n" +
                                            "  reg_periksa.kd_poli, \n" +
                                            "  penjab.png_jawab, \n" +
                                            ...
                                            "  ) as tgl_perawatan, \n" +
                                            "  if(\n" +
                                            "    resep_obat.jam = '00:00:00', '', resep_obat.jam\n" +
                                            "  ) as jam, \n" +
                                            "  if(\n" +
                                            ...
                                            "  ) as tgl_penyerahan, \n" +
                                            "  if(\n" +
                                            "    resep_obat.jam_penyerahan = '00:00:00', \n" +
                                            ...
                                            "where \n" +
                                            "  resep_obat.tgl_peresepan <> '0000-00-00' \n" +
                                            "  and resep_obat.status = 'ralan' \n" +
                                            "  and resep_obat.tgl_peresepan between ? \n" +
                                            "  and ?"+
                        (semua?"":"and dokter.nm_dokter like ? "
                                + "and poliklinik.nm_poli like ? "
                                + "and "+
                        "(resep_obat.no_resep like ? or "
                ...
                ps=koneksi.prepareStatement("select \n" +
                                            ...
                                            " where set_depo_ralan.kd_bangsal='"+DEPOAKTIFOBAT+"' and "+ 
                                            "  resep_obat.tgl_peresepan<>'0000-00-00' and "+ 
                                            "  resep_obat.status='ralan' and "+ 
                                            "  resep_obat.tgl_peresepan between ? and ? "+
                        (semua?"":"and dokter.nm_dokter like ? "
                                + "and poliklinik.nm_poli like ? "
                                + "and "+
                        "(resep_obat.no_resep like ? or "
            ...
            try{
                ...
                rs=ps.executeQuery();
                System.out.println("query daftar permintaan resep: "+ps.toString());
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    while(rs.next()){
                        String nm_poli = "", kd_poli = "";
                        PreparedStatement ps_internal = koneksi.prepareStatement("SELECT \n" +
                        ...
                        ps_internal.setString(1, rs.getString("no_rawat"));
                        ps_internal.setString(2, rs.getString("kd_dokter"));
