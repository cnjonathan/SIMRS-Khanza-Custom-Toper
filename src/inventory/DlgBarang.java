...
public class DlgBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPExpired.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2025" }));
        ...
        jLabel1.setBounds(770, 12, 80, 23);

        kategori_tarif_ina.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Obat", "Alkes", "Obat Kronis", "BMHP", "Obat Kemoterapi" }));
        kategori_tarif_ina.setName("kategori_tarif_ina"); // NOI18N
        FormInput.add(kategori_tarif_ina);
        kategori_tarif_ina.setBounds(860, 12, 160, 23);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Valid.editTabletf(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                ...
                String query_cek = "SELECT id_mapping_tarif_ina_barang FROM mapping_tarif_ina_barang WHERE kode_brng = '"+Kd.getText()+"'";
                try {
                    ps = koneksi.prepareStatement(query_cek);
                    rs = ps.executeQuery();
                    if(rs.next()){
                        String id_mapping = rs.getString("id_mapping_tarif_ina_barang");
                        String query_update = "UPDATE mapping_tarif_ina_barang SET kategori_tarif = '"+kategori_tarif_ina.getSelectedItem().toString()+"' WHERE id_mapping_tarif_ina_barang = '"+id_mapping+"'";
                        ...
                        String query_mapping = "INSERT INTO mapping_tarif_ina_barang (kode_brng, kategori_tarif) VALUES ('"+Kd.getText()+"', '"+kategori_tarif_ina.getSelectedItem().toString()+"')";
                ...
                tbObat.setValueAt(kategori_tarif_ina.getSelectedItem().toString(),tbObat.getSelectedRow(),32);
                emptTeks();
            }
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 26, new String[]{
                ...
                String query = "INSERT INTO mapping_tarif_ina_barang (kode_brng, kategori_tarif)\n" +
                            "VALUES ('"+Kd.getText()+"', '"+kategori_tarif_ina.getSelectedItem().toString()+"');";
                try {
                ...
                tabMode.addRow(new Object[]{
                    ...
                    tanggal,KdIF.getText(),NmIF.getText(),kdkategori.getText(),nmkategori.getText(),kdgolongan.getText(),nmgolongan.getText(),kategori_tarif_ina.getSelectedItem().toString()
                });
                LCount.setText("" + tabMode.getRowCount());
                emptTeks();
            }
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
            ...
            try {
                if(TCari.getText().trim().equals("")){
                    ...
                    ps = koneksi.prepareStatement(
                            ...
                            "  or databarang.status = '1' \n" +
                            "  and databarang.nama_brng like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and databarang.kode_sat like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and kodesatuan.satuan like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and databarang.kode_satbesar like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and satuanbesar.satuan like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and databarang.letak_barang like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and databarang.kdjns like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and kategori_barang.nama like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and golongan_barang.nama like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and jenis.nama like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and databarang.kode_industri like ? \n" +
                            "  or databarang.status = '1' \n" +
                            "  and industrifarmasi.nama_industri like ? \n" +
                            "order by \n" +
                            "  databarang.nama_brng");
                }
                ...
                try {
                    ...
                    // table autofit
                    for (int col = 0; col < tbObat.getColumnCount(); col++) {
                        ...
                        for (int row = 0; row < tbObat.getRowCount(); row++) {
                            TableCellRenderer renderer = tbObat.getCellRenderer(row, col);
                            Component comp = tbObat.prepareRenderer(renderer, row, col);
            ...
            try {
                ps = koneksi.prepareStatement(
                      "select \n" +
                        ...
                        "  databarang.isi, \n" +
                        "  data_batch.tgl_kadaluarsa as expire, \n" +
                        "  databarang.kode_industri, \n" +
                        "  industrifarmasi.nama_industri, \n" +
                        "  databarang.kode_kategori, \n" +
                        "  kategori_barang.nama as kategori, \n" +
                        ...
                        "where \n" +
                        "  data_batch.sisa > 0 \n" +
                        "  and data_batch.kode_brng like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        "  and databarang.nama_brng like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        "  and databarang.kode_sat like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        ...
                        "  and golongan_barang.nama like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        "  and data_batch.no_batch like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        "  and data_batch.no_faktur like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        "  and jenis.nama like ? \n" +
                        "  or data_batch.sisa > 0 \n" +
                        "  and databarang.kode_industri like ? \n" +
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            try {
                                ...
                                tabMode.addRow(new Object[]{false, "","    "+rs2.getString(2),": " + stokgudang, "", null,null,null,null,null, null, null, null, null, null, null, null, null, null, null, null,null,null, null,null,null,null,null,null,null,null,null,null});
                            } catch (Exception e) {
                                System.out.println("Notifikasi : " + e);
                            } finally{
                                if(rs3 != null){
                        ...
                        tabMode.addRow(new Object[]{false, "", "  Total Stok", ": " + totalstok, "", null,null,null,null,null, null, null, null, null, null, null, null, null, null, null, null, null,null, null,null,null,null,null,null,null,null});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally{
                        if(rs2 != null){
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        tabMode.addRow(new Object[]{false, "","    "+nmlokasi, ": " + stokgudang, "", null,null,null,null,null, null, null, null, null, null, null, null, null, null, null, null,null,null, null,null,null,null,null,null,null,null,null,null});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally{
                        if(rs3 != null){
            ...
            if(aktifkanbatch.equals("yes")){
                ...
                try {
                    ps4 = koneksi.prepareStatement(
                            ...
                            "  and detail_pemberian_obat.no_batch = data_batch.no_batch \n" +
                            "  and detail_pemberian_obat.no_faktur = data_batch.no_faktur \n" +
                            "  left join mapping_tarif_ina_barang on databarang.kode_brng = mapping_tarif_ina_barang.kode_brng \n" +
                            "where \n" +
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            if(!tbObat.getValueAt(tbObat.getSelectedRow(),32).toString().equals("-")){
                kategori_tarif_ina.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            }else{
                kategori_tarif_ina.setSelectedItem("Obat");
            }
        }
    }
