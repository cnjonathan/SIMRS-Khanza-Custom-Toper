...
//                column.setPreferredWidth(0);
    ...
    private void initComponents() {
        ...
        TTanggalSOAPIE = new javax.swing.JTextField();
        TJamSOAPIE = new javax.swing.JTextField();
        TMenitSOAPIE = new javax.swing.JTextField();
        TDetikSOAPIE = new javax.swing.JTextField();
        ...
        TTanggalSOAPIE.setText("jTextField1");
        TTanggalSOAPIE.setName("TTanggalSOAPIE"); // NOI18N

        TJamSOAPIE.setText("jTextField1");
        TJamSOAPIE.setName("TJamSOAPIE"); // NOI18N

        TMenitSOAPIE.setText("jTextField1");
        TMenitSOAPIE.setName("TMenitSOAPIE"); // NOI18N

        TDetikSOAPIE.setText("jTextField1");
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                if(sukses==true){
                    ...
                    if(RESEPRANAPKEPLAN.equals("yes")&&status.equals("ranap")&&(ubah==false)){
                        System.out.println("Simpan ke Plan Ranap");
                        try {
                            ps2=koneksi.prepareStatement(
                                "select \n" +
                            ...
                            try {
                                ps2.setString(1,TNoRw.getText());
                                ps2.setString(2,TTanggalSOAPIE.getText());
                                ps2.setString(3,TJamSOAPIE.getText()+":"+TMenitSOAPIE.getText()+":"+TDetikSOAPIE.getText());
                                ps2.setString(4,KdDokter.getText());
                                System.out.println("Query SOAPIE Ranap: "+ps2.toString());
                                rs2=ps2.executeQuery();
                                if(rs2.next()){
                                    System.out.println("SOAPIE Ranap ditemukan");
                                    resep="Resep : \n";
                                    psresep=koneksi.prepareStatement(
                                           "select databarang.nama_brng,resep_dokter.jml,resep_dokter.aturan_pakai from databarang inner join resep_dokter on databarang.kode_brng=resep_dokter.kode_brng where resep_dokter.no_resep=?");                                   
                                    try {
                                    ...
                                    Sequel.queryu2("update \n" +
                                                    ...
                                                    "  and tgl_perawatan = ? \n" +
                                                    "  and jam_rawat = ? \n" +
                                                    "  and nip = ?",5,new String[]{
                                        resep,TNoRw.getText(),rs2.getString("tgl_perawatan"),rs2.getString("jam_rawat"),KdDokter.getText()
                                    });
                                    System.out.println("SOAPIE Ranap diupdate");
                                }
                            } catch (Exception e) {
                                System.out.println("Notif : "+e);
                            } finally{
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    private javax.swing.JTextField TDetikSOAPIE;
    private javax.swing.JTextField TJamSOAPIE;
    private javax.swing.JTextField TMenitSOAPIE;
    private widget.TextBox TNoRw;
    private widget.TextBox TPasien;
    private javax.swing.JTextField TTanggalSOAPIE;
...
//                DTPBeri.getSelectedItem().toString().substring(6,10)+DTPBeri.getSelectedItem().toString().substring(3,5)+DTPBeri.getSelectedItem().toString().substring(0,2),4,NoResep);
            Valid.autoNomer3(
                    "select ifnull(MAX(CONVERT(RIGHT(resep_obat.no_resep,4),signed)),0) from resep_obat where LEFT(resep_obat.no_resep,8)='"+
                            DTPBeri.getSelectedItem().toString().substring(6,10)+DTPBeri.getSelectedItem().toString().substring(3,5)+
                            DTPBeri.getSelectedItem().toString().substring(0,2)+
                            "' ",
                DTPBeri.getSelectedItem().toString().substring(6,10)+DTPBeri.getSelectedItem().toString().substring(3,5)+
                        DTPBeri.getSelectedItem().toString().substring(0,2),4,NoResep);        
        } 
    }
    ...
    public void setTanggalWaktuResep(String tanggal, String jam, String menit, String detik){
        TTanggalSOAPIE.setText(tanggal);
        TJamSOAPIE.setText(jam);
        TMenitSOAPIE.setText(menit);
        TDetikSOAPIE.setText(detik);
    }
