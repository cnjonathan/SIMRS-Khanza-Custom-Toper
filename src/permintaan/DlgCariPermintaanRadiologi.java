...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter.getTable().getSelectedRow()!= -1){ 
                    if(TabPilihRawat.getSelectedIndex()==0){
                        ...
                        CrDokter2.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),2).toString());
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-07-2024 09:09:18" }));
...
//        this.setCursor(Cursor.getDefaultCursor());
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                try {
                    Desktop.getDesktop().browse(new URL(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(), 18).toString()).toURI());
                } catch (MalformedURLException ex) {
                    Logger.getLogger(DlgCariPermintaanRadiologi.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(!NoRawat.equals("")){
                try {
                    Desktop.getDesktop().browse(new URL(tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(), 16).toString()).toURI());
                } catch (MalformedURLException ex) {
                    Logger.getLogger(DlgCariPermintaanRadiologi.class.getName()).log(Level.SEVERE, null, ex);
                } catch (URISyntaxException ex) {
                    Logger.getLogger(DlgCariPermintaanRadiologi.class.getName()).log(Level.SEVERE, null, ex);
    ...
    */
    ...
    private void tampil() {
        ...
        try {
            boolean semua = (CrDokter.getText() == null || CrDokter.getText().trim().equals("")) &&
                            (CrPoli.getText() == null || CrPoli.getText().trim().equals("")) &&
                            (TCari.getText() == null || TCari.getText().trim().equals(""));
            ...
            ps = koneksi.prepareStatement(
                ...
                "  view_anjungan.no_sep,\n" +
                "  view_anjungan.type_booking,\n" +
                "  hasil_pacs_radiologi.link_ris\n" +
                "from \n" +
                ...
                "  left join hasil_pacs_radiologi on permintaan_radiologi.no_rawat = hasil_pacs_radiologi.no_rawat and permintaan_radiologi.noorder = hasil_pacs_radiologi.no_order \n" +
                "where \n" +
                "  permintaan_radiologi.status = 'ralan' \n" +
                "  and permintaan_radiologi.tgl_permintaan between ?\n" +
                "  and ? " +
            ...
            try {
                ...
                if (!semua) {
                    ps.setString(3, "%" + (CrDokter.getText() != null ? CrDokter.getText().trim() : "") + "%");
                    ps.setString(4, "%" + (CrPoli.getText() != null ? CrPoli.getText().trim() : "") + "%");
                    ps.setString(5, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                    ps.setString(6, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                    ps.setString(7, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                    ps.setString(8, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                    ps.setString(9, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                    ps.setString(10, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                    ps.setString(11, "%" + (TCari.getText() != null ? TCari.getText() : "") + "%");
                }
                ...
                while (rs.next()) {
                    if(rs.getString("type_booking") != null){
                        switch (rs.getString("type_booking")) {
                            ...
                            case "jkn":
                                ...
                                break;
                            case "anjungan":
                                type_booking = "Mesin Anjungan";
                                break;
                            case "petugas_registrasi":
                                type_booking = "Petugas Regis";
                                break;
                            default:
                                type_booking = "-";
                                break;
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        type_booking,
                        rs.getString("link_ris") != null ? rs.getString("link_ris") : "-"
                    });
                    ps2 = koneksi.prepareStatement(
                        "select permintaan_pemeriksaan_radiologi.kd_jenis_prw,jns_perawatan_radiologi.nm_perawatan " +
                        "from permintaan_pemeriksaan_radiologi inner join jns_perawatan_radiologi on " +
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                        ...
                        "  dokter.nm_dokter, \n" +
                        "  ifnull(\n" +
                        "    bangsal.nm_bangsal, 'Ranap Gabung'\n" +
                        "  ) as nm_bangsal, \n" +
                        "  permintaan_radiologi.informasi_tambahan, \n" +
                        "  permintaan_radiologi.diagnosa_klinis, \n" +
                        "  hasil_pacs_radiologi.link_ris \n" +
                        ...
                        "  left join hasil_pacs_radiologi on permintaan_radiologi.no_rawat = hasil_pacs_radiologi.no_rawat and permintaan_radiologi.noorder = hasil_pacs_radiologi.no_order \n" +
                        "where \n" +
                        "  permintaan_radiologi.status = 'ranap' \n" +
                        "  and permintaan_radiologi.tgl_permintaan between ? \n" +
                        "  and ? "+
