...
public class DlgPermintaanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-01-2026" }));
        ...
        Diagnosa.setBounds(80, 100, 213, 23);
        ...
        Catatan.setBounds(380, 100, 228, 23);

        jLabel14.setText("Catatan :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(320, 100, 60, 23);

        jLabel16.setText("Permintaan ke Kamar :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(630, 40, 120, 23);

        cmbKamar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bangsal", "Isolasi", "Intensif" }));
        cmbKamar.setName("cmbKamar"); // NOI18N
        FormInput.add(cmbKamar);
        cmbKamar.setBounds(760, 40, 200, 22);
...
//        }
            ...
            if(Sequel.menyimpantf("permintaan_ranap","?,?,?,?,?","Pasien",5,new String[]{
                NoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbKamar.getSelectedItem().toString(),Diagnosa.getText(),Catatan.getText()
            })==true){
                tampil();
        ...
        if(NoRw.getText().trim().equals("")||NoRM.getText().trim().equals("")||NmPasien.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()> -1){
                if(Sequel.mengedittf("permintaan_ranap","no_rawat=?","no_rawat=?,tanggal=?,kd_kamar=?,diagnosa=?,catatan=?",6,new String[]{
                    NoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbKamar.getSelectedItem().toString(),Diagnosa.getText(),Catatan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    // Sequel.mengedit("kamar","kd_kamar=?","status='DIBOOKING'",1,new String[]{KdKamar.getText()});
                    emptTeks();
