...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private String pilihan="",alarm="",formalarm="",nol_detik,detik,tglsampel="",tglhasil="",norm="",kamar="",namakamar="",la="",ld="",pa="",pd="",InformasiTambahan,DiagnosaKlinis,
                    NoPermintaan="",NoRawat="",Pasien="",Permintaan="",JamPermintaan="",Sampel="",JamSampel="",Hasil="",JamHasil="",KodeDokter="",DokterPerujuk="",Ruang="",json="",finger="", type_booking="";
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-07-2024 10:41:04" }));
        ...
        BtnKirimLISELIMS.setText("Kirim Permintaan ke Miracle");
        ...
        BtnAmbilLISELIMS.setText("Ambil Hasil dari Miracle");
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                            "select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_lab.tgl_permintaan,pasien.tgl_lahir,"+
                            "permintaan_lab.jam_permintaan,pasien.alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,pasien.no_tlp,"+
                        ...
                        try {
                            ...
                            if(rs.next()){
                                koneksielims.prepareStatement(
                                        ...
                                        "'"+rs.getString("nm_pasien")+"','"+rs.getString("no_tlp")+"','"+rs.getString("jk")+"','"+rs.getString("tmp_lahir")+"','"+rs.getString("tgl_lahir")+"',"+
                                ...
                                try {
                                    ps2.setString(1,NoPermintaan);
                                    System.out.println("permintaan_detail_permintaan_lab: "+ps2.toString());
                                    rs2=ps2.executeQuery();
                                    while(rs2.next()){
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                            ...
                            "pasien.no_tlp,permintaan_lab.diagnosa_klinis,permintaan_lab.status,reg_periksa.kd_pj,penjab.png_jawab "+
                            "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                            "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter "+
                            "inner join kamar_inap on reg_periksa.no_rawat=kamar_inap.no_rawat "+
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "  if(\n" +
                    "    permintaan_lab.jam_permintaan = '00:00:00', \n" +
                    "    '', permintaan_lab.jam_permintaan\n" +
                    "  ) as jam_permintaan, \n" +
                    "  reg_periksa.kd_pj, \n" +
                    "  penjab.png_jawab, \n" +
                    "  if(\n" +
                    "    permintaan_lab.tgl_sampel = '0000-00-00', \n" +
                    "    '', permintaan_lab.tgl_sampel\n" +
                    "  ) as tgl_sampel, \n" +
                    "  if(\n" +
                    "    permintaan_lab.jam_sampel = '00:00:00', \n" +
                    "    '', permintaan_lab.jam_sampel\n" +
                    "  ) as jam_sampel, \n" +
                    "  if(\n" +
                    "    permintaan_lab.tgl_hasil = '0000-00-00', \n" +
                    "    '', permintaan_lab.tgl_hasil\n" +
                    "  ) as tgl_hasil, \n" +
                    "  if(\n" +
                    "    permintaan_lab.jam_hasil = '00:00:00', \n" +
                    ...
                    "  inner join poliklinik on reg_periksa.kd_poli = poliklinik.kd_poli \n" +
                    "  inner join penjab on reg_periksa.kd_pj = penjab.kd_pj \n" +
                    "  left join view_anjungan on permintaan_lab.no_rawat = view_anjungan.param_2\n" +
                    "where \n" +
                    "  permintaan_lab.status = 'ralan' \n" +
                    "  and permintaan_lab.tgl_permintaan between ? \n" +
                    "  and ?"+
