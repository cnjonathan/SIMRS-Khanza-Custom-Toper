    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "  if(\n" +
                    "    permintaan_labpa.jam_permintaan = '00:00:00', \n" +
                    "    '', permintaan_labpa.jam_permintaan\n" +
                    "  ) as jam_permintaan, \n" +
                    "  reg_periksa.kd_pj, \n" +
                    "  penjab.png_jawab, \n" +
                    "  if(\n" +
                    "    permintaan_labpa.tgl_sampel = '0000-00-00', \n" +
                    "    '', permintaan_labpa.tgl_sampel\n" +
                    "  ) as tgl_sampel, \n" +
                    "  if(\n" +
                    "    permintaan_labpa.jam_sampel = '00:00:00', \n" +
                    "    '', permintaan_labpa.jam_sampel\n" +
                    "  ) as jam_sampel, \n" +
                    "  if(\n" +
                    "    permintaan_labpa.tgl_hasil = '0000-00-00', \n" +
                    "    '', permintaan_labpa.tgl_hasil\n" +
                    "  ) as tgl_hasil, \n" +
                    "  if(\n" +
                    "    permintaan_labpa.jam_hasil = '00:00:00', \n" +
                    ...
                    "  if(\n" +
                    "    permintaan_labpa.tanggal_pa_sebelumnya = '0000-00-00', \n" +
                    "    '', permintaan_labpa.tanggal_pa_sebelumnya\n" +
                    "  ) as tanggal_pa_sebelumnya, \n" +
                    ...
                    "where \n" +
                    "  permintaan_labpa.status = 'ralan' \n" +
                    "  and permintaan_labpa.tgl_permintaan between ? \n" +
                    "  and ?"+
