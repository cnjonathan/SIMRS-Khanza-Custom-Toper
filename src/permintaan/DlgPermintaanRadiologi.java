    ...
    private void isPsien(){
        try {
            ...
            try {
                ...
                Alamat.setText(rs.getString("alamat")+detail_alamat_pasien);
            } catch (Exception e) {
                System.out.println("error isPasien: "+e);
            }finally{
                if(rs_satu_sehat_detail_pasien !=null){
                    rs_satu_sehat_detail_pasien .close();
                }
                if(ps_satu_sehat_detail_pasien !=null){
                    ps_satu_sehat_detail_pasien .close();
                }
            }
