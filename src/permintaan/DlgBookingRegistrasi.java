        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptBookingRegistrasi.jasper","report","::[ Laporan Daftar Booking Registrasi ]::",
                "select booking_registrasi.tanggal_booking,booking_registrasi.jam_booking,booking_registrasi.no_rkm_medis, "+
                    ...
                    "pasien.namakeluarga,concat(pasien.alamat,', ',ifnull(kelurahan.nm_kel,''),', ',ifnull(kecamatan.nm_kec,''),', ',ifnull(kabupaten.nm_kab,''))as alamatpj,pasien.kelurahanpj,pasien.kecamatanpj,pasien.no_tlp,"+
...
//                    Sequel.queryu2("update view_anjungan set trace_progress= 'checkin', checkin_at=CURRENT_TIMESTAMP() where param_1=? and param_2=?",2,new String[]{
//                        tbObat.getValueAt(i,3).toString(),
//                        no_rawat
//                    });
                }
