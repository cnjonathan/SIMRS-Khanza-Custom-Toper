    ...
    private void tampil() {
        ...
        try {
            ...
            if (ChkBelumTerkirim.isSelected() == true) {
                ...
                belumterkirim = " satu_sehat_allergy.id_allergy IS NOT NULL and ";
            }
            ps = koneksi.prepareStatement(
                    ...
                    "  alergi_pasien.note, "+
                    "  DATE_FORMAT("+
                    "    alergi_pasien.tgl_perawatan, '%Y-%m-%dT%H:%i:%s+00:00'"+
                    "  ) AS tgl_perawatan, "+
                    ...
                    "  LEFT JOIN pegawai AS petugas ON petugas.nik = alergi_pasien.nippetugas "
            ...
            try {
                ...
                System.out.println("Query Satu Sehat Kirim Allergy Intollerance: "+ps.toString());
                rs = ps.executeQuery();
                while (rs.next()) {
