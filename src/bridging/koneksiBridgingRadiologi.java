 ...
 * @author khanzasoft
 */
public class koneksiBridgingRadiologi {
    private static Connection connection=null;
    private static final Properties prop = new Properties();  
    private static final MysqlDataSource dataSource=new MysqlDataSource();
    
    public koneksiBridgingRadiologi(){} 
    public static Connection condb(){ 
        if(connection == null){
            try{
                ...
                System.out.println("  Koneksi Briding Radiologi Berhasil. Menyambungkan ke database bridging radiologi...!!!");
            }catch(Exception e){
