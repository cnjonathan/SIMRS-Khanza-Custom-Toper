...
public class ApiSatuSehat {        
    ...
    public String TokenSatuSehat(){
        ...
        //    System.out.println("entity: "+"client_id="+clientid+"&client_secret="+key);
        ...
        try {
            ...
            String header = "client_id="+clientid+"&client_secret="+key;
            RequestBody body = RequestBody.create(mediaType,header);
            // System.out.println("Header: "+header);
            Request request = new Request.Builder()
              .url(urlauth+"/accesstoken?grant_type=client_credentials")
              .method("POST", body)
              .addHeader("Content-Type", "application/x-www-form-urlencoded")
              .build();
            Response response = client.newCall(request).execute();
            String response_satusehat_token_body = response.body().string();
            // ambil balikan root nya dulu
            JsonObject root_satusehat_token = JsonParser.parseString(response_satusehat_token_body).getAsJsonObject();
            String access_token = root_satusehat_token.get("access_token").getAsString();
            token = access_token;
        } catch (Exception e) {
            System.out.println("API Token error: "+e);
        }
        return token;
    }
