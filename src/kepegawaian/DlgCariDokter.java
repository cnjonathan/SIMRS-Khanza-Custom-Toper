...
public final class DlgCariDokter extends javax.swing.JDialog {
    ...
    public DlgCariDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Dokter","IHS","Nama Dokter","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Alamat Tinggal","No.HP/Telp","Stts.Nikah","Spesialis","Alumni","No.Ijin Praktek", "KTP"};
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "  left join pegawai on dokter.kd_dokter = pegawai.nik \n" +
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString(1),rs.getString(15),rs.getString(2),rs.getString(3),
                        rs.getString(4),rs.getString(5),rs.getString(6),
                        rs.getString(7),rs.getString(8),rs.getString(9),
                        rs.getString(10),rs.getString(11),rs.getString(12),
                        rs.getString(13), rs.getString(14)
                    });
                    iyem=iyem+"{\"KodeDokter\":\""+rs.getString(1)
                                +"\",\"IHS\":\""+rs.getString(15)
                                +"\",\"NamaDokter\":\""+rs.getString(2).replaceAll("\"","")
                                +"\",\"JK\":\""+rs.getString(3)
                                +"\",\"TmpLahir\":\""+rs.getString(4).replaceAll("\"","")
                                +"\",\"TglLahir\":\""+rs.getString(5)
                                +"\",\"GD\":\""+rs.getString(6)
                                +"\",\"Agama\":\""+rs.getString(7)
                                +"\",\"AlamatTinggal\":\""+rs.getString(8).replaceAll("\"","")
                                +"\",\"NoTelp\":\""+rs.getString(9)
                                +"\",\"SttsNikah\":\""+rs.getString(10)
                                +"\",\"Spesialis\":\""+rs.getString(11)
                                +"\",\"Alumni\":\""+rs.getString(12).replaceAll("\"","")
                                +"\",\"NoIjinPraktek\":\""+rs.getString(13)
                                +"\",\"NoKTP\":\""+rs.getString(14)
                                +"\"},";
                }
            }catch(Exception e){
                ...
                if(TCari.getText().trim().equals("")){
                    for(JsonNode list:response){
                        tabMode.addRow(new Object[]{
                            ...
                            list.path("IHS").asText(),
                            list.path("NamaDokter").asText(),
                            list.path("JK").asText(),
                            list.path("TmpLahir").asText(),
                            list.path("TglLahir").asText(),
                            list.path("GD").asText(),
                            list.path("Agama").asText(),
                            list.path("AlamatTinggal").asText(),
                            list.path("NoTelp").asText(),
                            list.path("SttsNikah").asText(),
                            list.path("Spesialis").asText(),
                            list.path("Alumni").asText(),
                            list.path("NoIjinPraktek").asText()
                        });
                    }
                }else{
                    for(JsonNode list:response){
