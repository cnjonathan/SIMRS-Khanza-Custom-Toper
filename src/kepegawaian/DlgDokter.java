...
public class DlgDokter extends javax.swing.JDialog {
    ...
    private String link_satu_sehat="";
    ...
    private void initComponents() {
        ...
        BtnSyncSatuSehat = new widget.Button();
        ...
        PractitionerIHS = new widget.TextBox();
        ...
        BtnAll.setBounds(520, 10, 100, 30);

        jLabel10.setText("Record :");
        jLabel10.setName("jLabel10"); // NOI18N
        panelGlass6.add(jLabel10);
        jLabel10.setBounds(795, 10, 50, 30);

        LCount.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LCount.setText("0");
        LCount.setName("LCount"); // NOI18N
        panelGlass6.add(LCount);
        LCount.setBounds(850, 10, 60, 30);
        ...
        BtnKeluar.setBounds(920, 10, 100, 30);

        BtnSyncSatuSehat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/refresh.png"))); // NOI18N
        BtnSyncSatuSehat.setMnemonic('M');
        BtnSyncSatuSehat.setText("Sync Satu Sehat");
        BtnSyncSatuSehat.setToolTipText("Alt+M");
        BtnSyncSatuSehat.setName("BtnSyncSatuSehat"); // NOI18N
        BtnSyncSatuSehat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSyncSatuSehatActionPerformed(evt);
            }
        });
        BtnSyncSatuSehat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnSyncSatuSehatKeyPressed(evt);
            }
        });
        panelGlass6.add(BtnSyncSatuSehat);
        BtnSyncSatuSehat.setBounds(630, 10, 140, 30);
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2025" }));
        ...
        jLabel23.setBounds(630, 70, 40, 23);
        ...
        FormInput.add(KTP);
        KTP.setBounds(673, 70, 190, 23);

        jLabel24.setText("Practitioner IHS :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(900, 12, 90, 23);

        PractitionerIHS.setHighlighter(null);
        PractitionerIHS.setName("PractitionerIHS"); // NOI18N
        PractitionerIHS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PractitionerIHSKeyPressed(evt);
            }
        });
        FormInput.add(PractitionerIHS);
        PractitionerIHS.setBounds(1000, 12, 190, 23);
        ...
        jTextArea1.setText("Untuk tambah atau mengganti data dokter dengan IHS number, masukkan KTP terlebih dahulu, kemudian klik Sync Satu Sehat, maka Practitioner IHS akan muncul ID Dokter dari Satu Sehat atau IHS Numbernya, kemudian klik Simpan atau Ganti");
        jTextArea1.setWrapStyleWord(true);
        jTextArea1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 204, 204), 2, true), "Tips"));
        jTextArea1.setName("jTextArea1"); // NOI18N
        jScrollPane1.setViewportView(jTextArea1);

        FormInput.add(jScrollPane1);
        jScrollPane1.setBounds(910, 40, 280, 130);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
        ...
        }else if(KTP.getText().trim().equals("-") || KTP.getText().trim().equals("")){
            ...
            try { 
                ...
                // aksi jika satu sehat practitioner tidak ada
                if(PractitionerIHS.getText().equals("")){
                    notif_auto_close("Nomor IHS Dokter Satu Sehat tidak ada.");
                    PractitionerIHS.requestFocus();
                }else{
                    String query_update = "INSERT INTO satu_sehat_practitioner(\n" +
                                            "  nik, \n" +
                                            "  practitioner_ihs \n" +
                                            ") \n" +
                                            "VALUES \n" +
                                            "  (\n" +
                                            "    '"+TKd.getText()+"', \n" +
                                            "    '"+PractitionerIHS.getText()+"' \n" +
                                            "  );";
                    ps=koneksi.prepareStatement(query_update);
                    // ps.executeUpdate();
                    System.out.println("Menyimpan IHS Practitioner ke database");
                    int affected_row = ps.executeUpdate();
                    if(affected_row > 0){
                        notif_auto_close("Simpan berhasil, IHS Practitioner Satu Sehat tersimpan.");
                    }else{
                        notif_auto_close("Ada kesalahan simpan data IHS Practitioner Satu Sehat. Silahkan hubungi IT.");
                    }
                }
                tampil();
                emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            try { 
                ...
                String check_ihs_number = Sequel.cariIsi("SELECT practitioner_ihs FROM satu_sehat_practitioner WHERE nik = '"+TKd.getText()+"'");
                String query_update = "";
                if(check_ihs_number.equals("")){
                    query_update = "INSERT INTO satu_sehat_practitioner(\n" +
                                    "  nik, \n" +
                                    "  practitioner_ihs \n" +
                                    ") \n" +
                                    "VALUES \n" +
                    ...
                    query_update = "UPDATE satu_sehat_practitioner \n" +
                                    "SET practitioner_ihs = '"+PractitionerIHS.getText()+"' \n" +
                                    "WHERE nik = '"+TKd.getText()+"';";
                    ps=koneksi.prepareStatement(query_update);
                    ps.executeUpdate();
                }
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnSyncSatuSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSyncSatuSehatActionPerformed
        sync_satu_sehat();
    }//GEN-LAST:event_BtnSyncSatuSehatActionPerformed

    private void BtnSyncSatuSehatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSyncSatuSehatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSyncSatuSehatKeyPressed

    private void KTPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KTPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KTPKeyPressed

    private void PractitionerIHSKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PractitionerIHSKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PractitionerIHSKeyPressed
    ...
    */
    ...
    private widget.Button BtnSyncSatuSehat;
    ...
    private widget.TextBox PractitionerIHS;
        ...
        try {
            stat=koneksi.prepareStatement(
                   "select \n" +
                    ...
                    "  dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.kd_dokter like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    ...
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.tmp_lahir like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.tgl_lahir like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.agama like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.almt_tgl like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.no_telp like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    ...
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and spesialis.nm_sps like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.alumni like ? \n" +
                    "  or dokter.status = '1' \n" +
                    "  and dokter.jk like ? \n" +
                    "  and dokter.gol_drh like ? \n" +
                    "  and dokter.stts_nikah like ? \n" +
                    "  and dokter.no_ijn_praktek like ? \n" +
                    "order by \n" +
                    "  dokter.kd_dokter");
            try{
                ...
                // table autofit
                for (int col = 0; col < tbDokter.getColumnCount(); col++) {
                    TableColumn column = tbDokter.getColumnModel().getColumn(col);
                    int maxWidth = 50; // minimal lebar kolom

                    for (int row = 0; row < tbDokter.getRowCount(); row++) {
                        TableCellRenderer renderer = tbDokter.getCellRenderer(row, col);
                        Component comp = tbDokter.prepareRenderer(renderer, row, col);
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            PractitionerIHS.setText(tbDokter.getValueAt(row,1).toString());
        }
    }
        ...
        if(TKd.getText().trim().equals("")){
            ...
            try { 
                ...
                Request request = new Request.Builder()
                  .url(link_satu_sehat+"/Practitioner?identifier=https://fhir.kemkes.go.id/id/nik|"+KTP.getText()+"")
                  .method("GET", null)
                ...
                if(response.isSuccessful()){
                    ...
                    if(total > 0){
                        JsonArray data_practitioner = root.getAsJsonArray("entry");
                        JsonObject practitioner_object = data_practitioner.get(0).getAsJsonObject();
                        JsonObject resource_object = practitioner_object.get("resource").getAsJsonObject();
                        String practitioner_ihs = resource_object.get("id").getAsString();
                        PractitionerIHS.setText(practitioner_ihs);
                    }else{
                        notif_auto_close("NIK Dokter tidak ditemukan");
                    }
                }else{
