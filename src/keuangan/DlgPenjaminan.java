...
//                    if(i==0){
                        ...
                        txtNoNota.setText(tbNota.getValueAt(tbNota.getSelectedRow(), 2).toString());
                        txtNoSurat.setText(tbNota.getValueAt(tbNota.getSelectedRow(), 3).toString());
                        txtNoRm.setText(tbNota.getValueAt(tbNota.getSelectedRow(), 4).toString());
                        txtSep.setText(tbNota.getValueAt(tbNota.getSelectedRow(), 1).toString());
//                    }
...
//                            proses.isTutup();
                            ...
                            proses.setData(
                                    ...
                                    tbNota.getValueAt(tbNota.getSelectedRow(), 4).toString(),
...
//                    throw new AssertionError();
            ...
            System.out.println("Status Lanjut: "+cmbStatusLanjut.getSelectedItem().toString());
            switch (cmbStatusLanjut.getSelectedItem().toString()) {
                case "Semua":
                    status_lanjut = "";
                    break;
                case "Ralan":
                    status_lanjut = " AND rp.status_lanjut = 'Ralan' ";
                    break;
                case "Ranap":
                    status_lanjut = " AND rp.status_lanjut = 'Ranap' ";
                    break;
                default:
                    status_lanjut = "";
            }
            ...
            String query_tampil = "SELECT "+
                                    "  rp.no_rawat, "+
                                    "  bs.no_sep, "+
                                    "  IFNULL(nj.no_nota, IFNULL(ni.no_nota, 'Belum Ada')) AS no_nota, "+
            ...
            try {
                rs=ps.executeQuery();
                while(rs.next()){
//                    System.out.println("cek: "+rs.getString(1)+" - "+
//                        rs.getString(2)+" - "+
//                        rs.getString(3)+" - "+
//                        rs.getString(4)+" - "+
//                        rs.getString(5)+" - "+
...
//                        rs.getString(9));
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString(6),
                        rs.getString(7),
                        rs.getString("status_lanjut")+" - "+rs.getString(8),
                        rs.getString(9),
                        rs.getString(10)
                    });
                 }
