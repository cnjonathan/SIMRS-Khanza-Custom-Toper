...
public final class DlgJnsPerawatanLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kategori_tarif_ina.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laboratorium", "Pelayanan Darah" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("jns_perawatan_lab","?,?,?,?,?,?,?,?,?,?,?,?,?,?","Kode Periksa",14,new String[]{
                ...
                String query = "INSERT INTO mapping_tarif_ina_lab (kd_jenis_prw, kategori_tarif)\n" +
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            String query_cek = "SELECT id_mapping_tarif_ina_kamar FROM mapping_tarif_ina_kamar WHERE kd_kamar = '"+TKd.getText()+"'";
            try {
                ps = koneksi.prepareStatement(query_cek);
                rs = ps.executeQuery();
                if(rs.next()){
                    String id_mapping = rs.getString("id_mapping_tarif_ina_lab");
                    String query_update = "UPDATE mapping_tarif_ina_lab SET kategori_tarif = '"+kategori_tarif_ina.getSelectedItem().toString()+"' WHERE id_mapping_tarif_ina_lab = '"+id_mapping+"'";
                    ...
                    String query_mapping = "INSERT INTO mapping_tarif_ina_lab (kd_jenis_prw, kategori_tarif) VALUES ('"+TKd.getText()+"', '"+kategori_tarif_ina.getSelectedItem().toString()+"')";
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                        ...
                        "  and (\n" +
                        "    jns_perawatan_lab.kd_jenis_prw like ? \n" +
                        "    or jns_perawatan_lab.nm_perawatan like ? \n" +
                        "    or jns_perawatan_lab.kelas like ? \n" +
                        "    or penjab.png_jawab like ? \n" +
                        "    or jns_perawatan_lab.kategori like ?\n" +
                        "  ) \n" +
                        "order by \n" +
                        "  jns_perawatan_lab.kd_jenis_prw");
            try {    
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            if(!tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString().equals("-")){
                ...
                kategori_tarif_ina.setSelectedItem("Laboratorium");
            }
            BagianRs.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString())));
            Bhp.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),5).toString())));
            JMPerujuk.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),6).toString())));
            JMDokter.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),7).toString())));
            JMLaborat.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),8).toString())));
            ...
            TotalBiaya.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),11).toString())));
            ...
            nmpnj.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),12).toString());
            Kelas.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),13).toString());
            Kategori.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),14).toString());
        }
    }
