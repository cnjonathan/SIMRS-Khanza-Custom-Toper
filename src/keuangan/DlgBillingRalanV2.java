 ...
 * @author perpustakaan
 */
public class DlgBillingRalanV2 extends javax.swing.JDialog {
    ...
    private double ttl=0,y=0,subttl=0,ralanparamedis=0,piutang=0,itembayar=0,itempiutang=0, 
                   ...
                   kekurangan=0,obatlangsung,uangdeposit=0,sisadeposit=0;
    ...
    private String nota_jalan="",dokterrujukan="",polirujukan="",status="",biaya="",tambahan="",totals="",kdptg="",nmptg="",kd_pj="",notaralan="",centangdokterralan="",
            ...
            Uang_Muka_Ranap="",Sisa_Uang_Muka_Ranap="",
     ...
     * @param parent
     * @param modal */
    public DlgBillingRalanV2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            psrekening=koneksi.prepareStatement(
                    "select set_akun_ranap2.Uang_Muka_Ranap,set_akun_ranap2.Sisa_Uang_Muka_Ranap from set_akun_ranap2");
            try {
                rsrekening=psrekening.executeQuery();
                if(rsrekening.next()){
                ...
                System.out.println("Notifikasi Rekening Uang Muka : "+e);
            } finally{
                if(rsrekening!=null){
                    rsrekening.close();
                }
        ...
        deposit.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgBilingRalan") || akses.getform().equals("DlgBillingRalanV2")){
                    uangdeposit=getNetDeposit(TNoRw.getText());
                    if (Deposit != null) Deposit.setText(Valid.SetAngka(uangdeposit));
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-08-2026 08:59:53" }));
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnNotaActionPerformed
            if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                ...
                try{
                    ...
                    double deposit_terpakai_print = Math.min(uangdeposit, bayar);
                    double sisadeposit_print = Math.max(0, uangdeposit - bayar);
                    if(piutang<=0){                        
                        Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        Sequel.menyimpan("temporary_bayar_ralan","'0','TOTAL TAGIHAN',':','','','','','<b>"+TtlSemua.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        Sequel.menyimpan("temporary_bayar_ralan","'0','PPN',':','','','','','<b>"+Valid.SetAngka(besarppn)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        Sequel.menyimpan("temporary_bayar_ralan","'0','TAGIHAN+PPN',':','','','','','<b>"+TagihanPPn.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        if(uangdeposit>0){
                            Sequel.menyimpan("temporary_bayar_ralan","'0','DEPOSIT',':','','','','','<b>"+Valid.SetAngka(uangdeposit)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        }
                        Sequel.menyimpan("temporary_bayar_ralan","'0','BAYAR',':','','','','','<b>"+Valid.SetAngka(bayar)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        if(uangdeposit>0 && sisadeposit_print>0){
                            Sequel.menyimpan("temporary_bayar_ralan","'0','REFUND',':','','','','','<b>"+Valid.SetAngka(sisadeposit_print)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        }else{
                            Sequel.menyimpan("temporary_bayar_ralan","'0','KEMBALI',':','','','','','<b>"+Valid.SetAngka(Math.max(0, bayar - tagihanppn))+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        }
                    }else if(piutang>0){                                                   
                        Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        Sequel.menyimpan("temporary_bayar_ralan","'0','TOTAL TAGIHAN',':','','','','','<b>"+TtlSemua.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        ...
                        Sequel.menyimpan("temporary_bayar_ralan","'0','BAYAR',':','','','','','<b>"+Valid.SetAngka(bayar)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        Sequel.menyimpan("temporary_bayar_ralan","'0','SISA PIUTANG',':','','','','','<b>"+Valid.SetAngka(piutang)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan");                                           
                        if(uangdeposit>0 && sisadeposit_print>0){
                            Sequel.menyimpan("temporary_bayar_ralan","'0','REFUND',':','','','','','<b>"+Valid.SetAngka(sisadeposit_print)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
                        }
                    }
...
private void MnRawatJalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRawatJalanActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            try {
                ...
                Logger.getLogger(DlgBillingRalanV2.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        if(i>0){
            if(!tbBilling.getValueAt(0,1).toString().trim().contains("No.Nota")){
                ...
                String noJurnalAsal = Sequel.cariIsi(
                    "select no_jurnal from jurnal where no_bukti=? and (keterangan like '%PEMBAYARAN PASIEN RAWAT JALAN%' or keterangan like '%PIUTANG PASIEN RAWAT JALAN%') and keterangan not like '%PEMBATALAN%' order by no_jurnal desc limit 1",
                    TNoRw.getText()
                );
                ...
                if(!noJurnalAsal.equals("")){
                    ...
                    try {
                        ...
                        sukses = false;
                        System.out.println("Notifikasi Invert Jurnal Asal Ralan: " + e);
                    } finally {
                ...
                if(sukses==true){
                    ...
                    try {
                        ...
                        System.out.println("Notifikasi Auto Refund Reversal Ralan: " + ex);
                    } finally {
...
private void MnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaLabActionPerformed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        isKembali();
        double piutang_klaim = 0;
        double piutang_umum = 0;
        row2 = tabModeAkunPiutang.getRowCount();
        for (r = 0; r < row2; r++) {
            if (tabModeAkunPiutang.getValueAt(r, 3) != null && !tabModeAkunPiutang.getValueAt(r, 3).toString().trim().equals("")) {
                double val = 0;
                try {
                    val = Double.parseDouble(tabModeAkunPiutang.getValueAt(r, 3).toString());
                } catch (Exception e) {
                    val = 0;
                }
                if (val > 0) {
                    String namaAkun = tabModeAkunPiutang.getValueAt(r, 0) != null ? tabModeAkunPiutang.getValueAt(r, 0).toString() : "";
                    String kdPj = tabModeAkunPiutang.getValueAt(r, 2) != null ? tabModeAkunPiutang.getValueAt(r, 2).toString() : "";
                    if (isAkunPiutangPasienUmum(namaAkun, kdPj)) {
                        piutang_umum += val;
                    } else {
                        piutang_klaim += val;
                    }
        ...
        double selisih = tagihanppn - (bayar + piutang);
        ...
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (uangdeposit > 0 && piutang_umum > 0 && (tagihanppn - piutang_klaim) <= uangdeposit) {
                JOptionPane.showMessageDialog(null, "Deposit pasien mencukupi seluruh tagihan RS. Piutang Pasien Umum hanya diperbolehkan jika tagihan RS melebihi deposit pasien!");
            } else if (selisih > 0) {
                if (piutang > 0) {
                    JOptionPane.showMessageDialog(null, "Maaf, piutang/pembayaran belum genap. Silahkan isi di jumlah piutang atau pembayaran...!!!");
                } else {
                    JOptionPane.showMessageDialog(null, "Maaf, pembayaran pasien masih kurang ...!!!");
                }
            } else if (selisih < 0) {
                if (uangdeposit > 0) {
                    JOptionPane.showMessageDialog(null, "Maaf, pembayaran melebihi jumlah tagihan...!!!");
                } else {
                    if (piutang > 0) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            if(jLabelTotDeposit != null) jLabelTotDeposit.setVisible(true);
            if(TotalDeposit != null) TotalDeposit.setVisible(true);
            if(jLabelTotRefund != null) jLabelTotRefund.setVisible(true);
            if(TotalRefund != null) TotalRefund.setVisible(true);
            if(Deposit != null) Deposit.setVisible(true);
            if(BtnSeek2 != null) BtnSeek2.setVisible(true);
        } catch (Exception e) {
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBillingRalanV2 dialog = new DlgBillingRalanV2(new javax.swing.JFrame(), true);
    ...
    // ==========================================
    // Custom Deposit & Refund Fields & Methods
    // ==========================================
    ...
    private void initDepositRefundTab() {
        ...
        jLabelSisaDep = new widget.Label();
        jLabelSisaDep.setText("Sisa Dep. : Rp.");
        jLabelSisaDep.setName("jLabelSisaDep");
        jLabelSisaDep.setPreferredSize(new java.awt.Dimension(80, 23));
        panelBayar.add(jLabelSisaDep);
        jLabelSisaDep.setBounds(420, 377, 80, 23);

        Deposit = new widget.TextBox();
        Deposit.setEditable(false);
        Deposit.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        BtnSeek2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png")));
        BtnSeek2.setMnemonic('3');
        BtnSeek2.setToolTipText("Alt+3");
        BtnSeek2.setName("BtnSeek2");
        ...
        btnCetakDep.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                String noDep = tbDepositDep.getValueAt(tbDepositDep.getSelectedRow(), 0).toString();
                DlgBillingRalanV2.this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                try {
                    java.util.Properties prop = new java.util.Properties();
                    prop.loadFromXML(new java.io.FileInputStream("setting/database.xml"));
                    String urlRme = prop.getProperty("URLRSUDRME");
                    ...
                    Valid.panggilUrl2(urlRme + "cetak_nota/deposit?no_deposit=" + java.net.URLEncoder.encode(noDep, "UTF-8"));
                } catch (Exception e) {
                    System.out.println("Error load/open RME URL: " + e.getMessage());
                }
                DlgBillingRalanV2.this.setCursor(Cursor.getDefaultCursor());
            }
        });
        ...
        btnCetakRef.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                try {
                    ...
                    Valid.panggilUrl2(urlRme + "cetak_nota/refund?no_refund=" + java.net.URLEncoder.encode(noRef, "UTF-8"));
                } catch (Exception e) {
                    System.out.println("Error load/open RME URL: " + e.getMessage());
                }
                DlgBillingRalanV2.this.setCursor(Cursor.getDefaultCursor());
        ...
        btnCetakMut.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                try {
                    ...
                    Valid.panggilUrl2(urlRme + "cetak_nota/ledger?no_rawat=" + java.net.URLEncoder.encode(TNoRw.getText(), "UTF-8") + "&petugas=" + java.net.URLEncoder.encode(akses.getkode(), "UTF-8"));
                } catch (Exception e) {
                    System.out.println("Error load/open RME URL: " + e.getMessage());
                }
                DlgBillingRalanV2.this.setCursor(Cursor.getDefaultCursor());
    ...
    public void refreshDepositRefundData() {
        try {
            ...
            if (noRawat.isEmpty()) {
                ...
                if (Deposit != null) Deposit.setText("0");
            ...
            if (status.equals("sudah")) {
                totalPemakaian = Math.max(0, totalDeposit - totalRefund);
            }
    ...
    public void isRawat() {
        ...
        if(i<=0){
             ...
             try{                
                ...
                tampilAkunPiutangTersimpan();
                isHitung(); 
                uangdeposit=Math.max(0, Sequel.cariIsiAngka("select ifnull(sum(besar_deposit),0) from deposit where no_rawat=?", TNoRw.getText()) - (Sequel.cariIsiAngka("select ifnull(sum(besar_pengembalian),0) from pengembalian_deposit where no_rawat=?", TNoRw.getText()) + Sequel.cariIsiAngka("select ifnull(sum(total_refund),0) from pengembalian_deposit_v2 where no_rawat=?", TNoRw.getText())));
                if (Deposit != null) Deposit.setText(Valid.SetAngka(uangdeposit));
                status="sudah";
            }catch(Exception e){
                System.out.println("Notifikasi : "+e);
    ...
    private boolean isAkunPiutangPasienUmum(String namaAkun, String kdPj) {
        if (namaAkun != null) {
            String nama = namaAkun.toUpperCase();
            if (nama.contains("PASIEN UMUM") || nama.contains("PIUTANG UMUM") || nama.contains("KURANG BAYAR")) {
                return true;
            }
        }
        if (kdPj != null) {
            if ("01".equals(kdPj) || "-".equals(kdPj)) {
                return true;
            }
        }
        return false;
    ...
    public void isKembali(){
        ...
        if (uangdeposit > 0) {
            double deposit_terpakai = Math.min(uangdeposit, bayar);
            sisadeposit = Math.max(0, uangdeposit - bayar);
            double selisih = tagihanppn - (bayar + piutang);
            if (Math.abs(selisih) < 0.001) {
                selisih = 0;
            }
            ...
            jLabel5.setText("Bayar : Rp.");
            if (sisadeposit > 0) {
                jLabel6.setText("Refund : Rp.");
                TKembali.setText(Valid.SetAngka3(sisadeposit));
                kekurangan = sisadeposit;
            } else if (selisih > 0) {
                jLabel6.setText("Kekurangan : Rp.");
                TKembali.setText(Valid.SetAngka3(-selisih));
                kekurangan = -selisih;
            } else if (selisih < 0) {
                ...
                jLabel6.setText("Kembali : Rp.");
                TKembali.setText(Valid.SetAngka3(0));
                kekurangan = 0;
            }
        } else {
            sisadeposit = 0;
            // cek penamaan label kekurangan dan kembali saat tidak ada deposit
            if(piutang<=0){
        ...
        if((chkLaborat.isSelected()==false)||(chkRadiologi.isSelected()==false)){
            ...
            try {
                ...
                if(sukses==true){
                    ...
                    double deposit_terpakai = Math.min(uangdeposit, bayar);
                    sisadeposit = Math.max(0, uangdeposit - bayar);
                    double remaining_payment_needed = Math.max(0, tagihanppn - piutang);
                    ...
                    for(r=0;r<row2;r++){
                        if(Valid.SetAngka(tbAkunBayar.getValueAt(r,2).toString())>0){
                            ...
                            double consumed_payment = Math.min(itembayar, remaining_payment_needed);
                            remaining_payment_needed = Math.max(0, remaining_payment_needed - consumed_payment);

                            if(countbayar>1){
                                if(Sequel.menyimpantf2("detail_nota_jalan","?,?,?,?","Akun bayar",4,new String[]{
                                        TNoRw.getText(),tbAkunBayar.getValueAt(r,0).toString(),Double.toString(besarppn),Double.toString(consumed_payment)
                                    })==true){
                                        Sequel.menyimpan("tampjurnal","'"+tbAkunBayar.getValueAt(r,1).toString()+"','"+tbAkunBayar.getValueAt(r,0).toString()+"','"+Double.toString(consumed_payment)+"','0'",
                                                         "debet=debet+"+Double.toString(consumed_payment),"kd_rek='"+tbAkunBayar.getValueAt(r,1).toString()+"'");
                                        if(Host_to_Host_Bank_Jateng.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(Sequel.menyimpantf2("tagihan_bpd_jateng","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",16,new String[]{
                                                no_rkm_medis,nm_pasien,alamat,jk,tgl_lahir,umurdaftar,tgl_registrasi,no_nota.replaceAll("/",""),Double.toString(consumed_payment),"Pembayaran Pasien Rawat Jalan",TNoRw.getText(),"Ralan",Valid.SetTgl(DTPTgl.getSelectedItem()+""),"Pending",akses.getkode(),"0000-00-00"
                                            })==false){
                                                sukses=false;
                                            }
                                        }
                                        ...
                                        if(Host_to_Host_Bank_Jabar.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(Sequel.menyimpantf2("tagihan_bpd_jabar","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",16,new String[]{
                                                no_rkm_medis,nm_pasien,alamat,jk,tgl_lahir,umurdaftar,tgl_registrasi,no_nota.replaceAll("/",""),Double.toString(consumed_payment),KodeBankJabar+"1011312"+Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(tagihan_bpd_jabar.keterangan,4),signed)),0) from tagihan_bpd_jabar where year(tagihan_bpd_jabar.tgl_closing)='"+DTPTgl.getSelectedItem().toString().substring(6,10)+"' and tagihan_bpd_jabar.status_lanjut='Ralan'",DTPTgl.getSelectedItem().toString().substring(8,10),4),TNoRw.getText(),"Ralan",Valid.SetTgl(DTPTgl.getSelectedItem()+""),"Pending",akses.getkode(),"0000-00-00"
                                            })==false){
                                                sukses=false;
                                            }
                                        }
                                        if(Akun_BRI_API.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(apibri.buatVA(TNoRw.getText().replaceAll("/","").substring(2,8)+TNoRw.getText().replaceAll("/","").substring(10,14),(nm_pasien.length()>38?nm_pasien.substring(0,38):nm_pasien),Valid.SetAngka2(consumed_payment),TNoRw.getText())==true){
                                                if(Sequel.menyimpantf2("tagihan_briva","?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",14,new String[]{
                                                        no_rkm_medis,nm_pasien,alamat,jk,tgl_lahir,tgl_registrasi,TNoRw.getText().replaceAll("/","").substring(2,8)+TNoRw.getText().replaceAll("/","").substring(10,14),Double.toString(consumed_payment),TNoRw.getText(),"Ralan",Valid.SetTgl(DTPTgl.getSelectedItem()+""),"Pending",akses.getkode(),"0000-00-00"
                                                    })==false){
                                                    sukses=false;
                                                }
                                            }
                                        ...
                                        if(Host_to_Host_Bank_Mandiri.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(Sequel.menyimpantf2("tagihan_mandiri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",22,new String[]{
                                                no_rkm_medis, nm_pasien, alamat, jk, tgl_lahir, umurdaftar, tgl_registrasi,no_nota.replaceAll("/","").replaceAll("RJ","01"),Double.toString(consumed_payment),TNoRw.getText(),TNoRw.getText().replaceAll("/",""),"Ralan",Valid.SetTgl(DTPTgl.getSelectedItem()+"")+" "+DTPTgl.getSelectedItem().toString().substring(11,19),"Pending","","","0",akses.getkode(),"","","","0000-00-00",""
                                            })==false){
                                                sukses=false;
                                            }
                                        }
                    ...
                    if(sukses==true){
                        if(deposit_terpakai>0){  
                            ...
                            if (!kdRekDepositAsal.equals("")) {
                                Sequel.menyimpan("tampjurnal","'"+kdRekDepositAsal+"','"+akunBayarDepositAsal+"','0','"+deposit_terpakai+"'",
                                                 "kredit=kredit+"+deposit_terpakai,"kd_rek='"+kdRekDepositAsal+"'");
                            }
                        }
                        ...
                        if(sukses==true && sisadeposit>0){
                            try {
                                String tglRefundAuto = Valid.SetTgl(DTPTgl.getSelectedItem()+"");
                                String tglRefundAutoFull = tglRefundAuto + " " + (new java.text.SimpleDateFormat("HH:mm:ss")).format(new java.util.Date());
                                String prefixRefundAuto = "RF" + tglRefundAuto.replace("-", "") + "";
                                String sqlRefundAuto = "select ifnull(MAX(CONVERT(RIGHT(no_refund,4),signed)),0) from pengembalian_deposit_v2 where tanggal like '%" + tglRefundAuto + "%'";
                                String noRefundAuto = Valid.autoNomer3(sqlRefundAuto, prefixRefundAuto, 4);

                                String akunBayarRefund = Sequel.cariIsi("select nama_bayar from deposit where no_rawat=? order by tgl_deposit desc limit 1", TNoRw.getText());
                                if (akunBayarRefund.equals("")) {
                                    akunBayarRefund = "1. Bayar Cash";
                                }
                                ...
                                if(Sequel.menyimpantf2("pengembalian_deposit_v2", "?,?,?,?,?,?,?,?,?", "Refund Deposit Auto", 9, new String[]{
                                    noRefundAuto, TNoRw.getText(), tglRefundAutoFull,
                                    akunBayarRefund, String.valueOf(sisadeposit), "0",
                                    String.valueOf(sisadeposit), nipPetugas, "Auto Refund sisa deposit saat simpan billing"
                                })==true){
                                    String kdRek = Sequel.cariIsi("select kd_rek from akun_bayar where nama_bayar=?", akunBayarRefund);
                                    if (!kdRek.equals("")) {
                                        Sequel.queryu("delete from tampjurnal");
                                        // Debit: Uang Muka Ranap
                                        Sequel.menyimpan("tampjurnal", "'" + Uang_Muka_Ranap + "','UANG MUKA RANAP','" + sisadeposit + "','0'", "Rekening");
                                        // Credit: Akun Bayar
                                        Sequel.menyimpan("tampjurnal", "'" + kdRek + "','" + akunBayarRefund + "','0','" + sisadeposit + "'", "Rekening");
                                        sukses = jur.simpanJurnal(noRefundAuto, "U", "REFUND DEPOSIT PASIEN " + TNoRw.getText() + " " + TNoRM.getText() + " " + TPasien.getText() + ", OLEH " + akses.getkode());
                                    }
                                } else {
                                    sukses = false;
                                }
                                ...
                                sukses = false;
                                System.out.println("Error auto refund: " + e.getMessage());
                            }
                        }
                    }
                }
