...
public final class DlgJnsPerawatanRanap extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            String query = "INSERT INTO mapping_tarif_ina_ranap (kd_jenis_prw, kategori_tarif)\n" +
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            String query_cek = "SELECT id_mapping_tarif_ina_ranap FROM mapping_tarif_ina_ranap WHERE kd_jenis_prw = '"+TKd.getText()+"'";
            try {
                ps = koneksi.prepareStatement(query_cek);
                rs = ps.executeQuery();
                if(rs.next()){
                    String id_mapping = rs.getString("id_mapping_tarif_ina_ranap");
                    String query_update = "UPDATE mapping_tarif_ina_ranap SET kategori_tarif = '"+kategori_tarif_ina.getSelectedItem().toString()+"' WHERE id_mapping_tarif_ina_ranap = '"+id_mapping+"'";
                    ...
                    String query_mapping = "INSERT INTO mapping_tarif_ina_ranap (kd_jenis_prw, kategori_tarif) VALUES ('"+TKd.getText()+"', '"+kategori_tarif_ina.getSelectedItem().toString()+"')";
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                        ...
                        "  inner join penjab \n" +
                        "  inner join bangsal on jns_perawatan_inap.kd_kategori = kategori_perawatan.kd_kategori \n" +
                        "  and bangsal.kd_bangsal = jns_perawatan_inap.kd_bangsal \n" +
                        "  and penjab.kd_pj = jns_perawatan_inap.kd_pj \n" +
                        "  left join mapping_tarif_ina_ranap on jns_perawatan_inap.kd_jenis_prw = mapping_tarif_ina_ranap.kd_jenis_prw \n" +
                        "where \n" +
                        "  jns_perawatan_inap.status = '1' \n" +
                        "  and jns_perawatan_inap.kd_jenis_prw like ? \n" +
                        "  or jns_perawatan_inap.status = '1' \n" +
                        "  and jns_perawatan_inap.nm_perawatan like ? \n" +
                        "  or jns_perawatan_inap.status = '1' \n" +
                        "  and kategori_perawatan.nm_kategori like ? \n" +
                        "  or jns_perawatan_inap.status = '1' \n" +
                        "  and jns_perawatan_inap.kelas like ? \n" +
                        "  or jns_perawatan_inap.status = '1' \n" +
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            NmKamar.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),15).toString());
            Kelas.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),16).toString());
        }
    }
