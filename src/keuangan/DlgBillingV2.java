            ...
            try{
                ...
                if(i>0){                       
                    ...
                    if(i==1){
                        ...
                        if(piutang>0){
                            Valid.panggilUrl("billing/LaporanBilling1.php?petugas="+akses.getkode().replaceAll(" ","_")+"&nonota="+Sequel.cariIsi("select count(kamar_inap.no_rawat) from kamar_inap inner join reg_periksa "+
