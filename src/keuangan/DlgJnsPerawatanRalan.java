...
public final class DlgJnsPerawatanRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1015, 250));
        ...
        kategori_tarif_ina.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Prosedur Non Bedah", "Tenaga Ahli", "Rehabilitasi", "Prosedur Bedah", "Keperawatan", "Kamar / Akomodasi", "BMHP", "Konsultasi", "Penunjang", "Sewa Alat" }));
        kategori_tarif_ina.setName("kategori_tarif_ina"); // NOI18N
        FormInput.add(kategori_tarif_ina);
        kategori_tarif_ina.setBounds(832, 12, 160, 23);

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("Mapping INA:");
        jLabel1.setName("jLabel1"); // NOI18N
        FormInput.add(jLabel1);
        jLabel1.setBounds(747, 12, 80, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            String query = "INSERT INTO mapping_tarif_ina_ralan (kd_jenis_prw, kategori_tarif)\n" +
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            String query_cek = "SELECT id_mapping_tarif_ina_ralan FROM mapping_tarif_ina_ralan WHERE kd_jenis_prw = '"+TKd.getText()+"'";
            try {
                ps = koneksi.prepareStatement(query_cek);
                rs = ps.executeQuery();
                if(rs.next()){
                    String id_mapping = rs.getString("id_mapping_tarif_ina_ralan");
                    String query_update = "UPDATE mapping_tarif_ina_ralan SET kategori_tarif = '"+kategori_tarif_ina.getSelectedItem().toString()+"' WHERE id_mapping_tarif_ina_ralan = '"+id_mapping+"'";
                    ...
                    String query_mapping = "INSERT INTO mapping_tarif_ina_ralan (kd_jenis_prw, kategori_tarif) VALUES ('"+TKd.getText()+"', '"+kategori_tarif_ina.getSelectedItem().toString()+"')";
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getDouble("total_byrpr"),
                        rs.getDouble("total_byrdrpr"),
    ...
    private void getData() {
        ...
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            if(!tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString().equals("-")){
                ...
                kategori_tarif_ina.setSelectedItem("Prosedur Non Bedah");
            }
            NmKtg.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
            BagianRs.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),5).toString())));
            BhpMedis.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),6).toString())));
            TTndDr.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),7).toString())));
            TTndPr.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),8).toString())));
            KSO.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),9).toString())));
            Menejemen.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),10).toString())));
            TJmlDr.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),11).toString())));
            TJmlPr.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),12).toString())));
            TJmlDrPr.setText(Valid.SetAngka2(Double.parseDouble(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),13).toString())));
            ...
            nmpnj.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),14).toString());
            ...
            NmPoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),15).toString());
            System.out.println("TKd: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1).toString());
            System.out.println("TNm: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
            System.out.println("kategori_tarif_ina: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
            System.out.println("NmKtg: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
            System.out.println("BagianRs: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),5).toString());
            System.out.println("BhpMedis: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),6).toString());
            System.out.println("TTndDr: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),7).toString());
            System.out.println("TTndPr: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),8).toString());
            System.out.println("KSO: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),9).toString());
            System.out.println("Menejemen: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),10).toString());
            System.out.println("TJmlDr: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),11).toString());
            System.out.println("TJmlPr: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),12).toString());
            System.out.println("TJmlDrPr: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),13).toString());
            System.out.println("nmpnj: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),14).toString());
            System.out.println("NmPoli: "+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),15).toString());
        }
    }
