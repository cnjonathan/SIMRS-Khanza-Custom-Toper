...
public class PanelDiagnosa extends widget.panelisi {
    ...
    private void initComponents() {
        ...
        tbDiagnosaPasien.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    public void tampil() {
        ...
        try{            
            ...
            try {
                ...
                System.out.println("no rawat: "+this.norawat);
                System.out.println("no rm: "+this.norm);
                System.out.println("no keyword: "+this.keyword);
                System.out.println("query diagnosa: "+psdiagnosapasien.toString());
    ...
    private void tampildiagnosa() {
        try{
            ...
            pspenyakit=koneksi.prepareStatement("select "
                    + "penyakit.kd_penyakit,"
                    + "penyakit.nm_penyakit,"
                    + "penyakit.ciri_ciri,"
                    + "penyakit.keterangan, "
                    + "kategori_penyakit.nm_kategori,"
                    + "kategori_penyakit.ciri_umum "+
