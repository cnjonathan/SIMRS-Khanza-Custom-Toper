...
public class koneksiDB {
    ...
    private static void disableSSLVerification() {
        try {
            ...
            System.out.println("Warning: Gagal inisialisasi SSL bypass di koneksiDB: " + e.getMessage());
        }
    }
    ...
    public static String URLMASTERDATASATUSEHAT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLMASTERDATASATUSEHAT");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String URLRSUDRME(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLRSUDRME");
        }catch(Exception e){
            var=""; 
        }
        return var;
