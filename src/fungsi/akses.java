...
public final class akses {
    ...
    private static String nik="", passphrase="";
    ...
    public static void setNikPassphrase(String nik, String passphrase){
        akses.nik=nik;
        akses.passphrase=passphrase;
    }

    public static String getNik(){return akses.nik;}
    public static String getPassphrase(){return akses.passphrase;}
