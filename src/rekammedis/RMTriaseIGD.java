...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-12-2025 23:28:06" }));
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-12-2025 23:28:07" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-12-2025 23:28:07" }));
    ...
    */
    ...
    public void setNoRm(String norwt,String norm,String namapasien) {
        ...
        TCari.setText(norwt);   
        // atur scroll
        ScrollTriase.getVerticalScrollBar().setUnitIncrement(20);
    }
    
    public void tampilPemeriksaan() {        
        Valid.tabelKosong(tabModePemeriksaan);
        try{
            ps=koneksi.prepareStatement("select * from master_triase_pemeriksaan where status = '1' and (kode_pemeriksaan like ? or nama_pemeriksaan like ?) order by kode_pemeriksaan");
            try {
