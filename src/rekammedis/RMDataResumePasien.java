...
import fungsi.WarnaTableResumeMedisRalan;
...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private FormTTE form_tte=new FormTTE(null,false);
    ...
    public RMDataResumePasien(java.awt.Frame parent, boolean modal) {
        ...
        tbObat.setDefaultRenderer(Object.class, new WarnaTableResumeMedisRalan());
    ...
    private void initComponents() {
        ...
        MnTTE.setBackground(new java.awt.Color(255, 255, 254));
        MnTTE.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTE.setForeground(new java.awt.Color(50, 50, 50));
        MnTTE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTE.setText("Tanda Tangan Elektronik");
        MnTTE.setName("MnTTE"); // NOI18N
        MnTTE.setPreferredSize(new java.awt.Dimension(250, 26));
        MnTTE.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTEActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnTTE);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-02-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-02-2025" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",29,new String[]{
                    ...
                    KodeDokter.getText(), //kd_dokter
                    Keluhan.getText(), //keluhan_utama
                    JalannyaPenyakit.getText(), //jalannya_penyakit
                    PemeriksaanPenunjang.getText(), //pemeriksaan_penunjang
                    HasilLaborat.getText(), //hasil_laborat
                    DiagnosaUtama.getText(), //diagnosa_utama
                    KodeDiagnosaUtama.getText(), //kd_diagnosa_utama
                    DiagnosaSekunder1.getText(), //diagnosa_sekunder
                    KodeDiagnosaSekunder1.getText(), //kd_diagnosa_sekunder
                    DiagnosaSekunder2.getText(), //diagnosa_sekunder2
                    KodeDiagnosaSekunder2.getText(), //kd_diagnosa_sekunder2
                    DiagnosaSekunder3.getText(), //diagnosa_sekunder3
                    KodeDiagnosaSekunder3.getText(), //kd_diagnosa_sekunder3
                    DiagnosaSekunder4.getText(), //diagnosa_sekunder4
                    KodeDiagnosaSekunder4.getText(), //kd_diagnosa_sekunder4
                    ProsedurUtama.getText(), //prosedur_utama
                    KodeProsedurUtama.getText(), //kd_prosedur_utama
                    ProsedurSekunder1.getText(), //prosedur_sekunder
                    KodeProsedurSekunder1.getText(), //kd_prosedur_sekunder
                    ProsedurSekunder2.getText(), //prosedur_sekunder2
                    KodeProsedurSekunder2.getText(), //kd_prosedur_sekunder2
                    ProsedurSekunder3.getText(), //prosedur_sekunder3
                    KodeProsedurSekunder3.getText(), //kd_prosedur_sekunder3
                    Kondisi.getSelectedItem().toString(), //kondisi_pulang
                    Obat2an.getText(), //obat_pulang
                    "Disusun Oleh Dokter", //status
                    timestamp,
                    timestamp
                })==true){
                    tampil();
    ...
    private void MnTTEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTEActionPerformed
        try {
            form_tte.setNoRawat(tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(), "resume_medis_ralan");
            form_tte.tampil_resume_medis_ralan();
            form_tte.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form_tte.setLocationRelativeTo(internalFrame1);
            form_tte.setVisible(true);
        } catch (JRException ex) {
            Logger.getLogger(RMDataResumePasien.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try{
            if(TCari.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "    or resume_pasien.kd_dokter like ? \n" +
                    "    or dokter.nm_dokter like ? \n" +
                    "    or resume_pasien.kondisi_pulang like ? \n" +
                    "    or resume_pasien.kd_diagnosa_utama like ? \n" +
                    "    or resume_pasien.diagnosa_utama like ? \n" +
                    "    or resume_pasien.prosedur_utama like ? \n" +
                    "    or reg_periksa.no_rawat like ? \n" +
                    "    or resume_pasien.kd_prosedur_utama like ?\n" +
                    "  ) \n" +
                    "order by \n" +
                    "  reg_periksa.tgl_registrasi");
            }
