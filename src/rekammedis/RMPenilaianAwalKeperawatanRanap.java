...
public final class RMPenilaianAwalKeperawatanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-01-2026 21:29:30" }));
    ...
    public void cek_ttv_triase() {
        ...
        try {
            ...
            if(rs_triase.next()){
                ...
                SpO2.setText(rs_triase.getString("saturasi_o2"));
                ...
                if(rs_medis.next()){
                    ...
                    SpO2.setText(rs_medis.getString("spo"));
            ...
            if(ps_triase != null){
                try {
                    ...
                    Logger.getLogger(RMPenilaianAwalKeperawatanRanap.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if(rs_triase != null){
                try {
