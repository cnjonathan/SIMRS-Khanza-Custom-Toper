...
public final class RMPenilaianAwalMedisRanapDewasa extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, ps_triase, ps_medis;
    private ResultSet rs, rs_triase, rs_medis;
    private int i=0;
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-01-2026 21:36:07" }));
    ...
    */
    ...
    public void cek_ttv_triase() throws SQLException {
        // TTV dari TRIASE
        String query_triase = "SELECT * FROM data_triase_igd WHERE no_rawat = '"+TNoRw.getText()+"' ORDER BY tgl_kunjungan DESC LIMIT 1;";
        System.out.println("query_triase: "+query_triase);
        try {
            ps_triase = koneksi.prepareStatement(query_triase);
            rs_triase = ps_triase.executeQuery();
            if(rs_triase.next()){
                TD.setText(rs_triase.getString("tekanan_darah"));
                Nadi.setText(rs_triase.getString("nadi"));
                RR.setText(rs_triase.getString("pernapasan"));
                Suhu.setText(rs_triase.getString("suhu"));
                SPO.setText(rs_triase.getString("saturasi_o2"));
                KeluhanUtama.setText(Sequel.cariIsi("SELECT keluhan_utama FROM data_triase_igdprimer WHERE no_rawat = '"+TNoRw.getText()+"'"));
                String query_medis_igd = "SELECT * FROM penilaian_medis_igd WHERE no_rawat = '"+TNoRw.getText()+"'";
                ps_medis = koneksi.prepareStatement(query_medis_igd);
                rs_medis = ps_medis.executeQuery();
                if(rs_medis.next()){
                    TD.setText(rs_medis.getString("td"));
                    Nadi.setText(rs_medis.getString("nadi"));
                    RR.setText(rs_medis.getString("rr"));
                    Suhu.setText(rs_medis.getString("suhu"));
                    SPO.setText(rs_medis.getString("spo"));
                    KeluhanUtama.setText(rs_medis.getString("keluhan_utama"));
                    BB.setText(rs_medis.getString("bb"));
                    TB.setText(rs_medis.getString("tb"));
                    GCS.setText(rs_medis.getString("gcs"));
                    Kesadaran.setSelectedItem(rs_medis.getString("kesadaran"));
                    Keadaan.setSelectedItem(rs_medis.getString("keadaan"));
                    Anamnesis.setSelectedItem(rs_medis.getString("anamnesis"));
                    KeluhanUtama.setText(rs_medis.getString("keluhan_utama"));
                    RPS.setText(rs_medis.getString("rps"));
                    RPD.setText(rs_medis.getString("rpd"));
                    RPK.setText(rs_medis.getString("rpk"));
                    RPO.setText(rs_medis.getString("rpo"));
                    Alergi.setText(rs_medis.getString("alergi"));
                    Kepala.setSelectedItem(rs_medis.getString("kepala"));
                    Gigi.setSelectedItem(rs_medis.getString("gigi"));
                    THT.setSelectedItem(rs_medis.getString("tht"));
                    Thoraks.setSelectedItem(rs_medis.getString("thoraks"));
                    Abdomen.setSelectedItem(rs_medis.getString("abdomen"));
                    Genital.setSelectedItem(rs_medis.getString("genital"));
                    Ekstremitas.setSelectedItem(rs_medis.getString("ekstremitas"));
                    Kulit.setSelectedItem(rs_medis.getString("kulit"));
                    KetFisik.setText(rs_medis.getString("ket_fisik"));
                    KetLokalis.setText(rs_medis.getString("ket_lokalis"));
                    Penunjang.setText(rs_medis.getString("penunjang"));
                    Diagnosis.setText(rs_medis.getString("diagnosis"));
                    Tatalaksana.setText(rs_medis.getString("tata"));
                    Radiologi.setText(rs_medis.getString("rad"));
                    Laborat.setText(rs_medis.getString("lab"));
                }
            }else{
                String query_medis_ralan = "SELECT * FROM penilaian_medis_ralan WHERE no_rawat = '"+TNoRw.getText()+"'";
                ps_medis = koneksi.prepareStatement(query_medis_ralan);
                rs_medis = ps_medis.executeQuery();
                if(rs_medis.next()){
                    TD.setText(rs_medis.getString("td"));
                    Nadi.setText(rs_medis.getString("nadi"));
            ...
            Logger.getLogger(RMPenilaianAwalMedisRanapDewasa.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
            if(ps_triase != null){
                ps_triase.close();
            }
