 ...
 * @author perpustakaan
 */
public class DlgDpjp1_backup extends javax.swing.JDialog {
    ...
    private String encounter_id="",json_encounter="",kd_kamar="", display_kamar="", kd_bangsal="", nm_bangsal="", link_satu_sehat="", status_kirim_encounter="";
    private ApiSatuSehat api=new ApiSatuSehat();

    /** Creates new form DlgPemberianObat
     * @param parent
     * @param modal */
    public DlgDpjp1_backup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            for(i=0;i<tbDiagnosa.getRowCount();i++){ 
                if(tbDiagnosa.getValueAt(i,0).toString().equals("true")){
                    if(Sequel.menyimpantf("dpjp_ranap","?,?","Dokter",2,new String[]{
                        ...
                        Sequel.cariIsi("select satu_sehat_practitioner.practitioner_ihs from satu_sehat_practitioner where satu_sehat_practitioner.nik=? ",Practitioner_SatuSehat,tbDiagnosa.getValueAt(i,1).toString());
                        Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=? ",Patient_SatuSehat,TNoRM.getText());
                        ...
                        if(encounter_id.equals("")){
                            ...
                            try {
                                ...
                                json_encounter = "{\n" +
                                                    ...
                                                    "                \"display\": \""+tbDiagnosa.getValueAt(i,2).toString()+"\"\n" +
                                                    "            }\n" +
                                                    "        }\n" +
                                                    "    ],\n" +
                                                    "    \"period\": {\n" +
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDpjp1_backup dialog = new DlgDpjp1_backup(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{            
            ps2=koneksi.prepareStatement("select reg_periksa.tgl_registrasi,reg_periksa.jam_reg,dpjp_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    "dpjp_ranap.kd_dokter,dokter.nm_dokter from dpjp_ranap inner join reg_periksa inner join pasien inner join dokter "+
                    "on dpjp_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and dpjp_ranap.kd_dokter=dokter.kd_dokter "+
    ...
    private void getData() {
        if(tbPasien.getSelectedRow()!= -1){
            ...
            Jam.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),2).toString());
        }
    }
