        ...
        if(TabRawat.getSelectedIndex()==0){
            ...
            if(tabMode.getRowCount()==0){
                ...
                Valid.MyReportqry("rptBrDiet.jasper","report","::[ Data Pemberian Diet ]::",
                    ...
                    "(detail_beri_diet.no_rawat like '%"+TCari.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari.getText().trim()+"%') order by bangsal.nm_bangsal, kamar.kd_kamar, diet.nama_diet",param);
            }
