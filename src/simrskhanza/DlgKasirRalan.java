...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private String tambahan_query_no_sep="", tambahan_query_kehadiran_pasien_online="", tambahan_query_tracking_pasien="";
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            this.dlgrwjl2 = new DlgRawatJalan(null,false);
        ...
        tbKasirRalan.setDragEnabled(false);
        ...
        for (i = 0; i < 17; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(280); //5
            }else if(i==5){
    ...
    private void initComponents() {
        ...
        cmbTracking = new widget.ComboBox();
        jLabel25 = new widget.Label();
        cmbTypeBooking = new widget.ComboBox();
        jLabel26 = new widget.Label();
        cmbPenjab = new widget.ComboBox();
        jLabel27 = new widget.Label();
        cmbKehadiran = new widget.ComboBox();
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-06-2025" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-06-2025" }));
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(55, 180));
        ...
        panelGlass8.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 10, -1, -1));
        ...
        panelGlass8.add(DTPCari1, new org.netbeans.lib.awtextra.AbsoluteConstraints(81, 10, -1, -1));

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel17.setText("s.d");
        jLabel17.setName("jLabel17"); // NOI18N
        jLabel17.setPreferredSize(new java.awt.Dimension(23, 23));
        panelGlass8.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(176, 10, -1, -1));
        ...
        panelGlass8.add(DTPCari2, new org.netbeans.lib.awtextra.AbsoluteConstraints(204, 10, -1, -1));

        jLabel12.setText("Status Periksa :");
        jLabel12.setName("jLabel12"); // NOI18N
        jLabel12.setPreferredSize(new java.awt.Dimension(90, 23));
        panelGlass8.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 40, -1, -1));
        ...
        panelGlass8.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(549, 10, -1, -1));
        ...
        panelGlass8.add(cmbStatusBayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 10, 130, -1));

        jLabel22.setText("Status SEP:");
        jLabel22.setName("jLabel22"); // NOI18N
        jLabel22.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass8.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 90, -1));

        cmbStatusSep.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Belum", "Sudah" }));
        cmbStatusSep.setName("cmbStatusSep"); // NOI18N
        cmbStatusSep.setPreferredSize(new java.awt.Dimension(130, 23));
        cmbStatusSep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        panelGlass8.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 40, 90, -1));

        cmbTracking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Booking", "Checkin", "Petugas Registrasi", "Antri Poli", "Antri Farmasi", "Antri Kasir", "Pulang" }));
        cmbTracking.setName("cmbTracking"); // NOI18N
        cmbTracking.setPreferredSize(new java.awt.Dimension(130, 23));
        cmbTracking.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbTrackingActionPerformed(evt);
            }
        });
        panelGlass8.add(cmbTracking, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 40, 130, -1));

        jLabel25.setText("Daftar melalui:");
        jLabel25.setName("jLabel25"); // NOI18N
        jLabel25.setPreferredSize(new java.awt.Dimension(100, 23));
        panelGlass8.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 10, 90, -1));

        cmbTypeBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "SiDOL", "JKN", "Anjungan", "Petugas Registrasi" }));
        cmbTypeBooking.setName("cmbTypeBooking"); // NOI18N
        cmbTypeBooking.setPreferredSize(new java.awt.Dimension(130, 23));
        panelGlass8.add(cmbTypeBooking, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 10, -1, -1));

        jLabel26.setText("Payer :");
        jLabel26.setName("jLabel26"); // NOI18N
        jLabel26.setPreferredSize(new java.awt.Dimension(90, 23));
        panelGlass8.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 40, 50, -1));

        cmbPenjab.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "BPJS", "NON BPJS" }));
        cmbPenjab.setName("cmbPenjab"); // NOI18N
        cmbPenjab.setPreferredSize(new java.awt.Dimension(150, 23));
        panelGlass8.add(cmbPenjab, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 40, 130, -1));

        jLabel27.setText("Kehadiran dari :");
        jLabel27.setName("jLabel27"); // NOI18N
        jLabel27.setPreferredSize(new java.awt.Dimension(90, 23));
        panelGlass8.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 10, -1, -1));

        cmbKehadiran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Anjungan", "Petugas Registrasi", "Belum Hadir" }));
        cmbKehadiran.setName("cmbKehadiran"); // NOI18N
        cmbKehadiran.setPreferredSize(new java.awt.Dimension(150, 23));
        panelGlass8.add(cmbKehadiran, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 10, -1, -1));
        ...
        tbKasirRalan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        panelGlass9.setMinimumSize(new java.awt.Dimension(1526, 76));
        panelGlass9.setName("panelGlass9"); // NOI18N
        panelGlass9.setPreferredSize(new java.awt.Dimension(1526, 76));
        ...
        panelGlass9.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 13, 70, 23));
        ...
        panelGlass9.add(TNoRwCari, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 13, 230, 23));

        jLabel5.setText("No. Reg. :");
        jLabel5.setName("jLabel5"); // NOI18N
        jLabel5.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass9.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 40, 70, 23));
        ...
        panelGlass9.add(TNoReg, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 60, 23));

        jLabel7.setText("No.R.M. :");
        jLabel7.setName("jLabel7"); // NOI18N
        jLabel7.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass9.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 40, 50, -1));
        ...
        panelGlass9.add(TNoRMCari, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, -1, -1));

        jLabel8.setText("Nama Pasien :");
        jLabel8.setName("jLabel8"); // NOI18N
        jLabel8.setPreferredSize(new java.awt.Dimension(85, 23));
        panelGlass9.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 13, 70, 23));
        ...
        panelGlass9.add(TPasienCari, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 13, -1, 23));

        jLabel9.setText("No SEP :");
        jLabel9.setName("jLabel9"); // NOI18N
        jLabel9.setPreferredSize(new java.awt.Dimension(85, 23));
        panelGlass9.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 40, 70, 23));
        ...
        panelGlass9.add(TNoSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 40, -1, 23));
        ...
        panelGlass9.add(BtnPrint1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 40, -1, 23));
        ...
        panelGlass9.add(IHS_SatuSehat, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 13, 160, 23));

        jLabel11.setText("IHS Satu Sehat :");
        jLabel11.setName("jLabel11"); // NOI18N
        panelGlass9.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 13, 120, 23));

        jLabel28.setText("Practitioner Satu Sehat :");
        jLabel28.setName("jLabel28"); // NOI18N
        panelGlass9.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 40, 120, 23));
        ...
        panelGlass9.add(Practitioner_SatuSehat, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 40, 160, 23));

        jLabel29.setText("Location Satu Sehat :");
        jLabel29.setName("jLabel29"); // NOI18N
        panelGlass9.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 13, 120, 23));
        ...
        panelGlass9.add(Location_SatuSehat, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 13, 160, 23));

        jLabel30.setText("Patient Satu Sehat :");
        jLabel30.setName("jLabel30"); // NOI18N
        panelGlass9.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 40, 120, 23));
        ...
        panelGlass9.add(Patient_SatuSehat, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 40, 160, 23));
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        ...
        cmbKehadiran.setSelectedItem("Semua");
        cmbPenjab.setSelectedItem("Semua");
        cmbStatusSep.setSelectedItem("Semua");
        cmbTracking.setSelectedItem("Semua");
        cmbTypeBooking.setSelectedItem("Semua");
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnKamarInap1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKamarInap1ActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){     
                if(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),11).toString().equals("Batal")){
                    JOptionPane.showMessageDialog(null,"Pasien berstatus batal periksa...!");
                }else{
                    if(Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                        JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi..!!");
                    }else{ 
                        akses.setstatus(true);
                        kamarinap.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        ...
                        kamarinap.emptTeks();
                        kamarinap.isCek();
                        kamarinap.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),2).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),3).toString());   
                        kamarinap.setVisible(true);                    
                    }
                }
            }               
    ...
    private void MnObatLangsung1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnObatLangsung1ActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    JOptionPane.showMessageDialog(null,"Maaf, Pasien sudah masuk Kamar Inap. Gunakan billing Ranap..!!!");
                }else{
                    if(Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                        JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi ..!!");
                    }else{
                        TotalObat.setText(Sequel.cariIsi("select besar_tagihan from tagihan_obat_langsung where no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString()));
                        WindowObatBhp.setSize(590,80);
                        WindowObatBhp.setLocationRelativeTo(internalFrame1);
                        WindowObatBhp.setVisible(true);
                    }        
       ...
       if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    dlgrwinap.isCek();
                    dlgrwinap.setNoRm(
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    dlgrwjl2.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                    dlgrwjl2.setLocationRelativeTo(internalFrame1);
                    dlgrwjl2.SetPoli(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),15).toString());
                    dlgrwjl2.SetPj(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),16).toString());
                    dlgrwjl2.setNoRm(
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    if(Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                        ...
                        dlgrwjl.isCek();
                        dlgrwjl.setPoli(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),15).toString());
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    periksalab.setLocationRelativeTo(internalFrame1);
                    periksalab.emptTeks();
                    periksalab.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),"Ralan"); 
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    periksarad.setLocationRelativeTo(internalFrame1);
                    periksarad.emptTeks();
                    periksarad.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),"Ralan"); 
                ...
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString())>0){
                    ...
                    if(Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                        ...
                        dlgobt.setNoRm(
                            ...
                            Sequel.cariIsi("select reg_periksa.tgl_registrasi from reg_periksa where reg_periksa.no_rawat='"+tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString()+"'"),
                            Sequel.cariIsi("select jam_reg from reg_periksa where no_rawat='"+tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString()+"'"),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),0).toString()
                        );
                        dlgobt.isCek();
                        dlgobt.setDokter(
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    resep.setNoRm(
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),
                        DTPCari1.getDate(),DTPCari2.getDate(),
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),14).toString().substring(0,2),
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),14).toString().substring(3,5),
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),14).toString().substring(6,8),
                        tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),0).toString(),
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    try {
                        sudah=Sequel.cariInteger("select count(billing.no_rawat) from billing where billing.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString());
                        pscaripiutang=koneksi.prepareStatement("select tgl_piutang from piutang_pasien where no_rkm_medis=? and status='Belum Lunas' order by tgl_piutang asc limit 1");
                        try{                                                
                            ...
                            if(rskasir.next()){
                                ...
                                if(i==JOptionPane.YES_OPTION){
                                    ...
                                    billing.TNoRw.setText(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString());  
                                    billing.isCek();
                                    billing.isRawat(); 
                                    if(sudah>0){
                                        billing.setPiutang();
    ...
    private void ppBerkasDigital1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDigital1BtnPrintActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                ...
                try {
                    if(akses.gethapus_berkas_digital_perawatan()==true){
                        berkas.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/"+"berkasrawat/login2.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&no_rawat="+tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString());
                    }else{
                        berkas.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/"+"berkasrawat/login2nonhapus.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&no_rawat="+tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString());
                    }   
                } catch (Exception ex) {
                    System.out.println("Notifikasi : "+ex);
                }
    ...
    private void ppIKP1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppIKP1BtnPrintActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                ...
                aplikasi.setLocationRelativeTo(internalFrame1);
                aplikasi.isCek();
                aplikasi.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),DTPCari1.getDate(),DTPCari2.getDate(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),4).toString());
                aplikasi.tampil();
                aplikasi.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
    ...
    private void MnBarcodeRM9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM9ActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            String label_1 = "SELECT \n" +
                            ...
                            "WHERE \n" +
                            "  reg_periksa.no_rawat = '"+TNoRwCari.getText()+"' \n" +
                            "  AND reg_periksa.tgl_registrasi = '"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),15).toString()+"' \n" +
                            "  AND reg_periksa.kd_pj = '"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),19).toString()+"';";
            System.out.println("Label RM 9: "+label_1);
            Valid.MyReportqry("rptAnjungan.jasper","report","::[ Label Anjungan ]::",label_1,param);
            Valid.MyReportqry("rptBarcodeRM18_new.jasper","report","::[ Label Rekam Medis ]::",
                    "select \n" +
                    "  pasien.no_rkm_medis, \n" +
                    "  pasien.nm_pasien, \n" +
                    "  pasien.no_ktp, \n" +
                    ...
                    "  -- pasien.alamat,\n" +
                    "  CONCAT(\n" +
                    "    pasien.alamat, ', ', satu_sehat_pasien.village_name, \n" +
                    ...
                    "  -- pasien.alamatpj\n" +
                    "  CONCAT(\n" +
                    "    pasien.alamatpj, ', ', satu_sehat_pasien.village_name_pj, \n" +
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()>-1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                    form.setLocationRelativeTo(internalFrame1);
                    form.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),2).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),3).toString(),
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()>-1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    dlgro.emptTeks();
                    dlgro.isCek();
                    dlgro.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString(),"Ralan",
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),0).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),1).toString());
                    dlgro.setVisible(true);
                    this.setCursor(Cursor.getDefaultCursor());
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString())>0){
                    ...
                    DlgCopyResep daftar=new DlgCopyResep(null,false);
                    daftar.isCek();
                    daftar.setRM(TNoRwCari.getText(),TNoRMCari.getText(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),0).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),16).toString(),"ralan");
                    daftar.tampil();
                    daftar.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                    daftar.setLocationRelativeTo(internalFrame1);
                    daftar.setVisible(true);
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRwCari.getText())>0){
                    ...
                    form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                    form.setLocationRelativeTo(internalFrame1);               
                    form.setNoRm(TNoRwCari.getText(),TNoRMCari.getText(),TPasienCari.getText(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),1).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),4).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),17).toString()); 
                    form.setVisible(true);
                } 
            }               
        }
    ...
    private void cmbTrackingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbTrackingActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbTrackingActionPerformed
    ...
    private void cmbStatusSepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbStatusSepActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbStatusSepActionPerformed

    private void MnPenilaianPreInduksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianPreInduksiActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnPenilaianPreInduksiActionPerformed

    private void MnHasilPemeriksaanUSGUrologiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilPemeriksaanUSGUrologiBtnPrintActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MnHasilPemeriksaanUSGUrologiBtnPrintActionPerformed

    private void MnHasilPemeriksaanUSGGynecologiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilPemeriksaanUSGGynecologiBtnPrintActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MnHasilPemeriksaanUSGGynecologiBtnPrintActionPerformed

    private void MnHasilPemeriksaanEKGBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilPemeriksaanEKGBtnPrintActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MnHasilPemeriksaanEKGBtnPrintActionPerformed

    private void MnPenatalaksanaanTerapiOkupasiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenatalaksanaanTerapiOkupasiBtnPrintActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MnPenatalaksanaanTerapiOkupasiBtnPrintActionPerformed
    ...
    */
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            switch(cmbStatusSep.getSelectedItem().toString()){
                case "Belum":
                    tambahan_query_no_sep = " AND (SELECT MAX(b.no_sep) FROM bridging_sep b WHERE b.no_rawat = reg_periksa.no_rawat AND b.nomr = reg_periksa.no_rkm_medis) IS NULL ";
//                    System.out.println("tambahan_query_no_sep belum: "+tambahan_query_no_sep);
                    break;
                case "Sudah":
                    tambahan_query_no_sep = " AND (SELECT MAX(b.no_sep) FROM bridging_sep b WHERE b.no_rawat = reg_periksa.no_rawat AND b.nomr = reg_periksa.no_rkm_medis) IS NOT NULL ";
                    System.out.println("tambahan_query_no_sep sudah: "+tambahan_query_no_sep);
                    break;
                default:
                    tambahan_query_no_sep = "";
//                    System.out.println("tambahan_query_no_sep semua: "+tambahan_query_no_sep);
            }
            switch(cmbTypeBooking.getSelectedItem().toString()){
                case "SiDOL":
                    tambahan_query_kehadiran_pasien_online = " AND view_anjungan.type_booking = 'sidoel'";
//                    System.out.println("tambahan_query_no_sep belum: "+tambahan_query_no_sep);
                    break;
                case "JKN":
                    tambahan_query_kehadiran_pasien_online = " AND view_anjungan.type_booking = 'jkn'";
//                    System.out.println("tambahan_query_no_sep belum: "+tambahan_query_no_sep);
                    break;
                case "Anjungan":
                    tambahan_query_kehadiran_pasien_online = " AND view_anjungan.type_booking = 'anjungan'";
                    break;
                case "Petugas Registrasi":
                    tambahan_query_kehadiran_pasien_online = " AND view_anjungan.type_booking = 'petugas_registrasi'";
                    break;
                default:
                    tambahan_query_kehadiran_pasien_online = "";
            }
            
            switch(cmbTracking.getSelectedItem().toString()){
                case "Booking":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'booking'";
//                    System.out.println("tambahan_query_no_sep belum: "+tambahan_query_no_sep);
                    break;
                case "Checkin":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'checkin'";
//                    System.out.println("tambahan_query_no_sep belum: "+tambahan_query_no_sep);
                    break;
                case "Petugas Registrasi":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'petugas_registrasi'";
                    break;
                case "Antri Poli":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'antri_poli'";
                    break;
                case "Antri Farmasi":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'antri_farmasi'";
                    break;
                case "Antri Kasir":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'antri_kasir'";
                    break;
                case "Pulang":
                    tambahan_query_tracking_pasien = " AND view_anjungan.trace_progress = 'pulang'";
                    break;
                default:
                    tambahan_query_tracking_pasien = "";
            }
            
            String where_penjab = "";
            String where_kehadiran = "";
            //QUERY FILTER WHERE
            switch (cmbPenjab.getSelectedItem().toString()) {
                case "BPJS":
                    where_penjab = " and (penjab.kd_pj = '001' OR penjab.kd_pj = '21' OR penjab.kd_pj = '22' OR penjab.kd_pj = '30' OR penjab.kd_pj = 'BP' OR penjab.kd_pj = 'BPJ') ";
                    break;
                case "NON BPJS":
                    where_penjab = " and (penjab.kd_pj = '01' OR penjab.kd_pj = '02' OR penjab.kd_pj = '03' OR penjab.kd_pj = '04' OR penjab.kd_pj = '05' OR penjab.kd_pj = '06' OR penjab.kd_pj = '08' OR penjab.kd_pj = '10' OR penjab.kd_pj = '12' OR penjab.kd_pj = '14' OR penjab.kd_pj = '20' OR penjab.kd_pj = '29' OR penjab.kd_pj = '31' OR penjab.kd_pj = '40' OR penjab.kd_pj = '99' OR penjab.kd_pj = 'A23' OR penjab.kd_pj = 'RS') ";
                    break;
                default:
                    where_penjab = "";
            }

            switch (cmbKehadiran.getSelectedItem().toString()) {
                case "Anjungan":
                    where_kehadiran = " and view_anjungan.kehadiran_melalui = 'anjungan' ";
                    break;
                case "Petugas Registrasi":
                    where_kehadiran = " and view_anjungan.kehadiran_melalui = 'petugas_registrasi' ";
                    break;
                case "Belum Hadir":
                    where_kehadiran = " and view_anjungan.kehadiran_melalui = 'belum_hadir' ";
                    break;
                default:
                    where_kehadiran = "";
            }
            ...
            String query_tampilkasir="SELECT \n"+
                ...
                "    dokter.nm_dokter,\n"+
                "    view_anjungan.type_booking, \n"+
                "    view_anjungan.trace_progress AS kehadiran, \n"+
//                "    (SELECT MAX(b.no_sep) FROM bridging_sep b WHERE b.no_rawat = reg_periksa.no_rawat AND b.nomr = reg_periksa.no_rkm_medis) AS no_sep, \n"+
                "    view_anjungan.no_sep AS no_sep, \n"+
                ...
                "	reg_periksa \n"+
                "LEFT JOIN \n" +
                "       satu_sehat_pasien ON reg_periksa.no_rkm_medis = satu_sehat_pasien.no_rkm_medis \n"+
                "INNER JOIN \n"+
                "	dokter ON reg_periksa.kd_dokter=dokter.kd_dokter \n"+
                "LEFT JOIN \n" + 
                "       satu_sehat_practitioner ON dokter.kd_dokter = satu_sehat_practitioner.nik \n"+
                "LEFT JOIN \n"+
                "	view_anjungan ON reg_periksa.no_rawat=view_anjungan.param_2\n"+
                "INNER JOIN \n"+
                ...
                "LEFT JOIN \n" +
                "       satu_sehat_mapping_lokasi_ralan on reg_periksa.kd_poli = satu_sehat_mapping_lokasi_ralan.kd_poli \n"+
                "WHERE \n"+
                "	reg_periksa.tgl_registrasi BETWEEN ? AND ? and reg_periksa.status_lanjut='Ralan'"+tampildiagnosa+tambahan_query_no_sep+tambahan_query_kehadiran_pasien_online+tambahan_query_tracking_pasien+where_penjab+where_kehadiran+
            ...
            try{
                ...
                // System.out.println("query_tampilkasir: "+pskasir);
                String type_booking = "-";
                String kehadiran = "-";
                while(rskasir.next()){
                    //System.out.println("type_booking: "+rskasir.getString("type_booking"));
                    if(rskasir.getString("type_booking") == null){
                        type_booking = "-";
                    }else{
                        switch (rskasir.getString("type_booking")) {
                            case "sidoel" :
                                type_booking = "SiDOL";
                                break;
                            case "jkn" :
                                type_booking = "Mobile JKN";
                                break;
                            case "anjungan" :
                                type_booking = "Anjungan Mandiri";
                                break;
                            case "petugas_registrasi" :
                                type_booking = "Petugas Registrasi";
                                break;
                            default:
                                type_booking = "-";
                        }
                    ...
                    if(rskasir.getString("kehadiran") == null){
                        kehadiran = "-";
                    }else{
                        switch (rskasir.getString("kehadiran")) {
                            case "booking" :
                                kehadiran = "Booking App";
                                break;
                            case "checkin" :
                                kehadiran = "Sudah Checkin App";
                                break;
                            case "petugas_registrasi" :
                                kehadiran = "Didaftarkan Petugas Registrasi";
                                break;
                            case "antri_poli" :
                                kehadiran = "Antri di Poli";
                                break;
                            case "antri_farmasi" :
                                kehadiran = "Antri di Apotek";
                                break;
                            case "antri_kasir" :
                                kehadiran = "Antri di Kasir";
                                break;
                            case "pulang" :
                                kehadiran = "Sudah Pulang";
                                break;
                            default:
                                kehadiran = "-";
                        }
                    ...
                    tabModekasir.addRow(new String[] {
                        ...
                        rskasir.getString("ihs_number"),
                        rskasir.getString("practitioner_ihs"),
                        rskasir.getString("nm_pasien"),
                        rskasir.getString("id_lokasi_satusehat")
                    });
                }
                // table autofit
                for (int col = 0; col < tbKasirRalan.getColumnCount(); col++) {
                    TableColumn column = tbKasirRalan.getColumnModel().getColumn(col);
                    int maxWidth = 50; // minimal lebar kolom

                    for (int row = 0; row < tbKasirRalan.getRowCount(); row++) {
                        TableCellRenderer renderer = tbKasirRalan.getCellRenderer(row, col);
                        Component comp = tbKasirRalan.prepareRenderer(renderer, row, col);
...
//                    System.out.println("tambahan_query_no_sep belum: "+tambahan_query_no_sep);
            ...
            semua=caripenjab.equals("")&&CrPoli.getText().trim().equals("")&&CrPtg.getText().trim().equals("")&&cmbStatus.getSelectedItem().toString().equals("Semua")&&cmbStatusBayar.getSelectedItem().toString().equals("Semua")&&cmbStatusSep.getSelectedItem().toString().equals("Semua")&&TCari.getText().trim().equals("");
            String query_rujuk_internal = "select \n" +
                                            "  reg_periksa.no_rawat, \n" +
                                            "  reg_periksa.tgl_registrasi, \n" +
                                            "  reg_periksa.jam_reg, \n" +
                                            ...
                                            "  left join view_anjungan on reg_periksa.no_rawat=view_anjungan.param_2 \n"+
                                            ...
                                            "  and ? "+tambahan_query_no_sep+tambahan_query_kehadiran_pasien_online+tambahan_query_tracking_pasien+
            ...
            pskasir=koneksi.prepareStatement(query_rujuk_internal);
            try{
                pskasir.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                pskasir.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                if(!semua){
...
//                System.out.println("query_rujuk_internal: "+pskasir.toString());
                rskasir=pskasir.executeQuery();
                String type_booking = "-";
                String kehadiran = "-";
                while(rskasir.next()){
...
//                    }
    ...
    private void getDatakasir() {
        if(tbKasirRalan.getSelectedRow()!= -1){
            ...
            TNoReg.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),2).toString());
            TNoRMCari.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),3).toString());
            TPasienCari.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),4).toString());
            TNoSep.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),7).toString());
            IHS_SatuSehat.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),23).toString());
            Practitioner_SatuSehat.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),24).toString());
            Patient_SatuSehat.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),25).toString());
            Location_SatuSehat.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),26).toString());
        }
    }
    ...
    private void getDatakasir2() {
        if(tbKasirRalan2.getSelectedRow()!= -1){
            TNoRwCari.setText(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),12).toString());
            TNoReg.setText("-");
    ...
    private void initJPopupMenu1(){
        ...
        MnPenilaianPreInduksi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPenilaianPreInduksi.setForeground(new java.awt.Color(50, 50, 50));
        MnPenilaianPreInduksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenilaianPreInduksi.setText("Skor Bromage Pasca Anestesi");
        ...
        MnPenilaianPreInduksi.setName("MnPenilaianPreInduksi"); // NOI18N
        MnPenilaianPreInduksi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnPenilaianPreInduksi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPenilaianPreInduksiActionPerformed(evt);
            }
        });
        ...
        MnHasilPemeriksaanUSGUrologi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHasilPemeriksaanUSGUrologi.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilPemeriksaanUSGUrologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnHasilPemeriksaanUSGUrologi.setText("Deteksi Dini Corona");
        ...
        MnHasilPemeriksaanUSGUrologi.setName("MnHasilPemeriksaanUSGUrologi"); // NOI18N
        MnHasilPemeriksaanUSGUrologi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnHasilPemeriksaanUSGUrologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilPemeriksaanUSGUrologiBtnPrintActionPerformed(evt);
            }
        });
        MnDataRM.add(MnHasilPemeriksaanUSGUrologi);

        MnHasilPemeriksaanUSGGynecologi.setBackground(new java.awt.Color(255, 255, 254));
        MnHasilPemeriksaanUSGGynecologi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHasilPemeriksaanUSGGynecologi.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilPemeriksaanUSGGynecologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnHasilPemeriksaanUSGGynecologi.setText("Deteksi Dini Corona");
        ...
        MnHasilPemeriksaanUSGGynecologi.setName("MnHasilPemeriksaanUSGGynecologi"); // NOI18N
        MnHasilPemeriksaanUSGGynecologi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnHasilPemeriksaanUSGGynecologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilPemeriksaanUSGGynecologiBtnPrintActionPerformed(evt);
            }
        });
        MnDataRM.add(MnHasilPemeriksaanUSGGynecologi);
        ...
        MnHasilPemeriksaanEKG.setText("Deteksi Dini Corona");
        ...
        MnHasilPemeriksaanEKG.setPreferredSize(new java.awt.Dimension(210, 26));
        MnHasilPemeriksaanEKG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilPemeriksaanEKGBtnPrintActionPerformed(evt);
            }
        });
        MnDataRM.add(MnHasilPemeriksaanEKG);
        ...
        MnPenatalaksanaanTerapiOkupasi.setText("Deteksi Dini Corona");
        ...
        MnPenatalaksanaanTerapiOkupasi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnPenatalaksanaanTerapiOkupasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPenatalaksanaanTerapiOkupasiBtnPrintActionPerformed(evt);
            }
        });
        MnDataRM.add(MnPenatalaksanaanTerapiOkupasi);
        ...
        PrintSuratKontrolBPJS.setName("MnKamarInap"); // NOI18N
