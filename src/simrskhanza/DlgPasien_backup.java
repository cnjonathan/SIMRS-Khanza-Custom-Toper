 ...
 * @author igos
 */
public class DlgPasien_backup extends javax.swing.JDialog {
    ...
    private String kdkel="",kdkec="",kdkab="",kdprop="",pengurutan="",asalform="",bulan="",tahun="",awalantahun="",awalanbulan="",posisitahun="",
            ...
            alamat_satu_sehat="",province_codes="",city_codes="",district_codes="";
     ...
     * @param parent
     * @param modal*/
    public DlgPasien_backup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-05-2025" }));
        ...
        Alamat.setBounds(500, 160, 370, 23);
        ...
        jLabel15.setBounds(649, 132, 90, 23);
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-05-2025" }));
        ...
        BtnKelurahan.setBounds(650, 190, 28, 23);
        ...
        nmjabatantni.setBounds(110, 490, 250, 23);
        ...
        BtnCekPasienSatuSehat.setPreferredSize(new java.awt.Dimension(100, 30));
        ...
        FormInput.add(BtnCekPasienSatuSehat);
        BtnCekPasienSatuSehat.setBounds(20, 530, 200, 30);
        ...
        FormInput.add(id_satu_sehat);
        id_satu_sehat.setBounds(320, 530, 250, 30);

        jLabel1.setForeground(java.awt.Color.black);
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("ID Satu Sehat:");
        jLabel1.setName("jLabel1"); // NOI18N
        FormInput.add(jLabel1);
        jLabel1.setBounds(230, 530, 80, 30);
        ...
        jPanel6.add(AlamatSatuSehatRW, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 90, -1));
        ...
        jPanel6.add(AlamatSatuSehatRT, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 90, -1));

        FormInput.add(jPanel6);
        jPanel6.setBounds(890, 10, 350, 220);

        jPanel7.setBackground(new java.awt.Color(255, 255, 255));
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 204, 204), 2, true), "WAJIB! Alamat Penanggung Jawab Pasien Satu Sehat"));
        ...
        jPanel7.add(AlamatSatuSehatRWPJ, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 90, -1));
        ...
        jPanel7.add(AlamatSatuSehatRTPJ, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 90, -1));

        FormInput.add(jPanel7);
        jPanel7.setBounds(890, 230, 350, 220);
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPasien_backup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            DlgPasien_backup dialog = new DlgPasien_backup(new javax.swing.JFrame(), true);
    ...
    private void cek_pasien_satu_sehat() {
        try {
            ...
            Request request = new Request.Builder()
              .url("https://api-satusehat-stg.dto.kemkes.go.id/fhir-r4/v1/Patient?identifier=https://fhir.kemkes.go.id/id/nik|9104025209000006")
              .method("GET", null)
            ...
            if (entries != null && entries.size() > 0) {
                ...
                Request request_satusehat_pasien = new Request.Builder()
                  ...
                  .addHeader("Authorization", "Bearer "+api.TokenSatuSehat()+"")
                  .build();
                Response response_satusehat_pasien = client.newCall(request_satusehat_pasien).execute();
                if (response_satusehat_pasien.isSuccessful()) {
                    ...
                    JsonArray entries_satusehat_pasien = root_satusehat_pasien.getAsJsonArray("entry");
                    System.out.println("Berhasil! Status: " + response_satusehat_pasien.code());
                    System.out.println("Isi respons: " + responseBody);
                } else {
                    // Jika status code selain 200
                    System.out.println("Gagal! Status: " + response.code());
                }
            }
        } catch (IOException ex) {
            Logger.getLogger(DlgPasien_backup.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void openDialogSatuSehatProvince() {
        try {
            ...
            RequestBody body = RequestBody.create(mediaType, "");
            Request request = new Request.Builder()
              .url("https://api-satusehat-stg.kemkes.go.id/masterdata/v1/provinces")
              .method("GET", null)
              .addHeader("Authorization", "Bearer "+api.TokenSatuSehat()+"")
              .build();
            Response response = client.newCall(request).execute();
    ...
    private void openDialogSatuSehatCity() {
        ...
        try {
            ...
            RequestBody body = RequestBody.create(mediaType, "");
            Request request = new Request.Builder()
              .url("https://api-satusehat-stg.kemkes.go.id/masterdata/v1/cities?province_codes="+province_codes+"")
              .method("GET", null)
              .addHeader("Authorization", "Bearer "+api.TokenSatuSehat()+"")
              .build();
            Response response = client.newCall(request).execute();
    ...
    private void openDialogSatuSehatDistrict() {
        ...
        try {
            ...
            RequestBody body = RequestBody.create(mediaType, "");
            Request request = new Request.Builder()
              .url("https://api-satusehat-stg.kemkes.go.id/masterdata/v1/districts?city_codes="+city_codes+"")
              .method("GET", null)
              .addHeader("Authorization", "Bearer "+api.TokenSatuSehat()+"")
              .build();
            Response response = client.newCall(request).execute();
    ...
    private void openDialogSatuSehatSubDistrict() {
        ...
        try {
            ...
            RequestBody body = RequestBody.create(mediaType, "");
            Request request = new Request.Builder()
              .url("https://api-satusehat-stg.kemkes.go.id/masterdata/v1/sub-districts?district_codes="+district_codes+"")
              .method("GET", null)
              .addHeader("Authorization", "Bearer "+api.TokenSatuSehat()+"")
              .build();
            Response response = client.newCall(request).execute();
