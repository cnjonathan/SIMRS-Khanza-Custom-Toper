...
public final class DlgRawatInap extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,
            tabModePemeriksaan,tabModeObstetri,tabModeGinekologi, TabModeHasilLab, TabModeHasilRadiologi,
    ...
    private PreparedStatement ps,ps2,ps3,ps4,ps5,psrekening,ps6,pskasir,ps_hasil_radiologi, ps_hasil_lab, ps_detail_hasil_lab, ps_penilaian_awal_medis;
    private ResultSet rs,rsrekening,rskasir, rs_hasil_radiologi, rs_hasil_lab, rs_detail_hasil_lab, rs_penilaian_awal_medis;
    ...
    private String Suspen_Piutang_Tindakan_Ranap="",Tindakan_Ranap="",Beban_Jasa_Medik_Dokter_Tindakan_Ranap="",Utang_Jasa_Medik_Dokter_Tindakan_Ranap="",
            ...
            HPP_BHP_Tindakan_Ranap="",Persediaan_BHP_Tindakan_Ranap="",kode_poli="",kamar="",jenisbayar="", noorder="", kd_pj="";
...
//                 java.lang.Boolean.class, 
    ...
    private void initComponents() {
        ...
        BtnCopyResep2 = new widget.Button();
        BtnInputResep = new widget.Button();
        jLabel23 = new widget.Label();
        TTanggalSOAPIE = new widget.TextBox();
        jLabel24 = new widget.Label();
        TJamSOAPIE = new widget.TextBox();
        TMenitSOAPIE = new widget.TextBox();
        TDetikSOAPIE = new widget.TextBox();
        BtnCopyResep3 = new widget.Button();
        ...
        PanelInput1.setPreferredSize(new java.awt.Dimension(192, 500));
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(46, 480));
        ...
        scrollPane2.setBounds(70, 230, 360, 150);
        ...
        jLabel26.setBounds(440, 230, 90, 23);
        ...
        scrollPane4.setBounds(540, 230, 360, 150);
        ...
        jLabel55.setBounds(440, 390, 90, 23);
        ...
        scrollPane7.setBounds(540, 390, 360, 50);

        jLabel56.setText("SpO2 (%) :");
        jLabel56.setName("jLabel56"); // NOI18N
        panelGlass12.add(jLabel56);
        jLabel56.setBounds(0, 450, 70, 23);
        ...
        SpO2.setBounds(70, 450, 42, 23);

        jLabel22.setText("GCS (E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(120, 450, 70, 23);
        ...
        TGCS.setBounds(190, 450, 42, 23);

        jLabel58.setText("Kesadaran :");
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass12.add(jLabel58);
        jLabel58.setBounds(240, 450, 70, 23);
        ...
        cmbKesadaran.setBounds(310, 450, 126, 23);
        ...
        scrollPane8.setBounds(540, 450, 360, 44);

        jLabel59.setText("Evaluasi :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelGlass12.add(jLabel59);
        jLabel59.setBounds(440, 450, 90, 23);
        ...
        TSuhu.setBounds(70, 390, 55, 23);

        jLabel17.setText("TB (Cm) :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass12.add(jLabel17);
        jLabel17.setBounds(0, 420, 70, 23);
        ...
        TTinggi.setBounds(70, 420, 55, 23);

        jLabel4.setText("Tensi (mmHg) :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass12.add(jLabel4);
        jLabel4.setBounds(130, 390, 90, 23);
        ...
        TTensi.setBounds(220, 390, 74, 23);
        ...
        TBerat.setBounds(220, 420, 64, 23);
        ...
        TNadi.setBounds(380, 390, 55, 23);

        jLabel61.setText("Nadi (/menit) :");
        jLabel61.setName("jLabel61"); // NOI18N
        panelGlass12.add(jLabel61);
        jLabel61.setBounds(300, 390, 79, 23);

        BtnCopyResep2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/editcopy.png"))); // NOI18N
        BtnCopyResep2.setMnemonic('S');
        BtnCopyResep2.setText("Copy Resep");
        BtnCopyResep2.setToolTipText("Alt+S");
        BtnCopyResep2.setIconTextGap(3);
        BtnCopyResep2.setName("BtnCopyResep2"); // NOI18N
        BtnCopyResep2.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnCopyResep2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCopyResep2ActionPerformed(evt);
            }
        });
        BtnCopyResep2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnCopyResep2KeyPressed(evt);
            }
        });
        panelGlass12.add(BtnCopyResep2);
        BtnCopyResep2.setBounds(910, 120, 220, 20);

        BtnInputResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/FirstAidKit.png"))); // NOI18N
        BtnInputResep.setMnemonic('S');
        BtnInputResep.setText("Input Resep");
        BtnInputResep.setToolTipText("Alt+S");
        BtnInputResep.setIconTextGap(3);
        BtnInputResep.setName("BtnInputResep"); // NOI18N
        BtnInputResep.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnInputResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputResepActionPerformed(evt);
            }
        });
        BtnInputResep.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnInputResepKeyPressed(evt);
            }
        });
        panelGlass12.add(BtnInputResep);
        BtnInputResep.setBounds(910, 90, 220, 20);

        jLabel23.setText("Tanggal :");
        jLabel23.setName("jLabel23"); // NOI18N
        panelGlass12.add(jLabel23);
        jLabel23.setBounds(910, 10, 60, 23);

        TTanggalSOAPIE.setHighlighter(null);
        TTanggalSOAPIE.setName("TTanggalSOAPIE"); // NOI18N
        TTanggalSOAPIE.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TTanggalSOAPIEKeyPressed(evt);
            }
        });
        panelGlass12.add(TTanggalSOAPIE);
        TTanggalSOAPIE.setBounds(980, 10, 150, 23);

        jLabel24.setText("Waktu :");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass12.add(jLabel24);
        jLabel24.setBounds(910, 40, 60, 23);

        TJamSOAPIE.setHighlighter(null);
        TJamSOAPIE.setName("TJamSOAPIE"); // NOI18N
        TJamSOAPIE.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TJamSOAPIEKeyPressed(evt);
            }
        });
        panelGlass12.add(TJamSOAPIE);
        TJamSOAPIE.setBounds(980, 40, 50, 23);

        TMenitSOAPIE.setHighlighter(null);
        TMenitSOAPIE.setName("TMenitSOAPIE"); // NOI18N
        TMenitSOAPIE.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TMenitSOAPIEKeyPressed(evt);
            }
        });
        panelGlass12.add(TMenitSOAPIE);
        TMenitSOAPIE.setBounds(1030, 40, 50, 23);

        TDetikSOAPIE.setHighlighter(null);
        TDetikSOAPIE.setName("TDetikSOAPIE"); // NOI18N
        TDetikSOAPIE.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TDetikSOAPIEKeyPressed(evt);
            }
        });
        panelGlass12.add(TDetikSOAPIE);
        TDetikSOAPIE.setBounds(1080, 40, 50, 23);

        BtnCopyResep3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/menu.png"))); // NOI18N
        BtnCopyResep3.setMnemonic('S');
        BtnCopyResep3.setText("Resep Pasien Pulang");
        BtnCopyResep3.setToolTipText("Alt+S");
        BtnCopyResep3.setIconTextGap(3);
        BtnCopyResep3.setName("BtnCopyResep3"); // NOI18N
        BtnCopyResep3.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnCopyResep3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCopyResep3ActionPerformed(evt);
            }
        });
        BtnCopyResep3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnCopyResep3KeyPressed(evt);
            }
        });
        panelGlass12.add(BtnCopyResep3);
        BtnCopyResep3.setBounds(910, 150, 220, 20);

        jScrollPane1.setViewportView(panelGlass12);

        PanelInput1.add(jScrollPane1, java.awt.BorderLayout.PAGE_START);
        ...
        jSplitPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Hasil Lab"));
    ...
    private void BtnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalActionPerformed
        ...
        TNoRw.requestFocus();
        TTanggalSOAPIE.setText("");
        TJamSOAPIE.setText("");
        TMenitSOAPIE.setText("");
        TDetikSOAPIE.setText("");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnResepObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResepObatActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            TindakLanjut.setText("");
            int cek_soapie = Sequel.cariInteger("SELECT COUNT(*) FROM pemeriksaan_ranap WHERE no_rawat='"+TNoRw.getText()+"' AND nip='"+KdPeg.getText()+"' AND tgl_perawatan = CURDATE()");
            System.out.println("cek_soapie : "+cek_soapie);
            if(cek_soapie > 0){
                if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                    JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi ..!!");
                }else{
                    ...
                    resep.setTanggalWaktuResep(TTanggalSOAPIE.getText(), TJamSOAPIE.getText(), TMenitSOAPIE.getText(), TDetikSOAPIE.getText());
                    resep.isCek();
                    resep.tampilobat();
                    resep.setVisible(true);
                }
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, Dokter belum mengisi Asesmen " + TPegawai.getText());
                TCari.requestFocus();
            }
        }
    ...
    private void BtnCopyResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResepActionPerformed
        ...
        if(cek_soapie > 0){
            if(TNoRw.getText().trim().equals("")){
                ...
                daftar.setTanggalWaktuResep(TTanggalSOAPIE.getText(), TJamSOAPIE.getText(), TMenitSOAPIE.getText(), TDetikSOAPIE.getText());
                daftar.tampil();
    ...
    private void BtnAwalMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            try {
                ...
                Logger.getLogger(DlgRawatInap.class.getName()).log(Level.SEVERE, null, ex);
            }
            this.setCursor(Cursor.getDefaultCursor());
        }
        ...
        try {
            if(tb_hasil_lab.getValueAt(tb_hasil_lab.getSelectedRow(), 1).toString() != null){
                switch (tb_hasil_lab.getValueAt(tb_hasil_lab.getSelectedRow(), 1).toString()) {
                    ...
                    ps_detail_hasil_lab.setString(1,tb_hasil_lab.getValueAt(tb_hasil_lab.getSelectedRow(), 0).toString());
                    ...
                    while(rs_detail_hasil_lab.next()){
                        ...
                        if(rs_detail_hasil_lab.getString("status").equals("Ranap")){
                            kamar=Sequel.cariIsi(
                                ...
                                " and kamar_inap.kd_kamar=kamar.kd_kamar where no_rawat=? order by tgl_masuk desc limit 1 ",rs_detail_hasil_lab.getString("no_rawat"));
                        }

                        TabModeDetailHasilLab.addRow(new String[]{
                            // rs_detail_hasil_lab.getString("no_rawat"),
                            rs_detail_hasil_lab.getString("no_rkm_medis")+" "+rs_detail_hasil_lab.getString("nm_pasien")+" ("+rs_detail_hasil_lab.getString("png_jawab")+")",
                            ...
                            Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rs_detail_hasil_lab.getString("dokter_perujuk")),
                    ...
                    while(rs_detail_hasil_lab.next()){
                        ...
                        TabModeDetailHasilLab.addRow(new String[]{
                            ...
                            rs_detail_hasil_lab.getString("satuan"),
                            rs_detail_hasil_lab.getString("nilai_rujukan"),
                            rs_detail_hasil_lab.getString("keterangan")+"; Kesan:"+rs_detail_hasil_lab.getString("kesan"),
                            kamar,
    ...
    private void tb_hasil_radiologiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_hasil_radiologiMouseClicked
        if(TabModeHasilRadiologi.getRowCount()!=0){
            try {
                ...
                String kd_jenis_prw_pacs = (String) tb_hasil_radiologi.getValueAt(tb_hasil_radiologi.getSelectedRow(), 2);
                ...
                if(rs_detail_radiologi.next()){
                    ...
                    // + "tindakan_radiologi: "+rs_detail_radiologi.getString("tindakan_radiologi")+"\n"
                ...
                if(evt.getClickCount()==2){
                    ...
                    if(selectedcolumn==5){
                        try {
                            Desktop.getDesktop().browse(new URL(tb_hasil_radiologi.getValueAt(tb_hasil_radiologi.getSelectedRow(), selectedcolumn).toString()).toURI());
    ...
    private void BtnCopyResep2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResep2ActionPerformed
        BtnCopyResepActionPerformed(evt);
    }//GEN-LAST:event_BtnCopyResep2ActionPerformed

    private void BtnCopyResep2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCopyResep2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnCopyResep2KeyPressed
    ...
    private void BtnInputResepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnInputResepKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnInputResepKeyPressed

    private void TTanggalSOAPIEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTanggalSOAPIEKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TTanggalSOAPIEKeyPressed

    private void TJamSOAPIEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TJamSOAPIEKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TJamSOAPIEKeyPressed

    private void TMenitSOAPIEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TMenitSOAPIEKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TMenitSOAPIEKeyPressed

    private void TDetikSOAPIEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDetikSOAPIEKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TDetikSOAPIEKeyPressed

    private void BtnCopyResep3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResep3ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{            
    ...
    }//GEN-LAST:event_BtnCopyResep3ActionPerformed

    private void BtnCopyResep3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCopyResep3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnCopyResep3KeyPressed
    ...
    */
    ...
    private widget.Button BtnCopyResep2;
    private widget.Button BtnCopyResep3;
    ...
    private widget.TextBox TDetikSOAPIE;
    ...
    private widget.TextBox TJamSOAPIE;
    ...
    private widget.TextBox TMenitSOAPIE;
    ...
    private widget.TextBox TTanggalSOAPIE;
    ...
    public void setNoRm(String norwt,Date awal,Date akhir) {
        ...
        if(Sequel.cariInteger("SELECT COUNT(*) FROM dpjp_ranap WHERE no_rawat = '"+norwt+"' AND kd_dokter = '"+kode_user+"'") > 0){
            KdDok.setText(kode_user);
        }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput1.setPreferredSize(new Dimension(WIDTH,500));
                ...
                while(rs_hasil_lab.next()){
                    ...
                    if(rs_hasil_lab.getString("kategori") != null){
                        switch (rs_hasil_lab.getString("kategori")) {
                            case "PK":
                                noorder = Sequel.cariIsi("SELECT noorder FROM `permintaan_lab` WHERE no_rawat = ?", rs_hasil_lab.getString("no_rawat"));
                                break;
                            case "PA":
                                noorder = Sequel.cariIsi("SELECT noorder FROM `permintaan_labpa` WHERE no_rawat = ?", rs_hasil_lab.getString("no_rawat"));
                                break;
                            case "MB":
                                noorder = Sequel.cariIsi("SELECT noorder FROM `permintaan_labmb` WHERE no_rawat = ?", rs_hasil_lab.getString("no_rawat"));
                                break;
                            default:
                                noorder="-";
                        }
...
//                                         "SELECT  "
//                                                 + "permintaan_radiologi.noorder, " //"No Order",
//                                                 + "permintaan_radiologi.no_rawat, " //"No Rawat",
...
//                                            + "LEFT JOIN reg_periksa ON reg_periksa.no_rawat = permintaan_radiologi.no_rawat "
//                                            + "LEFT JOIN hasil_pacs_radiologi ON hasil_pacs_radiologi.no_order = permintaan_radiologi.noorder "
//                                            + "WHERE reg_periksa.no_rkm_medis = ? "
//                                            + "ORDER BY permintaan_radiologi.no_rawat DESC"); 
...
//                                            + "LEFT JOIN reg_periksa on reg_periksa.no_rkm_medis = hasil_pacs_radiologi.no_rm "
//                                            + "LEFT JOIN periksa_radiologi  on periksa_radiologi.no_rawat = reg_periksa.no_rawat "
//                                            + "LEFT JOIN permintaan_radiologi  on permintaan_radiologi.no_rawat = reg_periksa.no_rawat "
    ...
    private void tampilPemeriksaan() {
        ...
        try{  
            ...
            try{
                ...
                rs=ps4.executeQuery();
                if(!rs.next()){
                    String query_asesmen_medis = "SELECT * FROM penilaian_medis_ranap WHERE no_rawat = '"+TNoRw.getText()+"'";
                    String subjektif = "", objektif = "", asesmen = "", plan = "", intruksi = "", evaluasi = "";
                    ps_penilaian_awal_medis = koneksi.prepareStatement(query_asesmen_medis);
                    rs_penilaian_awal_medis = ps_penilaian_awal_medis.executeQuery();
                    if(rs_penilaian_awal_medis.next()){
                        subjektif = rs_penilaian_awal_medis.getString("keluhan_utama")+"\n"+
                                    "Riwayat penyakit sekarang: " +rs_penilaian_awal_medis.getString("rps")+"\n"+
                                    "Riwayat penyakit dahulu: " +rs_penilaian_awal_medis.getString("rpd")+"\n"+
                                    "Riwayat penyakit keluarga: " +rs_penilaian_awal_medis.getString("rpk")+"\n"+
                                    "Riwayat penggunaan obat: "+rs_penilaian_awal_medis.getString("rpo")+"\n";
                        objektif = "Kepala "+rs_penilaian_awal_medis.getString("kepala")+", Mata "+rs_penilaian_awal_medis.getString("mata")+
                                    ", Gigi "+rs_penilaian_awal_medis.getString("gigi")+", THT "+rs_penilaian_awal_medis.getString("tht")+
                                    ", Thoraks "+rs_penilaian_awal_medis.getString("thoraks")+", Jantung "+rs_penilaian_awal_medis.getString("jantung")+
                                    ", Paru-paru "+rs_penilaian_awal_medis.getString("paru")+", Abdomen "+rs_penilaian_awal_medis.getString("abdomen")+
                                    ", Genital "+rs_penilaian_awal_medis.getString("genital")+", Ekstremitas "+rs_penilaian_awal_medis.getString("ekstremitas")+
                                    ", Kulit "+rs_penilaian_awal_medis.getString("kulit")+"\nKeterangan fisik: "+rs_penilaian_awal_medis.getString("ket_fisik")+
                                    "\nKeterangan lokalis: "+rs_penilaian_awal_medis.getString("ket_lokalis");
                        asesmen = rs_penilaian_awal_medis.getString("diagnosis");
                        evaluasi = "Pasien masih dalam observasi. ";
                        TKeluhan.setText(subjektif);
                        TPemeriksaan.setText(objektif);
                        TPenilaian.setText(asesmen);
                        TEvaluasi.setText(evaluasi);
                        TAlergi.setText(rs_penilaian_awal_medis.getString("alergi"));
                        TSuhu.setText(rs_penilaian_awal_medis.getString("suhu"));
                        TTensi.setText(rs_penilaian_awal_medis.getString("td"));
                        TBerat.setText(rs_penilaian_awal_medis.getString("bb"));
                        TTinggi.setText(rs_penilaian_awal_medis.getString("tb"));
                        TRespirasi.setText(rs_penilaian_awal_medis.getString("rr"));
                        TNadi.setText(rs_penilaian_awal_medis.getString("nadi"));
                        SpO2.setText(rs_penilaian_awal_medis.getString("spo"));
                        TGCS.setText(rs_penilaian_awal_medis.getString("gcs"));
                        cmbKesadaran.setSelectedItem(rs_penilaian_awal_medis.getString("kesadaran"));
                    }
                }
                rs.beforeFirst();
                while(rs.next()){
                ...
                if(rs_penilaian_awal_medis!=null){
                    rs_penilaian_awal_medis.close();
                }
                if(ps_penilaian_awal_medis!=null){
                    ps_penilaian_awal_medis.close();
                }
            }                  
        }catch(Exception e){
            System.out.println("Notifikasi : "+e);
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            TTanggalSOAPIE.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),4).toString());
            TJamSOAPIE.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),5).toString().substring(0,2));
            TMenitSOAPIE.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),5).toString().substring(3,5));
            TDetikSOAPIE.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),5).toString().substring(6,8));
        }
    }
