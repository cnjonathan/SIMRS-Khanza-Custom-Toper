...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password",
                ...
                "[K]Deposit Pasien",
                "[K]Piutang Pasien",
                "[M]Peminjaman Berkas RM",
                "[C]Barcode Presensi",
                "[C]Presensi Harian",
                "[C]Presensi Bulanan",
                "[C]Pegawai Admin",
                "[C]Pegawai User",
                "[D]Suplier Obat/Alkes/BHP",
                "[D]Satuan Barang",
                "[D]Konversi Satuan",
                "[D]Jenis Obat/Alkes/BHP",
                "[D]Obat, Alkes & BHP",
                "[D]Stok Opname Apotek",
                "[D]Stok Obat Pasien",
                "[D]Pengadaan Obat, Alkes & BHP",
                "[D]Penerimaan Obat, Alkes & BHP",
                "[D]Penjualan Obat, Alkes & BHP",
                "[D]Piutang Obat, Alkes & BHP",
                "[D]Retur Ke Suplier",
                "[D]Retur Dari Pembeli",
                "[D]Retur Obat, Alkes & BHP Ranap",
                "[D]Retur Piutang Pembeli",
                "[D]Keuntungan Penjualan",
                "[D]Keuntungan Beri Obat, Alkes & BHP",
                "[D]Sirkulasi Obat, Alkes & BHP",
                "[E]Barang Non Medis",
                "[E]Pengadaan Barang Nonmedis",
                "[E]Stok Keluar Non Medis",
                "[E]Rekap Pengadaan Non Medis",
                "[E]Rekap Stok Keluar Non Medis",
                "[E]Biaya Pengadaan Non Medis",
                "[G]Jenis Inventaris",
                "[G]Kategori Inventaris",
                "[G]Merk Inventaris",
                "[G]Ruang Inventaris",
                "[G]Produsen Inventaris",
                "[G]Koleksi Inventaris",
                "[G]Inventaris",
                "[G]Sirkulasi Inventaris",
                "[H]Jenis Parkir",
                "[H]Parkir Masuk",
                "[H]Parkir Keluar",
                "[H]Rekap Parkir Harian",
                "[H]Rekap Parkir Bulanan",
                "[A]Informasi Kamar",
                "[I]Harian Dokter Poli",
                "[I]Obat Per Poli",
                "[I]Obat Per Kamar",
                "[I]Obat Per Dokter Ralan",
                "[I]Obat Per Dokter Ranap",
                "[I]Harian Dokter",
                "[I]Bulanan Dokter",
                "[I]Harian Paramedis",
                "[I]Bulanan Paramedis",
                ...
                "[K]Cash Flow",
                "[K]Keuangan",
                "[K]Pengeluaran Harian",
                "[T]Set P.J. Unit Penunjang",
                "[T]Set Oto Lokasi",
                "[T]Set Kamar Inap",
                "[T]Set Embalase & Tuslah",
                "[T]Tracer Login",
                "[T]Display Antrian Registrasi & Poli",
                "[T]Set Harga Obat",
                "[T]Set Penggunaan Tarif",
                "[T]Set Oto Ralan",
                "[T]Biaya Harian Kamar",
                "[T]Biaya Masuk Sekali",
                "[T]Set RM",
                "[A]Billing Ralan",
                "[A]Billing Ranap",
                "[I]Detail JM Dokter",
                ...
                "[B]Barcode Ralan",
                "[B]Barcode Ranap",
                "[T]Set Harga Obat Ralan",
                "[T]Set Harga Obat Ranap",
                "[J]Penyakit AFP & PD3I",
                "[J]Surveilans AFP & PD3I",
                "[J]Surveilans Ralan",
                "[M]Diagnosa Pasien",
                "[J]Surveilans Ranap",
                "[J]Pny.Tdk Menular Ranap",
                "[J]Pny.Tdk Menular Ralan",
                "[J]Kunjungan Ralan",
                "[J]RL 3.2 Rawat Darurat",
                "[J]RL 3.3 Gigi dan Mulut",
                "[J]RL 3.7 Radiologi",
                "[J]RL 3.8 Laboratorium",
                ...
                "[T]Set Billing",
                "[A]DPJP Ranap",
                "[D]Mutasi Obat/Alkes/BHP",
                "[J]RL 3.4 Kebidanan",
                "[J]RL 3.6 Pembedahan",
                "[I]Fee Visit Dokter",
                "[I]Fee Bacaan EKG",
                "[I]Fee Rujukan Rontgen",
                "[I]Fee Rujukan Ranap",
                "[I]Fee Periksa Ralan",
                "[K]Akun Bayar",
                "[K]Bayar Pesan Obat",
                "[I]Obat Per Dokter Peresep",
                "[E]Jenis Barang Non Medis",
                "[K]Pemasukkan Lain-Lain",
                "[K]Pengaturan Rekening",
                "[T]Closing Kasir",
                "[T]Set Keterlambatan Presensi",
                "[T]Set Harga Kamar",
                "[I]Rekap Per Shift",
                "[L]Cek NIK",
                "[L]Cek No.Kartu",
                "[L]Riwayat Rujukan PCare di VClaim",
                "[I]Obat Per Cara Bayar",
                "[J]Kunjungan Ranap",
                "[K]Bayar Piutang",
                "[I]Payment Point",
                "[L]Cek No.Rujukan PCare di VClaim",
                "[J]ICD 9",
                "[D]Darurat Stok",
                "[M]Retensi Data R.M.",
                "[C]Temporary Presensi",
                "[K]Jurnal Harian",
                "[D]Sirkulasi Obat, Alkes & BHP 2",
                "[A]Edit Registrasi",
                "[L]Referensi Diagnosa VClaim",
                "[L]Referensi Poli VClaim",
                "[D]Industri Farmasi",
                "[I]Harian J.S.",
                "[I]Bulanan J.S.",
                "[I]Harian BHP Medis/Paket Obat",
                "[I]Bulanan BHP Medis/Paket Obat",
                "[K]Piutang Belum Lunas",
                "[L]Referensi Faskes VClaim",
                "[L]Data Bridging SEP VClaim",
                "[D]Pengambilan BHP UTD",
                "[K]Tarif UTD",
                "[N]Pengambilan BHP Medis",
                "[N]BHP Medis Rusak",
                "[E]Pengambilan UTD",
                "[N]Pengambilan BHP Non Medis",
                "[N]BHP Non Medis Rusak",
                "[E]Suplier Non Medis",
                "[N]Donor Darah",
                "[L]Monitoring Verifikasi Klaim",
                "[N]Cekal Darah",
                "[N]Komponen Darah",
                "[N]Stok Darah",
                "[N]Pemisahan Darah",
                "[I]Harian Kamar",
                "[K]Rincian Piutang Pasien",
                "[D]Keuntungan Beri Obat, Alkes & BHP 2",
                "[L]Reklasifikasi Ralan",
                "[L]Reklasifikasi Ranap",
                "[N]Penyerahan Darah",
                "[K]Hutang Obat & BHP",
                "[D]Riwayat Obat, Alkes & BHP",
                "[J]Sensus Harian Poli",
                "[J]RL 4A Sebab Morbiditas Ranap",
                "[L]Referensi Kamar Aplicare",
                "[L]Ketersediaan Kamar Aplicare",
                "[L]Klaim Baru Otomatis INACBG",
                "[L]Klaim Baru Manual INACBG",
                "[L]Coder NIK INACBG",
                "[M]Mutasi Berkas RM",
                "[K]Akun Piutang",
                "[I]Harian KSO",
                ...
                "[I]Harian Menejemen",
                "[I]Bulanan Menejemen",
                "[L]Cek Eligibilitas Inhealth",
                "[L]Referensi Ruang Rawat Inhealth",
                "[L]Referensi Poli Inhealth",
                "[L]Referensi Faskes Inhealth",
                "[L]Data Bridging SJP Inhealth",
                "[I]Piutang Ralan",
                "[I]Piutang Ranap",
                "[K]Piutang Per Cara Bayar",
                "[J]Lama Pelayanan Ralan",
                "[M]Catatan Pasien",
                "[J]RL 4B Sebab Morbiditas Ralan",
                "[J]RL 4A Morbiditas Ralan",
                "[J]RL 4B Morbiditas Ralan",
                "[M]Data HAIs",
                "[J]Harian HAIs",
                "[J]Bulanan HAIs",
                "[J]Hitung BOR",
                "[M]Instansi/Perusahaan Pasien",
                "[D]Resep Dokter",
                "[J]Lama Pelayanan Apotek",
                "[J]Hitung ALOS",
                "[I]Detail Tindakan",
                "[A]Rujukan Poli Internal",
                "[I]Rekap Poli Anak",
                "[O]Registrasi Per Poli",
                "[O]Registrasi Per Dokter",
                "[O]Registrasi Per Pekerjaan",
                "[O]Registrasi Per Pendidikan",
                "[O]Registrasi Per Tahun",
                "[M]Berkas Digital Perawatan",
                "[J]Pny Menular Ranap",
                "[J]Pny Menular Ralan",
                "[O]Registrasi Per Bulan",
                "[O]Registrasi Per Tanggal",
                "[O]Demografi Registrasi",
                "[O]Reg Lama Per Tahun",
                "[O]Reg Baru Per Tahun",
                "[O]Reg Lama Per Bulan",
                "[O]Reg Baru Per Bulan",
                "[O]Reg Lama Per Tanggal",
                "[O]Reg Baru Per Tanggal",
                "[O]Batal Periksa Per Tahun",
                "[O]Batal Periksa Per Bulan",
                "[L]Referensi Diagnosa Pcare",
                "[O]Batal Periksa Per Tanggal",
                "[D]Kategori Obat/Alkes/BHP",
                "[D]Golongan Obat/Alkes/BHP",
                "[D]Obat/Alkes/BHP Per Tanggal",
                "[D]Penjualan Bebas Per Tanggal",
                "[L]Referensi Kesadaran Pcare",
                "[J]Pembatalan Periksa Per Dokter",
                "[I]Pembayaran Per Unit",
                "[I]Rekap Pembayaran Per Unit",
                "[O]Registrasi Per Cara Bayar",
                "[E]Pengadaan Non Medis Per Tanggal",
                "[E]Stok Keluar Non Medis Per Tanggal",
                "[O]Kunjungan Ranap Per Tahun",
                "[L]Cek Rujukan PCare",
                "[O]Kunjungan Lab Ralan Per Tahun",
                "[O]Kunjungan Rad Ralan Per Tahun",
                "[J]Cek Entry Ralan",
                "[L]Klaim Baru Manual INACBG 2",
                "[D]Permintaan Obat & BHP",
                "[D]Ringkasan Permintaan Obat & BHP",
                "[D]Surat Pemesanan Obat & BHP",
                "[E]Permintaan Barang Non Medis",
                "[E]Ringkasan Permintaan Barang Non Medis",
                "[E]Surat Pemesanan Barang Non Medis",
                "[O]Registrasi Per Perujuk",
                "[L]Referensi Prosedur VClaim",
                "[L]Referensi Kelas Rawat VClaim",
                "[L]Referensi Dokter VClaim",
                "[L]Referensi Spesialistik VClaim",
                "[L]Referensi Ruang Rawat VClaim",
                "[L]Referensi Cara Keluar VClaim",
                "[L]Referensi Pasca Pulang VClaim",
                "[I]Detail VK/OK",
                "[A]Billing Parsial",
                "[L]Cek No.Rujukan RS di VClaim",
                "[L]Cek Rujukan Kartu PCare di VClaim",
                "[L]Cek Rujukan Kartu RS di VClaim",
                "[A]Akses Depo Obat/BHP",
                "[L]Pembuatan Rujukan VClaim",
                "[O]Kunjungan Lab Ralan Per Bulan",
                "[D]Stok Keluar Medis",
                "[O]Kunjungan Rad Ralan Per Bulan",
                "[I]Detail JM Dokter 2",
                "[M]Pengaduan/Chat",
                "[O]Kunjungan Lab Ralan Per Tanggal",
                "[O]Kunjungan Rad Ralan Per Tanggal",
                "[J]Sensus Harian Ralan",
                "[D]Metode Racik",
                "[I]Pembayaran Per Akun Bayar",
                "[D]Pengguna Obat/Alkes/BHP Resep",
                "[D]Rekap Penerimaan Obat & BHP",
                "[C]Master Berkas Pegawai",
                "[C]Berkas Kepegawaian",
                "[C]Riwayat Jabatan",
                "[C]Riwayat Pendidikan",
                "[C]Riwayat Naik Gaji",
                "[C]Kegiatan Ilmiah & Pelatihan",
                "[C]Riwayat Penghargaan",
                "[C]Riwayat Penelitian",
                "[E]Penerimaan Barang Non Medis",
                "[K]Bayar Pesan Non Medis",
                "[K]Hutang Barang Non Medis",
                "[E]Rekap Penerimaan Non Medis",
                "[J]Insiden Keselamatan",
                "[M]Insiden Keselamatan Pasien",
                "[O]Kejadian IKP Per Tahun",
                "[O]Kejadian IKP Per Bulan",
                "[O]Kejadian IKP Per Tanggal",
                "[D]Riwayat Batch",
                "[O]Kejadian IKP Per Jenis",
                "[O]Kejadian IKP Per Dampak",
                "[I]Piutang Per Akun Piutang",
                "[O]Registrasi Per Agama",
                "[O]Registrasi Per Umur",
                "[M]Suku/Bangsa Pasien",
                "[M]Bahasa Pasien",
                "[M]Golongan TNI",
                "[M]Satuan TNI",
                "[M]Jabatan TNI",
                ...
                "[O]Registrasi Per Bahasa",
                "[A]Jadwal Operasi",
                "[L]Mapping Poli VClaim",
                "[O]Registrasi Per Cacat Fisik",
                "[G]Barang CSSD",
                "[P]Surat Kontrol",
                "[A]Booking Registrasi",
                "[L]Referensi Propinsi VClaim",
                "[L]Referensi Kabupaten VClaim",
                "[L]Referensi Kecamatan VClaim",
                "[L]Referensi Dokter DPJP VClaim",
                "[L]Riwayat Rujukan RS di VClaim",
                "[L]Tanggal Rujukan di VClaim",
                "[A]Permintaan Lab",
                "[A]Permintaan Radiologi",
                "[P]Indeks Surat",
                "[P]Map Surat",
                "[P]Almari Surat",
                "[P]Rak Surat",
                ...
                "[P]Stts Balas Surat",
                "[P]Surat Masuk",
                "[L]Referensi Dokter PCare",
                "[L]Referensi Poli PCare",
                "[L]Referensi Provider PCare",
                "[L]Referensi Stts Pulang PCare",
                "[L]Referensi Spesialis PCare",
                "[L]Referensi Subspesialis PCare",
                "[L]Referensi Sarana PCare",
                "[L]Referensi Khusus PCare",
                "[L]Referensi Obat PCare",
                "[L]Referensi Tindakan PCare",
                "[L]Faskes Subspesialis PCare",
                "[L]Faskes Alih Rawat PCare",
                "[L]Faskes Thalasemia & Hemofili PCare",
                "[L]Mapping Obat PCare",
                "[L]Tarif Ralan RS & PCare",
                "[L]Club Prolanis PCare",
                "[L]Mapping Poli PCare",
                "[L]Kegiatan Kelompok PCare",
                "[L]Tarif Ranap RS & PCare",
                "[L]Peserta Keg Kelompok PCare",
                "[D]Sirkulasi Obat, Alkes & BHP 3",
                "[L]Data Pendafataran PCare",
                "[L]Mapping Dokter PCare",
                "[J]Ranap Per Ruang",
                "[J]Penyakit Ranap Per Cara Bayar",
                "[J]Anggota TNI Dirawat",
                "[T]Set Input Parsial",
                "[J]Lama Pelayanan Radiologi",
                "[J]Lama Pelayanan Lab",
                "[L]Cek Nomor SEP",
                "[A]Catatan Dokter",
                "[P]Surat Keluar",
                "[D]Kegiatan Farmasi",
                "[E]Stok Opname Non Medis",
                "[E]Sirkulasi Non Medis",
                "[J]Rekap Lab Per Tahun",
                "[J]Perujuk Lab Per Tahun",
                "[J]Rekap Radiologi Per Tahun",
                "[J]Perujuk Radiologi Per Tahun",
                "[J]Rekap Bulanan Porsi Diet",
                "[J]Rekap Bulanan Macam Diet",
                "[I]Payment Point 2",
                "[I]Pembayaran Per Akun Bayar 2",
                "[I]Hapus Nota Salah",
                "[A]Asesmen Awal Rawat Inap",
                "[J]HAIs Per Kamar/Bangsal",
                "[D]PPN Obat",
                "[K]Saldo Akun Per Bulan",
                "[T]Display Antrian Apotek",
                "[L]Referensi Faskes Sisrute",
                "[L]Referensi Alasan Rujuk Sisrute",
                "[L]Referensi Diagnosa Sisrute",
                "[L]Rujukan Masuk Sisrute",
                "[L]Rujukan Keluar Sisrute",
                "[L]Cek SKDP VClaim",
                "[D]Data Batch",
                "[J]Kunjungan Lab Ralan",
                "[J]Kunjungan Lab Ranap",
                "[J]Kunjungan Radiologi Ralan",
                "[J]Kunjungan Radiologi Ranap",
                "[L]Pemberian Obat PCare",
                "[L]Pemberian Tindakan PCare",
                "[I]Pembayaran Per Akun Bayar 3",
                "[T]Password BPJS",
                "[J]Data TB",
                "[L]Ketersediaan Kamar SIRANAP",
                "[O]Periode Laporan TB",
                "[O]Rujukan TB",
                "[O]Riwayat TB",
                "[O]Tipe Diagnosis TB",
                "[O]Status HIV TB",
                ...
                "[O]Konfirmasi Skoring 6 TB",
                "[O]Sumber Obat TB",
                "[O]Hasil Akhir Pengobatan TB",
                "[O]Hasil Tes HIV TB",
                "[D]Kadaluarsa Batch",
                "[D]Sisa Stok",
                "[D]Obat Per Resep",
                "[G]Pemakaian Air PDAM",
                "[G]Limbah Padat B3 Medis",
                "[O]Pemakaian Air PDAM Per Tanggal",
                "[O]Pemakaian Air PDAM Per Bulan",
                "[O]Limbah B3 Padat Per Tanggal",
                "[O]Limbah B3 Padat Per Bulan",
                ...
                "[Q]Pengarang/Penulis",
                "[Q]Penerbit Koleksi",
                "[Q]Koleksi Perpustakaan",
                "[Q]Inventaris Perpustakaan",
                "[Q]Pengaturan Peminjaman",
                "[Q]Denda Perpustakaan",
                "[Q]Anggota Perpustakaan",
                "[Q]Peminjaman Koleksi Perpustakaan",
                "[Q]Bayar Denda Perpustakaan",
                "[Q]Data Koleksi Ebook",
                "[C]Jenis Cidera K3",
                "[C]Penyebab Kecelakaan K3",
                "[C]Jenis Luka K3",
                "[C]Lokasi Kejadian K3",
                "[C]Dampak Cidera K3",
                "[C]Jenis Pekerjaan K3",
                "[C]Bagian Tubuh K3",
                "[C]Peristiwa K3",
                "[O]K3 Per Tahun",
                "[O]K3 Per Bulan",
                "[O]K3 Per Tanggal",
                "[O]K3 Per Jenis Cidera",
                "[O]K3 Per Penyebab Kecelakaan",
                "[O]K3 Per Jenis Luka",
                "[O]K3 Per Lokasi Kejadian",
                "[O]K3 Per Dampak Cidera",
                "[O]K3 Per Jenis Pekerjaan",
                "[O]K3 Per Bagian Tubuh",
                "[C]Jenis Cidera K3 Per Tahun",
                "[C]Penyebab Kecelakaan K3 Per Tahun",
                "[C]Jenis Luka K3 Per Tahun",
                "[C]Lokasi Kejadian K3 Per Tahun",
                "[C]Dampak Cidera K3 Per Tahun",
                "[C]Jenis Pekerjaan K3 Per Tahun",
                "[C]Bagian Tubuh K3 Per Tahun",
                "[A]Skrining Rawat Jalan",
                "[L]Histori Pelayanan BPJS",
                "[J]Rekap Mutasi Berkas",
                "[J]Skrining Pernapasan Ralan Per Tahun",
                "[D]Pengajuan Obat & BHP",
                "[E]Pengajuan Barang Non Medis",
                "[O]Kunjungan Ranap Per Bulan",
                "[O]Kunjungan Ranap Per Tanggal",
                "[O]Kunjungan Ranap Per Ruang",
                "[J]Masuk Ruang Per Tahun",
                "[O]Pegawai Per Jenjang Jabatan",
                "[O]Pegawai Per Bidang/Bagian",
                "[O]Pegawai Per Departemen",
                "[O]Pegawai Per Pendidikan",
                "[O]Pegawai Per Status WP",
                "[O]Pegawai Per Status Kerja",
                "[O]Status Pulang Ranap",
                "[J]KIP Pasien Ranap",
                "[J]KIP Pasien Ralan",
                "[L]Mapping Dokter DPJP VClaim",
                "[M]Data Triase IGD",
                "[M]Master Triase Skala 1",
                "[M]Master Triase Skala 2",
                "[M]Master Triase Skala 3",
                "[M]Master Triase Skala 4",
                "[M]Master Triase Skala 5",
                "[M]Master Triase Pemeriksaan",
                "[M]Master Triase Macam Kasus",
                "[J]Rekap Permintaan Diet",
                "[J]Daftar Pasien Ranap",
                "[J]Daftar Pasien Ranap TNI",
                "[G]Pengajuan Aset/Inventaris",
                "[O]Item Apotek Per Jenis",
                "[O]Item Apotek Per Kategori",
                "[O]Item Apotek Per Golongan",
                "[O]Item Apotek Per Industri Farmasi",
                "[D]10 Obat Terbanyak Poli",
                "[O]Pengajuan Aset Per Urgensi",
                "[O]Pengajuan Aset Per Status",
                "[O]Pengajuan Aset Per Departemen",
                "[G]Rekap Pengajuan Aset Departemen",
                "[O]Pegawai Per Kelompok Jabatan",
                "[O]Pegawai Per Risiko Kerja",
                "[O]Pegawai Per Emergency Index",
                "[O]Jumlah Inventaris Per Ruang",
                "[J]Harian HAIs 2",
                "[O]Jumlah Inventaris Per Jenis",
                "[M]Resume Pasien",
                "[A]Perkiraan Biaya Ranap",
                "[D]Rekap Obat Per Poli",
                "[D]Rekap Obat Per Pasien",
                "[G]Permintaan Perbaikan Inventaris",
                "[O]Pasien HAIs Per Ruang",
                "[O]Pasien HAIs Per Bulan",
                "[O]Laju HAIs VAP Per Ruang",
                "[O]Laju HAIs IAD Per Ruang",
                "[O]Laju HAIs Plebitis Per Ruang",
                "[O]Laju HAIs ISK Per Ruang",
                "[O]Laju HAIs ILO Per Ruang",
                "[O]Laju HAIs HAP Per Ruang",
                "[L]Mapping Poli Inhealth",
                "[L]Mapping Dokter Inhealth",
                "[L]Tarif Ralan Inhealth",
                "[L]Tarif Ranap Inhealth",
                "[L]Tarif Radiologi Inhealth",
                "[L]Tarif Laborat Inhealth",
                "[L]Tarif Operasi Inhealth",
                "[D]Hibah Obat & BHP",
                "[G]Asal Hibah",
                "[M]Asuhan Gizi",
                "[L]Tagihan Inhealth",
                "[D]Sirkulasi Obat, Alkes & BHP 4",
                "[D]Sirkulasi Obat, Alkes & BHP 5",
                "[E]Sirkulasi Non Medis 2",
                ...
                "[A]Permintaan Diet",
                "[M]Master Masalah Keperawatan",
                "[C]Pengajuan Cuti",
                "[J]Kedatangan Pasien Per Jam",
                "[N]Data Pendonor",
                "[R]Suplier Toko",
                "[R]Jenis Barang Toko",
                "[T]Set Harga Toko",
                "[R]Barang Toko",
                "[K]Penagihan Piutang Pasien",
                "[K]Akun Penagihan Piutang",
                "[R]Stok Opname Toko",
                "[R]Riwayat Barang Toko",
                "[R]Surat Pemesanan Toko",
                "[R]Pengajuan Barang Toko",
                "[R]Penerimaan Barang Toko",
                "[R]Pengadaan Barang Toko",
                "[R]Hutang Toko",
                "[R]Bayar Pesan Toko",
                "[R]Member Toko",
                "[R]Penjualan Toko",
                "[J]Registrasi Poli Per Tanggal",
                "[R]Piutang Toko",
                "[R]Retur Ke Suplier Toko",
                "[E]Retur Ke Suplier Non Medis",
                "[E]Riwayat Barang Non Medis",
                "[L]Pasien Corona",
                "[R]Pendapatan Harian Toko",
                "[L]Diagnosa Pasien Corona",
                "[L]Perawatan Pasien Corona",
                "[M]Penilaian Awal Keperawatan Gigi",
                "[M]Master Masalah Keperawatan Gigi",
                "[R]Bayar Piutang Toko",
                "[R]Piutang Harian Toko",
                "[R]Penjualan Harian Toko",
                "[A]Deteksi Dini Corona",
                "[M]Penilaian Awal Keperawatan Ralan Kebidanan",
                "[P]Pengumuman E-Pasien",
                "[P]Surat Hamil",
                "[K]Set Tarif Online",
                "[A]Booking Periksa",
                "[R]Sirkulasi Barang Toko",
                "[R]Retur Jual Toko",
                "[R]Retur Jual Piutang",
                "[R]Sirkulasi Barang Toko 2",
                "[R]Keuntungan Barang Toko",
                ...
                "[S]Lantai Rumah Penerima Dankes",
                "[S]Atap Rumah Penerima Dankes",
                "[S]Kepemilikan Rumah Penerima Dankes",
                "[S]Kamar Mandi Penerima Dankes",
                "[S]Dapur Rumah Penerima Dankes",
                "[S]Kursi Rumah Penerima Dankes",
                "[S]Kategori PHBS Penerima Dankes",
                "[S]Elektronik Penerima Dankes",
                "[S]Ternak Penerima Dankes",
                ...
                "[M]Master Imunisasi",
                "[S]Patologis Penerima Dankes",
                "[L]Cek No.Kartu PCare",
                "[P]Surat Bebas Narkoba",
                "[P]Surat Keterangan Covid",
                "[G]Pemakaian Air Tanah",
                "[O]Pemakaian Air Tanah Per Tanggal",
                "[O]Pemakaian Air Tanah Per Bulan",
                "[J]Lama Pelayanan Poli",
                "[M]Hemodialisa",
                "[J]Laporan Tahunan IRJ",
                "[O]Hemodialisa Per Tanggal",
                "[O]Hemodialisa Per Bulan",
                "[O]Hemodialisa Per Tahun",
                "[O]Pasien Meninggal Per Bulan",
                "[G]Perbaikan Inventaris",
                "[P]Surat Cuti Hamil",
                "[D]Permintaan Stok Obat Pasien",
                "[G]Pemeliharaan Inventaris",
                "[M]Klasifikasi Pasien Ranap",
                "[J]Bulanan Klasifikasi Pasien Ranap",
                "[J]Harian Klasifikasi Pasien Ranap",
                "[J]Klasifikasi Pasien Per Ruang",
                "[M]SOAP Perawatan",
                "[K]Klaim Rawat Jalan",
                "[M]Skrining Gizi Lanjut",
                "[J]Lama Penyiapan RM",
                "[J]Dosis Radiologi",
                "[J]Demografi Umur Kunjungan",
                "[T]Jam Diet Pasien",
                "[K]RVP Piutang BPJS",
                ...
                "[D]Ringkasan Penjualan Obat & BHP",
                "[D]Ringkasan Beri Obat & BHP",
                ...
                "[K]Penerimaan/Omset/Kas Masuk",
                "[K]Validasi Penagihan Piutang",
                "[A]Permintaan Rawat Inap",
                "[L]Referensi Diagnosa PRB VClaim",
                "[L]Referensi Obat PRB VClaim",
                "[L]Surat Kontrol VClaim",
                "[D]Penggunaan BHP OK/VK",
                "[P]Surat Keterangan Rawat Inap",
                "[P]Surat Keterangan Sehat",
                "[K]Pendapatan Per Cara Bayar",
                "[L]Host To Host Bank Jateng",
                "[K]Pembayaran Bank Jateng",
                "[L]Surat PRI VClaim",
                "[I]Ringkasan Tindakan",
                "[J]Lama Pelayanan Pasien",
                "[P]Surat Keterangan Sakit Pihak 2",
                "[K]Titip Faktur/Tagihan Obat & BHP",
                "[L]Referensi Pendaftaran Mobile JKN",
                "[L]Batal Pendaftaran Mobile JKN",
                "[J]Lama Operasi",
                "[O]Jumlah Inventaris Per Kategori",
                "[O]Jumlah Inventaris Per Merk",
                ...
                "[L]Integrasi BRI API",
                "[G]Pengadaan Aset/Inventaris",
                "[K]Akun Jenis Aset/Inventaris",
                "[G]Suplier Aset/Inventaris",
                "[G]Penerimaan Aset/Inventaris",
                "[K]Bayar Pesan Aset/Inventaris",
                "[K]Hutang Aset/Inventaris",
                "[G]Hibah Aset/Inventaris",
                "[K]Titip Faktur/Tagihan Non Medis",
                ...
                "[E]Hibah Non Medis",
                "[L]Referensi TACC PCare",
                "[D]Resep Luar",
                "[P]Surat Bebas TBC",
                "[P]Surat Keterangan Buta Warna",
                "[P]Surat Bebas Tato",
                "[P]Surat Kewaspadaan Kesehatan",
                "[O]Porsi Diet Per Tanggal",
                "[O]Porsi Diet Per Bulan",
                "[O]Porsi Diet Per Tahun",
                "[O]Porsi Diet Per Ruang",
                ...
                "[L]Referensi Poli HFIS",
                "[L]Referensi Dokter HFIS",
                "[L]Referensi Jadwal HFIS",
                "[M]Penilaian Awal Fisioterapi",
                "[L]Program PRB di VClaim",
                "[L]Suplesi Jasa Raharja di VClaim",
                "[L]Data Induk Kecelakaan VClaim",
                "[L]Data SEP Internal VClaim",
                "[L]Klaim Jaminan Jasa Raharja VClaim",
                "[L]Pasien Finger Print VClaim",
                "[L]Rujukan Khusus VClaim",
                ...
                "[K]Peminjam Piutang",
                "[K]Piutang Lain-lain",
                "[K]Asuransi/Askes/Jenis Bayar",
                "[C]Audit Kepatuhan APD",
                "[L]Task ID Mobile JKN",
                "[K]Bayar Piutang Lain-lain",
                "[I]Pembayaran Per Akun Bayar 4",
                "[D]Stok Akhir Farmasi Per Tanggal",
                "[M]Riwayat Kamar Pasien",
                "[M]Uji Fungsi/Prosedur KFR",
                "[M]Hapus Berkas Digital Perawatan",
                "[K]Kategori Pengeluaran Harian",
                "[K]Kategori Pemasukan Lain-lain",
                "[I]Pembayaran Per Akun Bayar 5",
                "[T]Ruang Operasi",
                "[D]Telaah Resep & Obat",
                "[I]Jasa Tindakan Pasien",
                "[D]Permintaan Resep Pulang",
                "[I]Rekap JM Dokter",
                "[J]Status Data RM",
                "[A]Ubah Petugas Lab PK",
                "[A]Ubah Petugas Lab PA",
                "[A]Ubah Petugas Radiologi",
                "[A]Gabung Nomor Rawat",
                "[M]Gabungkan Data RM",
                "[D]Ringkasan Biaya Obat Pasien Per Tanggal",
                "[M]Master Masalah Keperawatan IGD",
                "[M]Penilaian Awal Keperawatan IGD",
                "[L]Referensi DPHO Apotek BPJS",
                "[L]Referensi Poli Apotek BPJS",
                "[K]Bayar JM Dokter",
                ...
                "[K]Akun Bayar Hutang",
                "[M]Master Rencana Keperawatan",
                "[J]Laporan Tahunan IGD",
                "[D]Obat/Alkes/BHP Tidak Bergerak",
                ...
                "[J]Anggota POLRI Dirawat",
                "[J]Daftar Pasien Ranap POLRI",
                "[M]SOAP Ralan Anggota POLRI",
                "[M]SOAP Ranap Anggota POLRI",
                "[J]Laporan Penyakit POLRI",
                "[J]Jumlah Pengunjung Ralan POLRI",
                "[M]Catatan Observasi IGD",
                ...
                "[C]Audit Penempatan Pasien",
                "[C]Audit Kamar Jenazah",
                "[C]Audit Bundle IADP",
                "[C]Audit Bundle IDO",
                ...
                "[C]Audit Bundle ISK",
                "[C]Audit Bundle PLABSI",
                "[C]Audit Bundle VAP",
                "[L]Host To Host Bank Papua",
                "[K]Pembayaran Bank Papua",
                ...
                "[M]SOAP Ralan Anggota TNI",
                "[M]SOAP Ranap Anggota TNI",
                "[J]Jumlah Pengunjung Ralan TNI",
                "[J]Laporan Penyakit TNI",
                "[M]Catatan Keperawatan Ranap",
                ...
                "[M]Master Template Hasil Radiologi",
                "[J]Laporan Bulanan IRJ",
                "[M]Master Template Pemeriksaan",
                "[A]Periksa Lab MB",
                "[A]Ubah Petugas Lab MB",
                "[M]Penilaian Pre Operasi",
                "[M]Penilaian Pre Anestesi",
                ...
                "[M]Skrining Nutrisi Pasien Lansia",
                "[M]Hasil USG Kandungan",
                "[M]Skrining Nutrisi Pasien Anak",
                "[L]Host To Host Bank Jabar",
                "[K]Pembayaran Bank Jabar",
                "[P]Pernyataan Pasien Umum",
                "[M]Konseling Farmasi",
                "[M]Pelayanan Informasi Obat",
                "[M]Jawaban PIO Apoteker",
                "[P]Persetujuan Umum",
                "[M]Transfer Pasien Antar Ruang",
                "[L]Referensi Praktisi Satu Sehat",
                "[L]Referensi Pasien Satu Sehat",
                "[L]Mapping Organisasi Satu Sehat",
                "[L]Mapping Lokasi Satu Sehat",
                "[L]Kirim Encounter Satu Sehat",
                "[M]Catatan Cek GDS",
                "[L]Kirim Condition Satu Sehat",
                "[M]Check List Pre Operasi",
                "[L]Kirim Observation-TTV Satu Sehat",
                "[M]Sign-In Sebelum Anestesi",
                "[L]Kirim Procedure Satu Sehat",
                "[J]Operasi Per Bulan",
                "[M]Time-Out Sebelum Insisi",
                "[M]Sign-Out Sebelum Menutup Luka",
                "[F]Barang Dapur",
                "[F]Stok Opname Dapur",
                "[L]Mapping Vaksin Satu Sehat",
                "[F]Suplier Dapur",
                "[L]Kirim Imunisasi Satu Sehat",
                "[M]Check List Post Operasi",
                "[F]Pengadaan Barang Dapur",
                "[F]Stok Keluar Dapur",
                "[F]Riwayat Barang Dapur",
                "[F]Permintaan Barang Dapur",
                "[M]Rekonsiliasi Obat",
                "[F]Biaya Pengadaan Dapur",
                "[F]Rekap Pengadaan Dapur",
                "[G]Limbah Cair B3 Medis",
                "[O]Limbah B3 Cair Per Tanggal",
                "[O]Limbah B3 Cair Per Bulan",
                "[I]Rekap Biaya Registrasi",
                "[M]Konfirmasi Rekonsiliasi Obat",
                "[L]Kirim Clinical Impression Satu Sehat",
                "[M]Penilaian Pasien Terminal",
                "[P]Persetujuan Rawat Inap",
                "[M]Monitoring Reaksi Tranfusi",
                "[M]Penilaian Korban Kekerasan",
                ...
                "[M]Penilaian Risiko Dekubitus",
                "[P]Master Menolak Anjuran Medis",
                "[M]Master Rencana Keperawatan Geriatri",
                "[P]Penolakan Anjuran Medis",
                "[J]Laporan Tahunan Penolakan Anjuran Medis",
                "[M]Master Template Laporan Operasi",
                "[M]Dokumentasi Tindakan ESWL",
                ...
                "[K]Pembayaran Bank Mandiri",
                "[M]Penilaian Ulang Nyeri",
                "[M]Check List Kriteria Masuk HCU",
                "[M]Penilaian Lanjutan Risiko Jatuh Neonatus",
                "[K]Persetujuan Pengajuan Biaya",
                "[M]Penilaian Terapi Wicara",
                "[L]Obat 23 Hari Apotek BPJS",
                "[M]Pengkajian Restrain",
                "[L]Pencarian SEP Apotek BPJS",
                "[L]Monitoring Klaim Apotek BPJS",
                "[L]Daftar Pelayanan Obat Apotek BPJS",
                "[M]Penilaian Awal Medis Ralan Paru",
                "[M]Catatan Keperawatan Ralan",
                "[M]Catatan Persalinan",
                "[M]Skor Aldrette Pasca Anestesi",
                "[M]Skor Steward Pasca Anestesi",
                "[M]Skor Bromage Pasca Anestesi",
                "[M]Penilaian Pre Induksi",
                "[M]Hasil USG Urologi",
                "[M]Hasil USG Gynecologi",
                "[M]Hasil Pemeriksaan EKG",
                "[L]Hapus/Edit SEP VClaim",
                "[L]Kirim Diet Satu Sehat",
                ...
                "[M]Catatan Observasi CHBP",
                "[M]Catatan Observasi Induksi Persalinan",
                "[C]Kategori Penilaian SKP",
                "[C]Kriteria Penilaian SKP",
                ...
                "[M]Konsultasi Medik",
                "[M]Jawaban Konsultasi Medik",
                "[L]Referensi Alergi PCare",
                "[L]Referensi Prognosa PCare",
                "[J]Data Sasaran Usia Produktif",
                ...
                "[M]Skrining TBC",
                "[M]Skrining Kesehatan Gigi & Mulut Remaja",
                ...
                "[M]Hasil USG Neonatus",
                "[M]Hasil Endoskopi Faring Laring",
                "[A]Penjaminan",
                "[L]Satu Sehat Cari Allergy",
                "[L]Satu Sehat Kirim Allergy Intollerance",
                "[L]Data Alergi Pasien",
                "[T]List Workstation",
                "[T]List Config Workstation",
                "[T]Setup Workstation"
        };
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "checklist_kriteria_keluar_hcu='"+tbUser.getValueAt(i,950).toString()+"',"+
                    "penilaian_risiko_dekubitus='"+tbUser.getValueAt(i,951).toString()+"',"+
                    "master_menolak_anjuran_medis='"+tbUser.getValueAt(i,952).toString()+"',"+
                    "master_rencana_keperawatan_geriatri='"+tbUser.getValueAt(i,953).toString()+"',"+
                    "penolakan_anjuran_medis='"+tbUser.getValueAt(i,954).toString()+"',"+
                    "laporan_tahunan_penolakan_anjuran_medis='"+tbUser.getValueAt(i,955).toString()+"',"+
                    "template_laporan_operasi='"+tbUser.getValueAt(i,956).toString()+"',"+
                    "hasil_tindakan_eswl='"+tbUser.getValueAt(i,957).toString()+"',"+
                    "checklist_kriteria_masuk_icu='"+tbUser.getValueAt(i,958).toString()+"',"+
                    "checklist_kriteria_keluar_icu='"+tbUser.getValueAt(i,959).toString()+"',"+
                    "akses_dokter_lain_rawat_jalan='"+tbUser.getValueAt(i,960).toString()+"',"+
                    "follow_up_dbd='"+tbUser.getValueAt(i,961).toString()+"',"+
                    "pemeriksaan_fisik_ralan_per_penyakit='"+tbUser.getValueAt(i,962).toString()+"',"+
                    "penilaian_lanjutan_resiko_jatuh_geriatri='"+tbUser.getValueAt(i,963).toString()+"',"+
                    "pemantauan_ews_neonatus='"+tbUser.getValueAt(i,964).toString()+"',"+
                    "validasi_persetujuan_pengajuan_biaya='"+tbUser.getValueAt(i,965).toString()+"',"+
                    "riwayat_perawatan_icare_bpjs='"+tbUser.getValueAt(i,966).toString()+"',"+
                    "rekap_pengajuan_biaya='"+tbUser.getValueAt(i,967).toString()+"',"+
                    "penilaian_awal_medis_ralan_kulit_kelamin='"+tbUser.getValueAt(i,968).toString()+"',"+
                    "akun_host_to_host_bank_mandiri='"+tbUser.getValueAt(i,969).toString()+"',"+
                    "penilaian_medis_hemodialisa='"+tbUser.getValueAt(i,970).toString()+"',"+
                    "penilaian_level_kecemasan_ranap_anak='"+tbUser.getValueAt(i,971).toString()+"',"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri='"+tbUser.getValueAt(i,972).toString()+"',"+
                    "penilaian_lanjutan_skrining_fungsional='"+tbUser.getValueAt(i,973).toString()+"',"+
                    "penilaian_medis_ralan_rehab_medik='"+tbUser.getValueAt(i,974).toString()+"',"+
                    "laporan_anestesi='"+tbUser.getValueAt(i,975).toString()+"',"+
                    "template_persetujuan_penolakan_tindakan='"+tbUser.getValueAt(i,976).toString()+"',"+
                    "penilaian_medis_ralan_gawat_darurat_psikiatri='"+tbUser.getValueAt(i,977).toString()+"',"+
                    "bpjs_referensi_setting_apotek='"+tbUser.getValueAt(i,978).toString()+"',"+
                    "bpjs_referensi_obat_apotek='"+tbUser.getValueAt(i,979).toString()+"',"+
                    "bpjs_mapping_obat_apotek='"+tbUser.getValueAt(i,980).toString()+"',"+
                    "pembayaran_bank_mandiri='"+tbUser.getValueAt(i,981).toString()+"',"+
                    "penilaian_ulang_nyeri='"+tbUser.getValueAt(i,982).toString()+"',"+
                    "checklist_kriteria_masuk_hcu='"+tbUser.getValueAt(i,983).toString()+"',"+
                    "penilaian_risiko_jatuh_neonatus='"+tbUser.getValueAt(i,984).toString()+"',"+
                    "persetujuan_pengajuan_biaya='"+tbUser.getValueAt(i,985).toString()+"',"+
                    ...
                    "satu_sehat_mapping_radiologi='"+tbUser.getValueAt(i,1006).toString()+"',"+
                    "satu_sehat_kirim_servicerequest_radiologi='"+tbUser.getValueAt(i,1007).toString()+"',"+
                    "hasil_endoskopi_hidung='"+tbUser.getValueAt(i,1008).toString()+"',"+
                    "satu_sehat_kirim_specimen_radiologi='"+tbUser.getValueAt(i,1009).toString()+"',"+
                    "master_masalah_keperawatan_neonatus='"+tbUser.getValueAt(i,1010).toString()+"',"+
                    "master_rencana_keperawatan_neonatus='"+tbUser.getValueAt(i,1011).toString()+"',"+
                    "penilaian_awal_keperawatan_ranap_neonatus='"+tbUser.getValueAt(i,1012).toString()+"',"+
                    "satu_sehat_kirim_medication='"+tbUser.getValueAt(i,1013).toString()+"',"+
                    "satu_sehat_kirim_observation_radiologi='"+tbUser.getValueAt(i,1014).toString()+"',"+
                    "satu_sehat_kirim_diagnosticreport_radiologi='"+tbUser.getValueAt(i,1015).toString()+"',"+
                    "hasil_endoskopi_telinga='"+tbUser.getValueAt(i,1016).toString()+"',"+
                    "satu_sehat_mapping_lab='"+tbUser.getValueAt(i,1017).toString()+"',"+
                    "satu_sehat_kirim_servicerequest_lab='"+tbUser.getValueAt(i,1018).toString()+"',"+
                    "satu_sehat_kirim_servicerequest_labmb='"+tbUser.getValueAt(i,1019).toString()+"',"+
                    "satu_sehat_kirim_specimen_lab='"+tbUser.getValueAt(i,1020).toString()+"',"+
                    "satu_sehat_kirim_specimen_labmb='"+tbUser.getValueAt(i,1021).toString()+"',"+
                    "satu_sehat_kirim_observation_lab='"+tbUser.getValueAt(i,1022).toString()+"',"+
                    "satu_sehat_kirim_observation_labmb='"+tbUser.getValueAt(i,1023).toString()+"',"+
                    "satu_sehat_kirim_diagnosticreport_lab='"+tbUser.getValueAt(i,1024).toString()+"',"+
                    "satu_sehat_kirim_diagnosticreport_labmb='"+tbUser.getValueAt(i,1025).toString()+"',"+
                    "kepatuhan_kelengkapan_keselamatan_bedah='"+tbUser.getValueAt(i,1026).toString()+"',"+
                    "nilai_piutang_perjenis_bayar_per_bulan='"+tbUser.getValueAt(i,1027).toString()+"',"+
                    "ringkasan_piutang_jenis_bayar='"+tbUser.getValueAt(i,1028).toString()+"',"+
                    "penilaian_pasien_imunitas_rendah='"+tbUser.getValueAt(i,1029).toString()+"',"+
                    "balance_cairan='"+tbUser.getValueAt(i,1030).toString()+"',"+
                    "catatan_observasi_chbp='"+tbUser.getValueAt(i,1031).toString()+"',"+
                    "catatan_observasi_induksi_persalinan='"+tbUser.getValueAt(i,1032).toString()+"',"+
                    "skp_kategori_penilaian='"+tbUser.getValueAt(i,1033).toString()+"',"+
                    "skp_kriteria_penilaian='"+tbUser.getValueAt(i,1034).toString()+"',"+
                    "skp_penilaian='"+tbUser.getValueAt(i,1035).toString()+"',"+
                    "referensi_poli_mobilejknfktp='"+tbUser.getValueAt(i,1036).toString()+"',"+
                    "referensi_dokter_mobilejknfktp='"+tbUser.getValueAt(i,1037).toString()+"',"+
                    "skp_rekapitulasi_penilaian='"+tbUser.getValueAt(i,1038).toString()+"',"+
                    "pembayaran_pihak_ke3_bankmandiri='"+tbUser.getValueAt(i,1039).toString()+"',"+
                    "metode_pembayaran_bankmandiri='"+tbUser.getValueAt(i,1040).toString()+"',"+
                    "bank_tujuan_transfer_bankmandiri='"+tbUser.getValueAt(i,1041).toString()+"',"+
                    "kodetransaksi_tujuan_transfer_bankmandiri='"+tbUser.getValueAt(i,1042).toString()+"',"+
                    "konsultasi_medik='"+tbUser.getValueAt(i,1043).toString()+"',"+
                    "jawaban_konsultasi_medik='"+tbUser.getValueAt(i,1044).toString()+"',"+
                    "pcare_cek_alergi='"+tbUser.getValueAt(i,1045).toString()+"',"+
                    "pcare_cek_prognosa='"+tbUser.getValueAt(i,1046).toString()+"',"+
                    "data_sasaran_usiaproduktif='"+tbUser.getValueAt(i,1047).toString()+"',"+
                    "data_sasaran_usialansia='"+tbUser.getValueAt(i,1048).toString()+"',"+
                    "skrining_perilaku_merokok_sekolah_remaja='"+tbUser.getValueAt(i,1049).toString()+"',"+
                    "skrining_kekerasan_pada_perempuan='"+tbUser.getValueAt(i,1050).toString()+"',"+
                    "skrining_obesitas='"+tbUser.getValueAt(i,1051).toString()+"',"+
                    "skrining_risiko_kanker_payudara='"+tbUser.getValueAt(i,1052).toString()+"',"+
                    "skrining_risiko_kanker_paru='"+tbUser.getValueAt(i,1053).toString()+"',"+
                    "skrining_tbc='"+tbUser.getValueAt(i,1054).toString()+"',"+
                    "skrining_kesehatan_gigi_mulut_remaja='"+tbUser.getValueAt(i,1055).toString()+"',"+
                    "penilaian_awal_keperawatan_ranap_bayi='"+tbUser.getValueAt(i,1056).toString()+"',"+
                    "satu_sehat_kirim_medicationrequest='"+tbUser.getValueAt(i,1057).toString()+"',"+
                    "penatalaksanaan_terapi_okupasi='"+tbUser.getValueAt(i,1058).toString()+"',"+
                    "satu_sehat_kirim_medicationdispense='"+tbUser.getValueAt(i,1059).toString()+"',"+
                    "hasil_usg_neonatus='"+tbUser.getValueAt(i,1060).toString()+"',"+
                    "hasil_endoskopi_faring_laring='"+tbUser.getValueAt(i,1061).toString()+"',"+
                    "penjaminan='"+tbUser.getValueAt(i,1062).toString()+"',"+
                    "satusehatcariallergy='"+tbUser.getValueAt(i,1063).toString()+"',"+
                    "satusehatkirimallergyintollerance='"+tbUser.getValueAt(i,1064).toString()+"',"+
                    "dataalergipasien='"+tbUser.getValueAt(i,1065).toString()+"',"+
                    "list_workstation='"+tbUser.getValueAt(i,1066).toString()+"',"+
                    "list_config_workstation='"+tbUser.getValueAt(i,1067).toString()+"',"+
                    "setup_workstation='"+tbUser.getValueAt(i,1068).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "checklist_kriteria_keluar_hcu='"+tbUser.getValueAt(barisdicopy,950).toString()+"',"+
                                        "penilaian_risiko_dekubitus='"+tbUser.getValueAt(barisdicopy,951).toString()+"',"+
                                        "master_menolak_anjuran_medis='"+tbUser.getValueAt(barisdicopy,952).toString()+"',"+
                                        "master_rencana_keperawatan_geriatri='"+tbUser.getValueAt(barisdicopy,953).toString()+"',"+
                                        "penolakan_anjuran_medis='"+tbUser.getValueAt(barisdicopy,954).toString()+"',"+
                                        "laporan_tahunan_penolakan_anjuran_medis='"+tbUser.getValueAt(barisdicopy,955).toString()+"',"+
                                        "template_laporan_operasi='"+tbUser.getValueAt(barisdicopy,956).toString()+"',"+
                                        "hasil_tindakan_eswl='"+tbUser.getValueAt(barisdicopy,957).toString()+"',"+
                                        "checklist_kriteria_masuk_icu='"+tbUser.getValueAt(barisdicopy,958).toString()+"',"+
                                        "checklist_kriteria_keluar_icu='"+tbUser.getValueAt(barisdicopy,959).toString()+"',"+
                                        "akses_dokter_lain_rawat_jalan='"+tbUser.getValueAt(barisdicopy,960).toString()+"',"+
                                        "follow_up_dbd='"+tbUser.getValueAt(barisdicopy,961).toString()+"',"+
                                        "pemeriksaan_fisik_ralan_per_penyakit='"+tbUser.getValueAt(barisdicopy,962).toString()+"',"+
                                        "penilaian_lanjutan_resiko_jatuh_geriatri='"+tbUser.getValueAt(barisdicopy,963).toString()+"',"+
                                        "pemantauan_ews_neonatus='"+tbUser.getValueAt(barisdicopy,964).toString()+"',"+
                                        "validasi_persetujuan_pengajuan_biaya='"+tbUser.getValueAt(barisdicopy,965).toString()+"',"+
                                        "riwayat_perawatan_icare_bpjs='"+tbUser.getValueAt(barisdicopy,966).toString()+"',"+
                                        "rekap_pengajuan_biaya='"+tbUser.getValueAt(barisdicopy,967).toString()+"',"+
                                        "penilaian_awal_medis_ralan_kulit_kelamin='"+tbUser.getValueAt(barisdicopy,968).toString()+"',"+
                                        "akun_host_to_host_bank_mandiri='"+tbUser.getValueAt(barisdicopy,969).toString()+"',"+
                                        "penilaian_medis_hemodialisa='"+tbUser.getValueAt(barisdicopy,970).toString()+"',"+
                                        "penilaian_level_kecemasan_ranap_anak='"+tbUser.getValueAt(barisdicopy,971).toString()+"',"+
                                        "penilaian_lanjutan_resiko_jatuh_psikiatri='"+tbUser.getValueAt(barisdicopy,972).toString()+"',"+
                                        "penilaian_lanjutan_skrining_fungsional='"+tbUser.getValueAt(barisdicopy,973).toString()+"',"+
                                        "penilaian_medis_ralan_rehab_medik='"+tbUser.getValueAt(barisdicopy,974).toString()+"',"+
                                        "laporan_anestesi='"+tbUser.getValueAt(barisdicopy,975).toString()+"',"+
                                        "template_persetujuan_penolakan_tindakan='"+tbUser.getValueAt(barisdicopy,976).toString()+"',"+
                                        "penilaian_medis_ralan_gawat_darurat_psikiatri='"+tbUser.getValueAt(barisdicopy,977).toString()+"',"+
                                        "bpjs_referensi_setting_apotek='"+tbUser.getValueAt(barisdicopy,978).toString()+"',"+
                                        "bpjs_referensi_obat_apotek='"+tbUser.getValueAt(barisdicopy,979).toString()+"',"+
                                        "bpjs_mapping_obat_apotek='"+tbUser.getValueAt(barisdicopy,980).toString()+"',"+
                                        "pembayaran_bank_mandiri='"+tbUser.getValueAt(barisdicopy,981).toString()+"',"+
                                        "penilaian_ulang_nyeri='"+tbUser.getValueAt(barisdicopy,982).toString()+"',"+
                                        "checklist_kriteria_masuk_hcu='"+tbUser.getValueAt(barisdicopy,983).toString()+"',"+
                                        "penilaian_risiko_jatuh_neonatus='"+tbUser.getValueAt(barisdicopy,984).toString()+"',"+
                                        "persetujuan_pengajuan_biaya='"+tbUser.getValueAt(barisdicopy,985).toString()+"',"+
                                        ...
                                        "satu_sehat_mapping_radiologi='"+tbUser.getValueAt(barisdicopy,1006).toString()+"',"+
                                        "satu_sehat_kirim_servicerequest_radiologi='"+tbUser.getValueAt(barisdicopy,1007).toString()+"',"+
                                        "hasil_endoskopi_hidung='"+tbUser.getValueAt(barisdicopy,1008).toString()+"',"+
                                        "satu_sehat_kirim_specimen_radiologi='"+tbUser.getValueAt(barisdicopy,1009).toString()+"',"+
                                        "master_masalah_keperawatan_neonatus='"+tbUser.getValueAt(barisdicopy,1010).toString()+"',"+
                                        "master_rencana_keperawatan_neonatus='"+tbUser.getValueAt(barisdicopy,1011).toString()+"',"+
                                        "penilaian_awal_keperawatan_ranap_neonatus='"+tbUser.getValueAt(barisdicopy,1012).toString()+"',"+
                                        "satu_sehat_kirim_medication='"+tbUser.getValueAt(barisdicopy,1013).toString()+"',"+
                                        "satu_sehat_kirim_observation_radiologi='"+tbUser.getValueAt(barisdicopy,1014).toString()+"',"+
                                        "satu_sehat_kirim_diagnosticreport_radiologi='"+tbUser.getValueAt(barisdicopy,1015).toString()+"',"+
                                        "hasil_endoskopi_telinga='"+tbUser.getValueAt(barisdicopy,1016).toString()+"',"+
                                        "satu_sehat_mapping_lab='"+tbUser.getValueAt(barisdicopy,1017).toString()+"',"+
                                        "satu_sehat_kirim_servicerequest_lab='"+tbUser.getValueAt(barisdicopy,1018).toString()+"',"+
                                        "satu_sehat_kirim_servicerequest_labmb='"+tbUser.getValueAt(barisdicopy,1019).toString()+"',"+
                                        "satu_sehat_kirim_specimen_lab='"+tbUser.getValueAt(barisdicopy,1020).toString()+"',"+
                                        "satu_sehat_kirim_specimen_labmb='"+tbUser.getValueAt(barisdicopy,1021).toString()+"',"+
                                        "satu_sehat_kirim_observation_lab='"+tbUser.getValueAt(barisdicopy,1022).toString()+"',"+
                                        "satu_sehat_kirim_observation_labmb='"+tbUser.getValueAt(barisdicopy,1023).toString()+"',"+
                                        "satu_sehat_kirim_diagnosticreport_lab='"+tbUser.getValueAt(barisdicopy,1024).toString()+"',"+
                                        "satu_sehat_kirim_diagnosticreport_labmb='"+tbUser.getValueAt(barisdicopy,1025).toString()+"',"+
                                        "kepatuhan_kelengkapan_keselamatan_bedah='"+tbUser.getValueAt(barisdicopy,1026).toString()+"',"+
                                        "nilai_piutang_perjenis_bayar_per_bulan='"+tbUser.getValueAt(barisdicopy,1027).toString()+"',"+
                                        "ringkasan_piutang_jenis_bayar='"+tbUser.getValueAt(barisdicopy,1028).toString()+"',"+
                                        "penilaian_pasien_imunitas_rendah='"+tbUser.getValueAt(barisdicopy,1029).toString()+"',"+
                                        "balance_cairan='"+tbUser.getValueAt(barisdicopy,1030).toString()+"',"+
                                        "catatan_observasi_chbp='"+tbUser.getValueAt(barisdicopy,1031).toString()+"',"+
                                        "catatan_observasi_induksi_persalinan='"+tbUser.getValueAt(barisdicopy,1032).toString()+"',"+
                                        "skp_kategori_penilaian='"+tbUser.getValueAt(barisdicopy,1033).toString()+"',"+
                                        "skp_kriteria_penilaian='"+tbUser.getValueAt(barisdicopy,1034).toString()+"',"+
                                        "skp_penilaian='"+tbUser.getValueAt(barisdicopy,1035).toString()+"',"+
                                        "referensi_poli_mobilejknfktp='"+tbUser.getValueAt(barisdicopy,1036).toString()+"',"+
                                        "referensi_dokter_mobilejknfktp='"+tbUser.getValueAt(barisdicopy,1037).toString()+"',"+
                                        "skp_rekapitulasi_penilaian='"+tbUser.getValueAt(barisdicopy,1038).toString()+"',"+
                                        "pembayaran_pihak_ke3_bankmandiri='"+tbUser.getValueAt(barisdicopy,1039).toString()+"',"+
                                        "metode_pembayaran_bankmandiri='"+tbUser.getValueAt(barisdicopy,1040).toString()+"',"+
                                        "bank_tujuan_transfer_bankmandiri='"+tbUser.getValueAt(barisdicopy,1041).toString()+"',"+
                                        "kodetransaksi_tujuan_transfer_bankmandiri='"+tbUser.getValueAt(barisdicopy,1042).toString()+"',"+
                                        "konsultasi_medik='"+tbUser.getValueAt(barisdicopy,1043).toString()+"',"+
                                        "jawaban_konsultasi_medik='"+tbUser.getValueAt(barisdicopy,1044).toString()+"',"+
                                        "pcare_cek_alergi='"+tbUser.getValueAt(barisdicopy,1045).toString()+"',"+
                                        "pcare_cek_prognosa='"+tbUser.getValueAt(barisdicopy,1046).toString()+"',"+
                                        "data_sasaran_usiaproduktif='"+tbUser.getValueAt(barisdicopy,1047).toString()+"',"+
                                        "data_sasaran_usialansia='"+tbUser.getValueAt(barisdicopy,1048).toString()+"',"+
                                        "skrining_perilaku_merokok_sekolah_remaja='"+tbUser.getValueAt(barisdicopy,1049).toString()+"',"+
                                        "skrining_kekerasan_pada_perempuan='"+tbUser.getValueAt(barisdicopy,1050).toString()+"',"+
                                        "skrining_obesitas='"+tbUser.getValueAt(barisdicopy,1051).toString()+"',"+
                                        "skrining_risiko_kanker_payudara='"+tbUser.getValueAt(barisdicopy,1052).toString()+"',"+
                                        "skrining_risiko_kanker_paru='"+tbUser.getValueAt(barisdicopy,1053).toString()+"',"+
                                        "skrining_tbc='"+tbUser.getValueAt(barisdicopy,1054).toString()+"',"+
                                        "skrining_kesehatan_gigi_mulut_remaja='"+tbUser.getValueAt(barisdicopy,1055).toString()+"',"+
                                        "penilaian_awal_keperawatan_ranap_bayi='"+tbUser.getValueAt(barisdicopy,1056).toString()+"',"+
                                        "satu_sehat_kirim_medicationrequest='"+tbUser.getValueAt(barisdicopy,1057).toString()+"',"+
                                        "penatalaksanaan_terapi_okupasi='"+tbUser.getValueAt(barisdicopy,1058).toString()+"',"+
                                        "satu_sehat_kirim_medicationdispense='"+tbUser.getValueAt(barisdicopy,1059).toString()+"',"+
                                        "hasil_usg_neonatus='"+tbUser.getValueAt(barisdicopy,1060).toString()+"',"+
                                        "hasil_endoskopi_faring_laring='"+tbUser.getValueAt(barisdicopy,1061).toString()+"',"+
                                        "penjaminan='"+tbUser.getValueAt(barisdicopy,1062).toString()+"',"+
                                        "satusehatcariallergy='"+tbUser.getValueAt(barisdicopy,1063).toString()+"',"+
                                        "satusehatkirimallergyintollerance='"+tbUser.getValueAt(barisdicopy,1064).toString()+"',"+
                                        "dataalergipasien='"+tbUser.getValueAt(barisdicopy,1065).toString()+"',"+
                                        "list_workstation='"+tbUser.getValueAt(barisdicopy,1066).toString()+"',"+
                                        "list_config_workstation='"+tbUser.getValueAt(barisdicopy,1067).toString()+"',"+
                                        "setup_workstation='"+tbUser.getValueAt(barisdicopy,1068).toString()+"'");
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
    ...
    */
    ...
    private void tampil() {        
        try{    
            ...
            String query_user = "select AES_DECRYPT(user.id_user,'nur'),AES_DECRYPT(user.password,'windi'),"+
                "user.penyakit,\n" +
                "user.obat_penyakit,\n" +
                "user.dokter,\n" +
                "user.jadwal_praktek,\n" +
                ...
                "user.beri_obat,\n" +
                "user.resep_pulang,\n" +
                "user.pasien_meninggal,\n" +
                "user.diet_pasien,\n" +
                "user.kelahiran_bayi,\n" +
                "user.periksa_lab,\n" +
                "user.periksa_radiologi,\n" +
                "user.kasir_ralan,\n" +
                "user.deposit_pasien,\n" +
                "user.piutang_pasien,\n" +
                "user.peminjaman_berkas,\n" +
                "user.barcode,\n" +
                "user.presensi_harian,\n" +
                "user.presensi_bulanan,\n" +
                "user.pegawai_admin,\n" +
                "user.pegawai_user,\n" +
                "user.suplier,\n" +
                "user.satuan_barang,\n" +
                "user.konversi_satuan,\n" +
                "user.jenis_barang,\n" +
                "user.obat,\n" +
                "user.stok_opname_obat,\n" +
                "user.stok_obat_pasien,\n" +
                "user.pengadaan_obat,\n" +
                "user.pemesanan_obat,\n" +
                "user.penjualan_obat,\n" +
                "user.piutang_obat,\n" +
                "user.retur_ke_suplier,\n" +
                "user.retur_dari_pembeli,\n" +
                "user.retur_obat_ranap,\n" +
                "user.retur_piutang_pasien,\n" +
                "user.keuntungan_penjualan,\n" +
                "user.keuntungan_beri_obat,\n" +
                "user.sirkulasi_obat,\n" +
                "user.ipsrs_barang,\n" +
                "user.ipsrs_pengadaan_barang,\n" +
                "user.ipsrs_stok_keluar,\n" +
                "user.ipsrs_rekap_pengadaan,\n" +
                "user.ipsrs_rekap_stok_keluar,\n" +
                "user.ipsrs_pengeluaran_harian,\n" +
                "user.inventaris_jenis,\n" +
                "user.inventaris_kategori,\n" +
                "user.inventaris_merk,\n" +
                "user.inventaris_ruang,\n" +
                "user.inventaris_produsen,\n" +
                "user.inventaris_koleksi,\n" +
                "user.inventaris_inventaris,\n" +
                "user.inventaris_sirkulasi,\n" +
                "user.parkir_jenis,\n" +
                "user.parkir_in,\n" +
                "user.parkir_out,\n" +
                "user.parkir_rekap_harian,\n" +
                "user.parkir_rekap_bulanan,\n" +
                "user.informasi_kamar,\n" +
                "user.harian_tindakan_poli,\n" +
                "user.obat_per_poli,\n" +
                "user.obat_per_kamar,\n" +
                "user.obat_per_dokter_ralan,\n" +
                "user.obat_per_dokter_ranap,\n" +
                "user.harian_dokter,\n" +
                "user.bulanan_dokter,\n" +
                "user.harian_paramedis,\n" +
                "user.bulanan_paramedis,\n" +
                "user.pembayaran_ralan,\n" +
                "user.pembayaran_ranap,\n" +
                "user.rekap_pembayaran_ralan,\n" +
                "user.rekap_pembayaran_ranap,\n" +
                "user.tagihan_masuk,\n" +
                "user.tambahan_biaya,\n" +
                "user.potongan_biaya,\n" +
                "user.resep_obat,\n" +
                ...
                "user.pengeluaran,\n" +
                "user.setup_pjlab,\n" +
                "user.setup_otolokasi,\n" +
                "user.setup_jam_kamin,\n" +
                "user.setup_embalase,\n" +
                "user.tracer_login,\n" +
                "user.display,\n" +
                "user.set_harga_obat,\n" +
                "user.set_penggunaan_tarif,\n" +
                "user.set_oto_ralan,\n" +
                "user.biaya_harian,\n" +
                "user.biaya_masuk_sekali,\n" +
                "user.set_no_rm,\n" +
                "user.billing_ralan,\n" +
                "user.billing_ranap,\n" +
                "user.jm_ranap_dokter,\n" +
                "user.igd,\n" +
                "user.barcoderalan,\n" +
                "user.barcoderanap,\n" +
                "user.set_harga_obat_ralan,\n" +
                "user.set_harga_obat_ranap,\n" +
                "user.penyakit_pd3i,\n" +
                "user.surveilans_pd3i,\n" +
                "user.surveilans_ralan,\n" +
                "user.diagnosa_pasien,\n" +
                "user.surveilans_ranap,\n" +
                "user.pny_takmenular_ranap,\n" +
                "user.pny_takmenular_ralan,\n" +
                "user.kunjungan_ralan,\n" +
                "user.rl32,\n" +
                "user.rl33,\n" +
                "user.rl37,\n" +
                "user.rl38,\n" +
                "user.harian_tindakan_dokter,\n" +
                "user.sms,\n" +
                "user.sidikjari,\n" +
                "user.jam_masuk,\n" +
                "user.jadwal_pegawai,\n" +
                ...
                "user.rl34,\n" +
                "user.rl36,\n" +
                "user.fee_visit_dokter,\n" +
                "user.fee_bacaan_ekg,\n" +
                "user.fee_rujukan_rontgen,\n" +
                "user.fee_rujukan_ranap,\n" +
                "user.fee_ralan,\n" +
                "user.akun_bayar,\n" +
                "user.bayar_pemesanan_obat,\n" +
                "user.obat_per_dokter_peresep,\n" +
                "user.ipsrs_jenis_barang,\n" +
                "user.pemasukan_lain,\n" +
                "user.pengaturan_rekening,\n" +
                "user.closing_kasir,\n" +
                "user.keterlambatan_presensi,\n" +
                "user.set_harga_kamar,\n" +
                "user.rekap_per_shift,\n" +
                "user.bpjs_cek_nik,\n" +
                "user.bpjs_cek_kartu,\n" +
                "user.bpjs_cek_riwayat,\n" +
                "user.obat_per_cara_bayar,\n" +
                "user.kunjungan_ranap,\n" +
                "user.bayar_piutang,\n" +
                "user.payment_point,\n" +
                "user.bpjs_cek_nomor_rujukan,\n" +
                "user.icd9,\n" +
                "user.darurat_stok,\n" +
                "user.retensi_rm,\n" +
                "user.temporary_presensi,\n" +
                "user.jurnal_harian,\n" +
                "user.sirkulasi_obat2,\n" +
                "user.edit_registrasi,\n" +
                "user.bpjs_referensi_diagnosa,\n" +
                "user.bpjs_referensi_poli,\n" +
                "user.industrifarmasi,\n" +
                "user.harian_js,\n" +
                "user.bulanan_js,\n" +
                "user.harian_paket_bhp,\n" +
                "user.bulanan_paket_bhp,\n" +
                "user.piutang_pasien2,\n" +
                "user.bpjs_referensi_faskes,\n" +
                "user.bpjs_sep,\n" +
                "user.pengambilan_utd,\n" +
                "user.tarif_utd,\n" +
                "user.pengambilan_utd2,\n" +
                "user.utd_medis_rusak,\n" +
                "user.pengambilan_penunjang_utd,\n" +
                "user.pengambilan_penunjang_utd2,\n" +
                "user.utd_penunjang_rusak,\n" +
                "user.suplier_penunjang,\n" +
                "user.utd_donor,\n" +
                "user.bpjs_monitoring_klaim,\n" +
                "user.utd_cekal_darah,\n" +
                "user.utd_komponen_darah,\n" +
                "user.utd_stok_darah,\n" +
                "user.utd_pemisahan_darah,\n" +
                "user.harian_kamar,\n" +
                "user.rincian_piutang_pasien,\n" +
                "user.keuntungan_beri_obat_nonpiutang,\n" +
                "user.reklasifikasi_ralan,\n" +
                "user.reklasifikasi_ranap,\n" +
                "user.utd_penyerahan_darah,\n" +
                "user.hutang_obat,\n" +
                "user.riwayat_obat_alkes_bhp,\n" +
                "user.sensus_harian_poli,\n" +
                "user.rl4a,\n" +
                "user.aplicare_referensi_kamar,\n" +
                "user.aplicare_ketersediaan_kamar,\n" +
                "user.inacbg_klaim_baru_otomatis,\n" +
                "user.inacbg_klaim_baru_manual,\n" +
                "user.inacbg_coder_nik,\n" +
                "user.mutasi_berkas,\n" +
                "user.akun_piutang,\n" +
                "user.harian_kso,\n" +
                "user.bulanan_kso,\n" +
                "user.harian_menejemen,\n" +
                "user.bulanan_menejemen,\n" +
                "user.inhealth_cek_eligibilitas,\n" +
                "user.inhealth_referensi_jenpel_ruang_rawat,\n" +
                "user.inhealth_referensi_poli,\n" +
                "user.inhealth_referensi_faskes,\n" +
                "user.inhealth_sjp,\n" +
                "user.piutang_ralan,\n" +
                "user.piutang_ranap,\n" +
                "user.detail_piutang_penjab,\n" +
                "user.lama_pelayanan_ralan,\n" +
                "user.catatan_pasien,\n" +
                "user.rl4b,\n" +
                "user.rl4asebab,\n" +
                "user.rl4bsebab,\n" +
                ...
                "user.bulanan_HAIs,\n" +
                "user.hitung_bor,\n" +
                "user.perusahaan_pasien,\n" +
                "user.resep_dokter,\n" +
                "user.lama_pelayanan_apotek,\n" +
                "user.hitung_alos,\n" +
                "user.detail_tindakan,\n" +
                "user.rujukan_poli_internal,\n" +
                "user.rekap_poli_anak,\n" +
                "user.grafik_kunjungan_poli,\n" +
                "user.grafik_kunjungan_perdokter,\n" +
                "user.grafik_kunjungan_perpekerjaan,\n" +
                "user.grafik_kunjungan_perpendidikan,\n" +
                "user.grafik_kunjungan_pertahun,\n" +
                "user.berkas_digital_perawatan,\n" +
                "user.penyakit_menular_ranap,\n" +
                "user.penyakit_menular_ralan,\n" +
                "user.grafik_kunjungan_perbulan,\n" +
                "user.grafik_kunjungan_pertanggal,\n" +
                "user.grafik_kunjungan_demografi,\n" +
                "user.grafik_kunjungan_statusdaftartahun,\n" +
                "user.grafik_kunjungan_statusdaftartahun2,\n" +
                "user.grafik_kunjungan_statusdaftarbulan,\n" +
                "user.grafik_kunjungan_statusdaftarbulan2,\n" +
                "user.grafik_kunjungan_statusdaftartanggal,\n" +
                "user.grafik_kunjungan_statusdaftartanggal2,\n" +
                "user.grafik_kunjungan_statusbataltahun,\n" +
                "user.grafik_kunjungan_statusbatalbulan,\n" +
                "user.pcare_cek_penyakit,\n" +
                "user.grafik_kunjungan_statusbataltanggal,\n" +
                "user.kategori_barang,\n" +
                "user.golongan_barang,\n" +
                "user.pemberian_obat_pertanggal,\n" +
                "user.penjualan_obat_pertanggal,\n" +
                "user.pcare_cek_kesadaran,\n" +
                "user.pembatalan_periksa_dokter,\n" +
                "user.pembayaran_per_unit,\n" +
                "user.rekap_pembayaran_per_unit,\n" +
                "user.grafik_kunjungan_percarabayar,\n" +
                "user.ipsrs_pengadaan_pertanggal,\n" +
                "user.ipsrs_stokkeluar_pertanggal,\n" +
                "user.grafik_kunjungan_ranaptahun,\n" +
                "user.pcare_cek_rujukan,\n" +
                "user.grafik_lab_ralantahun,\n" +
                "user.grafik_rad_ralantahun,\n" +
                "user.cek_entry_ralan,\n" +
                "user.inacbg_klaim_baru_manual2,\n" +
                "user.permintaan_medis,\n" +
                "user.rekap_permintaan_medis,\n" +
                "user.surat_pemesanan_medis,\n" +
                "user.permintaan_non_medis,\n" +
                "user.rekap_permintaan_non_medis,\n" +
                "user.surat_pemesanan_non_medis,\n" +
                "user.grafik_per_perujuk,\n" +
                "user.bpjs_cek_prosedur,\n" +
                "user.bpjs_cek_kelas_rawat,\n" +
                "user.bpjs_cek_dokter,\n" +
                "user.bpjs_cek_spesialistik,\n" +
                "user.bpjs_cek_ruangrawat,\n" +
                "user.bpjs_cek_carakeluar,\n" +
                "user.bpjs_cek_pasca_pulang,\n" +
                "user.detail_tindakan_okvk,\n" +
                "user.billing_parsial,\n" +
                "user.bpjs_cek_nomor_rujukan_rs,\n" +
                "user.bpjs_cek_rujukan_kartu_pcare,\n" +
                "user.bpjs_cek_rujukan_kartu_rs,\n" +
                "user.akses_depo_obat,\n" +
                "user.bpjs_rujukan_keluar,\n" +
                "user.grafik_lab_ralanbulan,\n" +
                "user.pengeluaran_stok_apotek,\n" +
                "user.grafik_rad_ralanbulan,\n" +
                "user.detailjmdokter2,\n" +
                "user.pengaduan_pasien,\n" +
                "user.grafik_lab_ralanhari,\n" +
                "user.grafik_rad_ralanhari,\n" +
                "user.sensus_harian_ralan,\n" +
                "user.metode_racik,\n" +
                "user.pembayaran_akun_bayar,\n" +
                "user.pengguna_obat_resep,\n" +
                "user.rekap_pemesanan,\n" +
                "user.master_berkas_pegawai,\n" +
                "user.berkas_kepegawaian,\n" +
                "user.riwayat_jabatan,\n" +
                "user.riwayat_pendidikan,\n" +
                "user.riwayat_naik_gaji,\n" +
                "user.kegiatan_ilmiah,\n" +
                "user.riwayat_penghargaan,\n" +
                "user.riwayat_penelitian,\n" +
                "user.penerimaan_non_medis,\n" +
                "user.bayar_pesan_non_medis,\n" +
                "user.hutang_barang_non_medis,\n" +
                "user.rekap_pemesanan_non_medis,\n" +
                "user.insiden_keselamatan,\n" +
                "user.insiden_keselamatan_pasien,\n" +
                "user.grafik_ikp_pertahun,\n" +
                "user.grafik_ikp_perbulan,\n" +
                "user.grafik_ikp_pertanggal,\n" +
                "user.riwayat_data_batch,\n" +
                "user.grafik_ikp_jenis,\n" +
                "user.grafik_ikp_dampak,\n" +
                "user.piutang_akun_piutang,\n" +
                "user.grafik_kunjungan_per_agama,\n" +
                "user.grafik_kunjungan_per_umur,\n" +
                "user.suku_bangsa,\n" +
                "user.bahasa_pasien,\n" +
                "user.golongan_tni,\n" +
                "user.satuan_tni,\n" +
                ...
                "user.pangkat_polri,\n" +
                "user.cacat_fisik,\n" +
                "user.grafik_kunjungan_suku,\n" +
                "user.grafik_kunjungan_bahasa,\n" +
                "user.booking_operasi,\n" +
                "user.mapping_poli_bpjs,\n" +
                "user.grafik_kunjungan_per_cacat,\n" +
                "user.barang_cssd,\n" +
                "user.skdp_bpjs,\n" +
                "user.booking_registrasi,\n" +
                "user.bpjs_cek_propinsi,\n" +
                "user.bpjs_cek_kabupaten,\n" +
                "user.bpjs_cek_kecamatan,\n" +
                "user.bpjs_cek_dokterdpjp,\n" +
                "user.bpjs_cek_riwayat_rujukanrs,\n" +
                "user.bpjs_cek_tanggal_rujukan,\n" +
                "user.permintaan_lab,\n" +
                "user.permintaan_radiologi,\n" +
                "user.surat_indeks,\n" +
                "user.surat_map,\n" +
                "user.surat_almari,\n" +
                "user.surat_rak,\n" +
                "user.surat_ruang,\n" +
                "user.surat_klasifikasi,\n" +
                "user.surat_status,\n" +
                "user.surat_sifat,\n" +
                "user.surat_balas,\n" +
                "user.surat_masuk,\n" +
                "user.pcare_cek_dokter,\n" +
                "user.pcare_cek_poli,\n" +
                "user.pcare_cek_provider,\n" +
                "user.pcare_cek_statuspulang,\n" +
                "user.pcare_cek_spesialis,\n" +
                "user.pcare_cek_subspesialis,\n" +
                "user.pcare_cek_sarana,\n" +
                "user.pcare_cek_khusus,\n" +
                "user.pcare_cek_obat,\n" +
                "user.pcare_cek_tindakan,\n" +
                "user.pcare_cek_faskessubspesialis,\n" +
                "user.pcare_cek_faskesalihrawat,\n" +
                "user.pcare_cek_faskesthalasemia,\n" +
                "user.pcare_mapping_obat,\n" +
                "user.pcare_mapping_tindakan,\n" +
                "user.pcare_club_prolanis,\n" +
                "user.pcare_mapping_poli,\n" +
                "user.pcare_kegiatan_kelompok,\n" +
                "user.pcare_mapping_tindakan_ranap,\n" +
                "user.pcare_peserta_kegiatan_kelompok,\n" +
                "user.sirkulasi_obat3,\n" +
                "user.bridging_pcare_daftar,\n" +
                "user.pcare_mapping_dokter,\n" +
                "user.ranap_per_ruang,\n" +
                "user.penyakit_ranap_cara_bayar,\n" +
                "user.anggota_militer_dirawat,\n" +
                "user.set_input_parsial,\n" +
                "user.lama_pelayanan_radiologi,\n" +
                "user.lama_pelayanan_lab,\n" +
                "user.bpjs_cek_sep,\n" +
                "user.catatan_perawatan,\n" +
                "user.surat_keluar,\n" +
                "user.kegiatan_farmasi,\n" +
                "user.stok_opname_logistik,\n" +
                "user.sirkulasi_non_medis,\n" +
                "user.rekap_lab_pertahun,\n" +
                "user.perujuk_lab_pertahun,\n" +
                "user.rekap_radiologi_pertahun,\n" +
                "user.perujuk_radiologi_pertahun,\n" +
                "user.jumlah_porsi_diet,\n" +
                "user.jumlah_macam_diet,\n" +
                "user.payment_point2,\n" +
                "user.pembayaran_akun_bayar2,\n" +
                "user.hapus_nota_salah,\n" +
                "user.pengkajian_askep,\n" +
                "user.hais_perbangsal,\n" +
                "user.ppn_obat,\n" +
                "user.saldo_akun_perbulan,\n" +
                "user.display_apotek,\n" +
                "user.sisrute_referensi_faskes,\n" +
                "user.sisrute_referensi_alasanrujuk,\n" +
                "user.sisrute_referensi_diagnosa,\n" +
                "user.sisrute_rujukan_masuk,\n" +
                "user.sisrute_rujukan_keluar,\n" +
                "user.bpjs_cek_skdp,\n" +
                "user.data_batch,\n" +
                "user.kunjungan_permintaan_lab,\n" +
                "user.kunjungan_permintaan_lab2,\n" +
                "user.kunjungan_permintaan_radiologi,\n" +
                "user.kunjungan_permintaan_radiologi2,\n" +
                "user.pcare_pemberian_obat,\n" +
                "user.pcare_pemberian_tindakan,\n" +
                "user.pembayaran_akun_bayar3,\n" +
                "user.password_asuransi,\n" +
                "user.kemenkes_sitt,\n" +
                "user.siranap_ketersediaan_kamar,\n" +
                "user.grafik_tb_periodelaporan,\n" +
                "user.grafik_tb_rujukan,\n" +
                "user.grafik_tb_riwayat,\n" +
                "user.grafik_tb_tipediagnosis,\n" +
                "user.grafik_tb_statushiv,\n" +
                "user.grafik_tb_skoringanak,\n" +
                "user.grafik_tb_konfirmasiskoring5,\n" +
                "user.grafik_tb_konfirmasiskoring6,\n" +
                "user.grafik_tb_sumberobat,\n" +
                "user.grafik_tb_hasilakhirpengobatan,\n" +
                "user.grafik_tb_hasilteshiv,\n" +
                "user.kadaluarsa_batch,\n" +
                "user.sisa_stok,\n" +
                "user.obat_per_resep,\n" +
                "user.pemakaian_air_pdam,\n" +
                "user.limbah_b3_medis,\n" +
                "user.grafik_air_pdam_pertanggal,\n" +
                "user.grafik_air_pdam_perbulan,\n" +
                "user.grafik_limbahb3_pertanggal,\n" +
                "user.grafik_limbahb3_perbulan,\n" +
                "user.limbah_domestik,\n" +
                "user.grafik_limbahdomestik_pertanggal,\n" +
                "user.grafik_limbahdomestik_perbulan,\n" +
                "user.mutu_air_limbah,\n" +
                "user.pest_control,\n" +
                "user.ruang_perpustakaan,\n" +
                "user.kategori_perpustakaan,\n" +
                "user.jenis_perpustakaan,\n" +
                "user.pengarang_perpustakaan,\n" +
                "user.penerbit_perpustakaan,\n" +
                "user.koleksi_perpustakaan,\n" +
                "user.inventaris_perpustakaan,\n" +
                "user.set_peminjaman_perpustakaan,\n" +
                "user.denda_perpustakaan,\n" +
                "user.anggota_perpustakaan,\n" +
                "user.peminjaman_perpustakaan,\n" +
                "user.bayar_denda_perpustakaan,\n" +
                "user.ebook_perpustakaan,\n" +
                "user.jenis_cidera_k3rs,\n" +
                "user.penyebab_k3rs,\n" +
                "user.jenis_luka_k3rs,\n" +
                "user.lokasi_kejadian_k3rs,\n" +
                "user.dampak_cidera_k3rs,\n" +
                "user.jenis_pekerjaan_k3rs,\n" +
                "user.bagian_tubuh_k3rs,\n" +
                "user.peristiwa_k3rs,\n" +
                "user.grafik_k3_pertahun,\n" +
                "user.grafik_k3_perbulan,\n" +
                "user.grafik_k3_pertanggal,\n" +
                "user.grafik_k3_perjeniscidera,\n" +
                "user.grafik_k3_perpenyebab,\n" +
                "user.grafik_k3_perjenisluka,\n" +
                "user.grafik_k3_lokasikejadian,\n" +
                "user.grafik_k3_dampakcidera,\n" +
                "user.grafik_k3_perjenispekerjaan,\n" +
                "user.grafik_k3_perbagiantubuh,\n" +
                "user.jenis_cidera_k3rstahun,\n" +
                "user.penyebab_k3rstahun,\n" +
                "user.jenis_luka_k3rstahun,\n" +
                "user.lokasi_kejadian_k3rstahun,\n" +
                "user.dampak_cidera_k3rstahun,\n" +
                "user.jenis_pekerjaan_k3rstahun,\n" +
                "user.bagian_tubuh_k3rstahun,\n" +
                "user.sekrining_rawat_jalan,\n" +
                "user.bpjs_histori_pelayanan,\n" +
                "user.rekap_mutasi_berkas,\n" +
                "user.skrining_ralan_pernapasan_pertahun,\n" +
                "user.pengajuan_barang_medis,\n" +
                "user.pengajuan_barang_nonmedis,\n" +
                "user.grafik_kunjungan_ranapbulan,\n" +
                "user.grafik_kunjungan_ranaptanggal,\n" +
                "user.grafik_kunjungan_ranap_peruang,\n" +
                "user.kunjungan_bangsal_pertahun,\n" +
                "user.grafik_jenjang_jabatanpegawai,\n" +
                "user.grafik_bidangpegawai,\n" +
                "user.grafik_departemenpegawai,\n" +
                "user.grafik_pendidikanpegawai,\n" +
                "user.grafik_sttswppegawai,\n" +
                "user.grafik_sttskerjapegawai,\n" +
                "user.grafik_sttspulangranap,\n" +
                "user.kip_pasien_ranap,\n" +
                "user.kip_pasien_ralan,\n" +
                "user.bpjs_mapping_dokterdpjp,\n" +
                "user.data_triase_igd,\n" +
                "user.master_triase_skala1,\n" +
                "user.master_triase_skala2,\n" +
                "user.master_triase_skala3,\n" +
                "user.master_triase_skala4,\n" +
                "user.master_triase_skala5,\n" +
                "user.master_triase_pemeriksaan,\n" +
                "user.master_triase_macamkasus,\n" +
                "user.rekap_permintaan_diet,\n" +
                "user.daftar_pasien_ranap,\n" +
                "user.daftar_pasien_ranaptni,\n" +
                "user.pengajuan_asetinventaris,\n" +
                "user.item_apotek_jenis,\n" +
                "user.item_apotek_kategori,\n" +
                "user.item_apotek_golongan,\n" +
                "user.item_apotek_industrifarmasi,\n" +
                "user.10_obat_terbanyak_poli,\n" +
                "user.grafik_pengajuan_aset_urgensi,\n" +
                "user.grafik_pengajuan_aset_status,\n" +
                "user.grafik_pengajuan_aset_departemen,\n" +
                "user.rekap_pengajuan_aset_departemen,\n" +
                "user.grafik_kelompok_jabatanpegawai,\n" +
                "user.grafik_resiko_kerjapegawai,\n" +
                "user.grafik_emergency_indexpegawai,\n" +
                "user.grafik_inventaris_ruang,\n" +
                "user.harian_HAIs2,\n" +
                "user.grafik_inventaris_jenis,\n" +
                "user.data_resume_pasien,\n" +
                "user.perkiraan_biaya_ranap,\n" +
                "user.rekap_obat_poli,\n" +
                "user.rekap_obat_pasien,\n" +
                "user.permintaan_perbaikan_inventaris,\n" +
                "user.grafik_HAIs_pasienbangsal,\n" +
                "user.grafik_HAIs_pasienbulan,\n" +
                "user.grafik_HAIs_laju_vap,\n" +
                "user.grafik_HAIs_laju_iad,\n" +
                "user.grafik_HAIs_laju_pleb,\n" +
                "user.grafik_HAIs_laju_isk,\n" +
                "user.grafik_HAIs_laju_ilo,\n" +
                "user.grafik_HAIs_laju_hap,\n" +
                "user.inhealth_mapping_poli,\n" +
                "user.inhealth_mapping_dokter,\n" +
                "user.inhealth_mapping_tindakan_ralan,\n" +
                "user.inhealth_mapping_tindakan_ranap,\n" +
                "user.inhealth_mapping_tindakan_radiologi,\n" +
                "user.inhealth_mapping_tindakan_laborat,\n" +
                "user.inhealth_mapping_tindakan_operasi,\n" +
                "user.hibah_obat_bhp,\n" +
                "user.asal_hibah,\n" +
                "user.asuhan_gizi,\n" +
                "user.inhealth_kirim_tagihan,\n" +
                "user.sirkulasi_obat4,\n" +
                "user.sirkulasi_obat5,\n" +
                "user.sirkulasi_non_medis2,\n" +
                "user.monitoring_asuhan_gizi,\n" +
                "user.penerimaan_obat_perbulan,\n" +
                "user.rekap_kunjungan,\n" +
                "user.surat_sakit,\n" +
                "user.penilaian_awal_keperawatan_ralan,\n" +
                "user.permintaan_diet,\n" +
                "user.master_masalah_keperawatan,\n" +
                "user.pengajuan_cuti,\n" +
                "user.kedatangan_pasien,\n" +
                "user.utd_pendonor,\n" +
                "user.toko_suplier,\n" +
                "user.toko_jenis,\n" +
                "user.toko_set_harga,\n" +
                "user.toko_barang,\n" +
                "user.penagihan_piutang_pasien,\n" +
                "user.akun_penagihan_piutang,\n" +
                "user.stok_opname_toko,\n" +
                "user.toko_riwayat_barang,\n" +
                "user.toko_surat_pemesanan,\n" +
                "user.toko_pengajuan_barang,\n" +
                "user.toko_penerimaan_barang,\n" +
                "user.toko_pengadaan_barang,\n" +
                "user.toko_hutang,\n" +
                "user.toko_bayar_pemesanan,\n" +
                "user.toko_member,\n" +
                "user.toko_penjualan,\n" +
                "user.registrasi_poli_per_tanggal,\n" +
                "user.toko_piutang,\n" +
                "user.toko_retur_beli,\n" +
                "user.ipsrs_returbeli,\n" +
                "user.ipsrs_riwayat_barang,\n" +
                "user.pasien_corona,\n" +
                "user.toko_pendapatan_harian,\n" +
                "user.diagnosa_pasien_corona,\n" +
                "user.perawatan_pasien_corona,\n" +
                "user.penilaian_awal_keperawatan_gigi,\n" +
                "user.master_masalah_keperawatan_gigi,\n" +
                "user.toko_bayar_piutang,\n" +
                "user.toko_piutang_harian,\n" +
                "user.toko_penjualan_harian,\n" +
                "user.deteksi_corona,\n" +
                "user.penilaian_awal_keperawatan_kebidanan,\n" +
                "user.pengumuman_epasien,\n" +
                "user.surat_hamil,\n" +
                "user.set_tarif_online,\n" +
                "user.booking_periksa,\n" +
                "user.toko_sirkulasi,\n" +
                "user.toko_retur_jual,\n" +
                "user.toko_retur_piutang,\n" +
                "user.toko_sirkulasi2,\n" +
                "user.toko_keuntungan_barang,\n" +
                "user.zis_pengeluaran_penerima_dankes,\n" +
                "user.zis_penghasilan_penerima_dankes,\n" +
                "user.zis_ukuran_rumah_penerima_dankes,\n" +
                "user.zis_dinding_rumah_penerima_dankes,\n" +
                "user.zis_lantai_rumah_penerima_dankes,\n" +
                "user.zis_atap_rumah_penerima_dankes,\n" +
                "user.zis_kepemilikan_rumah_penerima_dankes,\n" +
                "user.zis_kamar_mandi_penerima_dankes,\n" +
                "user.zis_dapur_rumah_penerima_dankes,\n" +
                "user.zis_kursi_rumah_penerima_dankes,\n" +
                "user.zis_kategori_phbs_penerima_dankes,\n" +
                "user.zis_elektronik_penerima_dankes,\n" +
                "user.zis_ternak_penerima_dankes,\n" +
                "user.zis_jenis_simpanan_penerima_dankes,\n" +
                "user.penilaian_awal_keperawatan_anak,\n" +
                "user.zis_kategori_asnaf_penerima_dankes,\n" +
                "user.master_masalah_keperawatan_anak,\n" +
                "user.master_imunisasi,\n" +
                "user.zis_patologis_penerima_dankes,\n" +
                "user.pcare_cek_kartu,\n" +
                "user.surat_bebas_narkoba,\n" +
                "user.surat_keterangan_covid,\n" +
                "user.pemakaian_air_tanah,\n" +
                "user.grafik_air_tanah_pertanggal,\n" +
                "user.grafik_air_tanah_perbulan,\n" +
                "user.lama_pelayanan_poli,\n" +
                "user.hemodialisa,\n" +
                "user.laporan_tahunan_irj,\n" +
                "user.grafik_harian_hemodialisa,\n" +
                "user.grafik_bulanan_hemodialisa,\n" +
                "user.grafik_tahunan_hemodialisa,\n" +
                "user.grafik_bulanan_meninggal,\n" +
                "user.perbaikan_inventaris,\n" +
                "user.surat_cuti_hamil,\n" +
                "user.permintaan_stok_obat_pasien,\n" +
                "user.pemeliharaan_inventaris,\n" +
                "user.klasifikasi_pasien_ranap,\n" +
                "user.bulanan_klasifikasi_pasien_ranap,\n" +
                "user.harian_klasifikasi_pasien_ranap,\n" +
                "user.klasifikasi_pasien_perbangsal,\n" +
                "user.soap_perawatan,\n" +
                "user.klaim_rawat_jalan,\n" +
                "user.skrining_gizi,\n" +
                "user.lama_penyiapan_rm,\n" +
                "user.dosis_radiologi,\n" +
                "user.demografi_umur_kunjungan,\n" +
                "user.jam_diet_pasien,\n" +
                "user.rvu_bpjs,\n" +
                "user.verifikasi_penerimaan_farmasi,\n" +
                "user.verifikasi_penerimaan_logistik,\n" +
                "user.pemeriksaan_lab_pa,\n" +
                "user.ringkasan_pengajuan_obat,\n" +
                "user.ringkasan_pemesanan_obat,\n" +
                "user.ringkasan_pengadaan_obat,\n" +
                "user.ringkasan_penerimaan_obat,\n" +
                "user.ringkasan_hibah_obat,\n" +
                "user.ringkasan_penjualan_obat,\n" +
                "user.ringkasan_beri_obat,\n" +
                "user.ringkasan_piutang_obat,\n" +
                "user.ringkasan_stok_keluar_obat,\n" +
                "user.ringkasan_retur_suplier_obat,\n" +
                "user.ringkasan_retur_pembeli_obat,\n" +
                "user.penilaian_awal_keperawatan_ranapkebidanan,\n" +
                "user.ringkasan_pengajuan_nonmedis,\n" +
                "user.ringkasan_pemesanan_nonmedis,\n" +
                "user.ringkasan_pengadaan_nonmedis,\n" +
                "user.ringkasan_penerimaan_nonmedis,\n" +
                "user.ringkasan_stokkeluar_nonmedis,\n" +
                "user.ringkasan_returbeli_nonmedis,\n" +
                "user.omset_penerimaan,\n" +
                "user.validasi_penagihan_piutang,\n" +
                "user.permintaan_ranap,\n" +
                "user.bpjs_diagnosa_prb,\n" +
                "user.bpjs_obat_prb,\n" +
                "user.bpjs_surat_kontrol,\n" +
                "user.penggunaan_bhp_ok,\n" +
                "user.surat_keterangan_rawat_inap,\n" +
                "user.surat_keterangan_sehat,\n" +
                "user.pendapatan_per_carabayar,\n" +
                "user.akun_host_to_host_bank_jateng,\n" +
                "user.pembayaran_bank_jateng,\n" +
                "user.bpjs_surat_pri,\n" +
                "user.ringkasan_tindakan,\n" +
                "user.lama_pelayanan_pasien,\n" +
                "user.surat_sakit_pihak_2,\n" +
                "user.tagihan_hutang_obat,\n" +
                "user.referensi_mobilejkn_bpjs,\n" +
                "user.batal_pendaftaran_mobilejkn_bpjs,\n" +
                "user.lama_operasi,\n" +
                "user.grafik_inventaris_kategori,\n" +
                "user.grafik_inventaris_merk,\n" +
                "user.grafik_inventaris_produsen,\n" +
                "user.pengembalian_deposit_pasien,\n" +
                "user.validasi_tagihan_hutang_obat,\n" +
                "user.piutang_obat_belum_lunas,\n" +
                "user.integrasi_briapi,\n" +
                "user.pengadaan_aset_inventaris,\n" +
                "user.akun_aset_inventaris,\n" +
                "user.suplier_inventaris,\n" +
                "user.penerimaan_aset_inventaris,\n" +
                "user.bayar_pemesanan_iventaris,\n" +
                "user.hutang_aset_inventaris,\n" +
                "user.hibah_aset_inventaris,\n" +
                "user.titip_faktur_non_medis,\n" +
                "user.validasi_tagihan_non_medis,\n" +
                "user.titip_faktur_aset,\n" +
                "user.validasi_tagihan_aset,\n" +
                "user.hibah_non_medis,\n" +
                "user.pcare_alasan_tacc,\n" +
                "user.resep_luar,\n" +
                "user.surat_bebas_tbc,\n" +
                "user.surat_buta_warna,\n" +
                "user.surat_bebas_tato,\n" +
                "user.surat_kewaspadaan_kesehatan,\n" +
                "user.grafik_porsidiet_pertanggal,\n" +
                "user.grafik_porsidiet_perbulan,\n" +
                "user.grafik_porsidiet_pertahun,\n" +
                "user.grafik_porsidiet_perbangsal,\n" +
                "user.penilaian_awal_medis_ralan,\n" +
                "user.master_masalah_keperawatan_mata,\n" +
                "user.penilaian_awal_keperawatan_mata,\n" +
                "user.penilaian_awal_medis_ranap,\n" +
                "user.penilaian_awal_medis_ranap_kebidanan,\n" +
                "user.penilaian_awal_medis_ralan_kebidanan,\n" +
                "user.penilaian_awal_medis_igd,\n" +
                "user.penilaian_awal_medis_ralan_anak,\n" +
                "user.bpjs_referensi_poli_hfis,\n" +
                "user.bpjs_referensi_dokter_hfis,\n" +
                "user.bpjs_referensi_jadwal_hfis,\n" +
                "user.penilaian_fisioterapi,\n" +
                "user.bpjs_program_prb,\n" +
                "user.bpjs_suplesi_jasaraharja,\n" +
                "user.bpjs_data_induk_kecelakaan,\n" +
                "user.bpjs_sep_internal,\n" +
                "user.bpjs_klaim_jasa_raharja,\n" +
                "user.bpjs_daftar_finger_print,\n" +
                "user.bpjs_rujukan_khusus,\n" +
                "user.pemeliharaan_gedung,\n" +
                "user.grafik_perbaikan_inventaris_pertanggal,\n" +
                "user.grafik_perbaikan_inventaris_perbulan,\n" +
                "user.grafik_perbaikan_inventaris_pertahun,\n" +
                "user.grafik_perbaikan_inventaris_perpelaksana_status,\n" +
                "user.penilaian_mcu,\n" +
                "user.peminjam_piutang,\n" +
                "user.piutang_lainlain,\n" +
                "user.cara_bayar,\n" +
                "user.audit_kepatuhan_apd,\n" +
                "user.bpjs_task_id,\n" +
                "user.bayar_piutang_lain,\n" +
                "user.pembayaran_akun_bayar4,\n" +
                "user.stok_akhir_farmasi_pertanggal,\n" +
                "user.riwayat_kamar_pasien,\n" +
                "user.uji_fungsi_kfr,\n" +
                "user.hapus_berkas_digital_perawatan,\n" +
                "user.kategori_pengeluaran_harian,\n" +
                "user.kategori_pemasukan_lain,\n" +
                "user.pembayaran_akun_bayar5,\n" +
                "user.ruang_ok,\n" +
                "user.telaah_resep,\n" +
                "user.jasa_tindakan_pasien,\n" +
                "user.permintaan_resep_pulang,\n" +
                "user.rekap_jm_dokter,\n" +
                "user.status_data_rm,\n" +
                "user.ubah_petugas_lab_pk,\n" +
                "user.ubah_petugas_lab_pa,\n" +
                "user.ubah_petugas_radiologi,\n" +
                "user.gabung_norawat,\n" +
                "user.gabung_rm,\n" +
                "user.ringkasan_biaya_obat_pasien_pertanggal,\n" +
                "user.master_masalah_keperawatan_igd,\n" +
                "user.penilaian_awal_keperawatan_igd,\n" +
                "user.bpjs_referensi_dpho_apotek,\n" +
                "user.bpjs_referensi_poli_apotek,\n" +
                "user.bayar_jm_dokter,\n" +
                "user.bpjs_referensi_faskes_apotek,\n" +
                "user.bpjs_referensi_spesialistik_apotek,\n" +
                "user.pembayaran_briva,\n" +
                "user.penilaian_awal_keperawatan_ranap,\n" +
                "user.nilai_penerimaan_vendor_farmasi_perbulan,\n" +
                "user.akun_bayar_hutang,\n" +
                "user.master_rencana_keperawatan,\n" +
                "user.laporan_tahunan_igd,\n" +
                "user.obat_bhp_tidakbergerak,\n" +
                "user.ringkasan_hutang_vendor_farmasi,\n" +
                "user.nilai_penerimaan_vendor_nonmedis_perbulan,\n" +
                "user.ringkasan_hutang_vendor_nonmedis,\n" +
                "user.master_rencana_keperawatan_anak,\n" +
                "user.anggota_polri_dirawat,\n" +
                "user.daftar_pasien_ranap_polri,\n" +
                "user.soap_ralan_polri,\n" +
                "user.soap_ranap_polri,\n" +
                "user.laporan_penyakit_polri,\n" +
                "user.jumlah_pengunjung_ralan_polri,\n" +
                "user.catatan_observasi_igd,\n" +
                "user.catatan_observasi_ranap,\n" +
                "user.catatan_observasi_ranap_kebidanan,\n" +
                "user.catatan_observasi_ranap_postpartum,\n" +
                "user.penilaian_awal_medis_ralan_tht,\n" +
                "user.penilaian_psikologi,\n" +
                "user.audit_cuci_tangan_medis,\n" +
                "user.audit_pembuangan_limbah,\n" +
                "user.ruang_audit_kepatuhan,\n" +
                "user.audit_pembuangan_benda_tajam,\n" +
                "user.audit_penanganan_darah,\n" +
                "user.audit_pengelolaan_linen_kotor,\n" +
                "user.audit_penempatan_pasien,\n" +
                "user.audit_kamar_jenazah,\n" +
                "user.audit_bundle_iadp,\n" +
                "user.audit_bundle_ido,\n" +
                "user.audit_fasilitas_kebersihan_tangan,\n" +
                "user.audit_fasilitas_apd,\n" +
                "user.audit_pembuangan_limbah_cair_infeksius,\n" +
                "user.audit_sterilisasi_alat,\n" +
                "user.penilaian_awal_medis_ralan_psikiatri,\n" +
                "user.persetujuan_penolakan_tindakan,\n" +
                "user.audit_bundle_isk,\n" +
                "user.audit_bundle_plabsi,\n" +
                "user.audit_bundle_vap,\n" +
                "user.akun_host_to_host_bank_papua,\n" +
                "user.pembayaran_bank_papua,\n" +
                "user.penilaian_awal_medis_ralan_penyakit_dalam,\n" +
                "user.penilaian_awal_medis_ralan_mata,\n" +
                "user.penilaian_awal_medis_ralan_neurologi,\n" +
                "user.sirkulasi_obat6,\n" +
                "user.penilaian_awal_medis_ralan_orthopedi,\n" +
                "user.penilaian_awal_medis_ralan_bedah,\n" +
                "user.integrasi_khanza_health_services,\n" +
                "user.soap_ralan_tni,\n" +
                "user.soap_ranap_tni,\n" +
                "user.jumlah_pengunjung_ralan_tni,\n" +
                "user.laporan_penyakit_tni,\n" +
                "user.catatan_keperawatan_ranap,\n" +
                "user.master_rencana_keperawatan_gigi,\n" +
                "user.master_rencana_keperawatan_mata,\n" +
                "user.master_rencana_keperawatan_igd,\n" +
                "user.master_masalah_keperawatan_psikiatri,\n" +
                "user.master_rencana_keperawatan_psikiatri,\n" +
                "user.penilaian_awal_keperawatan_psikiatri,\n" +
                "user.pemantauan_pews_anak,\n" +
                "user.surat_pulang_atas_permintaan_sendiri,\n" +
                "user.template_hasil_radiologi,\n" +
                "user.laporan_bulanan_irj,\n" +
                "user.template_pemeriksaan,\n" +
                "user.pemeriksaan_lab_mb,\n" +
                "user.ubah_petugas_lab_mb,\n" +
                "user.penilaian_pre_operasi,\n" +
                "user.penilaian_pre_anestesi,\n" +
                "user.perencanaan_pemulangan,\n" +
                "user.penilaian_lanjutan_resiko_jatuh_dewasa,\n" +
                "user.penilaian_lanjutan_resiko_jatuh_anak,\n" +
                "user.penilaian_awal_medis_ralan_geriatri,\n" +
                "user.penilaian_tambahan_pasien_geriatri,\n" +
                "user.skrining_nutrisi_dewasa,\n" +
                "user.skrining_nutrisi_lansia,\n" +
                "user.hasil_pemeriksaan_usg,\n" +
                "user.skrining_nutrisi_anak,\n" +
                "user.akun_host_to_host_bank_jabar,\n" +
                "user.pembayaran_bank_jabar,\n" +
                "user.surat_pernyataan_pasien_umum,\n" +
                "user.konseling_farmasi,\n" +
                "user.pelayanan_informasi_obat,\n" +
                "user.jawaban_pio_apoteker,\n" +
                "user.surat_persetujuan_umum,\n" +
                "user.transfer_pasien_antar_ruang,\n" +
                "user.satu_sehat_referensi_dokter,\n" +
                "user.satu_sehat_referensi_pasien,\n" +
                "user.satu_sehat_mapping_departemen,\n" +
                "user.satu_sehat_mapping_lokasi,\n" +
                "user.satu_sehat_kirim_encounter,\n" +
                "user.catatan_cek_gds,\n" +
                "user.satu_sehat_kirim_condition,\n" +
                "user.checklist_pre_operasi,\n" +
                "user.satu_sehat_kirim_observationttv,\n" +
                "user.signin_sebelum_anestesi,\n" +
                "user.satu_sehat_kirim_procedure,\n" +
                "user.operasi_per_bulan,\n" +
                "user.timeout_sebelum_insisi,\n" +
                "user.signout_sebelum_menutup_luka,\n" +
                "user.dapur_barang,\n" +
                "user.dapur_opname,\n" +
                "user.satu_sehat_mapping_vaksin,\n" +
                "user.dapur_suplier,\n" +
                "user.satu_sehat_kirim_Immunization,\n" +
                "user.checklist_post_operasi,\n" +
                "user.dapur_pembelian,\n" +
                "user.dapur_stok_keluar,\n" +
                "user.dapur_riwayat_barang,\n" +
                "user.permintaan_dapur,\n" +
                "user.rekonsiliasi_obat,\n" +
                "user.biaya_pengadaan_dapur,\n" +
                "user.rekap_pengadaan_dapur,\n" +
                "user.kesling_limbah_b3medis_cair,\n" +
                "user.grafik_limbahb3cair_pertanggal,\n" +
                "user.grafik_limbahb3cair_perbulan,\n" +
                "user.rekap_biaya_registrasi,\n" +
                "user.konfirmasi_rekonsiliasi_obat,\n" +
                "user.satu_sehat_kirim_clinicalimpression,\n" +
                "user.penilaian_pasien_terminal,\n" +
                "user.surat_persetujuan_rawat_inap,\n" +
                "user.monitoring_reaksi_tranfusi,\n" +
                "user.penilaian_korban_kekerasan,\n" +
                "user.penilaian_lanjutan_resiko_jatuh_lansia,\n" +
                "user.penilaian_pasien_penyakit_menular,\n" +
                "user.mpp_skrining,\n" +
                "user.edukasi_pasien_keluarga_rj,\n" +
                "user.pemantauan_pews_dewasa,\n" +
                "user.penilaian_tambahan_bunuh_diri,\n" +
                "user.bpjs_antrean_pertanggal,\n" +
                "user.penilaian_tambahan_perilaku_kekerasan,\n" +
                "user.penilaian_tambahan_beresiko_melarikan_diri,\n" +
                "user.persetujuan_penundaan_pelayanan,\n" +
                "user.sisa_diet_pasien,\n" +
                "user.penilaian_awal_medis_ralan_bedah_mulut,\n" +
                "user.penilaian_pasien_keracunan,\n" +
                "user.pemantauan_meows_obstetri,\n" +
                "user.catatan_adime_gizi,\n" +
                "user.pengajuan_biaya,\n" +
                "user.penilaian_awal_keperawatan_ralan_geriatri,\n" +
                "user.master_masalah_keperawatan_geriatri,\n" +
                "user.checklist_kriteria_keluar_hcu,\n" +
                "user.penilaian_risiko_dekubitus,\n" +
                "user.master_menolak_anjuran_medis,\n" +
                "user.master_rencana_keperawatan_geriatri,\n" +
                "user.penolakan_anjuran_medis,\n" +
                "user.laporan_tahunan_penolakan_anjuran_medis,\n" +
                "user.template_laporan_operasi,\n" +
                "user.hasil_tindakan_eswl,\n" +
                "user.checklist_kriteria_masuk_icu,\n" +
                "user.checklist_kriteria_keluar_icu,\n" +
                "user.akses_dokter_lain_rawat_jalan,\n" +
                "user.follow_up_dbd,\n" +
                "user.pemeriksaan_fisik_ralan_per_penyakit,\n" +
                "user.penilaian_lanjutan_resiko_jatuh_geriatri,\n" +
                "user.pemantauan_ews_neonatus,\n" +
                "user.validasi_persetujuan_pengajuan_biaya,\n" +
                "user.riwayat_perawatan_icare_bpjs,\n" +
                "user.rekap_pengajuan_biaya,\n" +
                "user.penilaian_awal_medis_ralan_kulit_kelamin,\n" +
                "user.akun_host_to_host_bank_mandiri,\n" +
                "user.penilaian_medis_hemodialisa,\n" +
                "user.penilaian_level_kecemasan_ranap_anak,\n" +
                "user.penilaian_lanjutan_resiko_jatuh_psikiatri,\n" +
                "user.penilaian_lanjutan_skrining_fungsional,\n" +
                "user.penilaian_medis_ralan_rehab_medik,\n" +
                "user.laporan_anestesi,\n" +
                "user.template_persetujuan_penolakan_tindakan,\n" +
                "user.penilaian_medis_ralan_gawat_darurat_psikiatri,\n" +
                "user.bpjs_referensi_setting_apotek,\n" +
                "user.bpjs_referensi_obat_apotek,\n" +
                "user.bpjs_mapping_obat_apotek,\n" +
                "user.pembayaran_bank_mandiri,\n" +
                "user.penilaian_ulang_nyeri,\n" +
                "user.checklist_kriteria_masuk_hcu,\n" +
                "user.penilaian_risiko_jatuh_neonatus,\n" +
                "user.persetujuan_pengajuan_biaya,\n" +
                "user.penilaian_terapi_wicara,\n" +
                "user.bpjs_obat_23hari_apotek,\n" +
                "user.pengkajian_restrain,\n" +
                "user.bpjs_kunjungan_sep_apotek,\n" +
                "user.bpjs_monitoring_klaim_apotek,\n" +
                "user.bpjs_daftar_pelayanan_obat_apotek,\n" +
                "user.penilaian_awal_medis_ralan_paru,\n" +
                "user.catatan_keperawatan_ralan,\n" +
                "user.catatan_persalinan,\n" +
                "user.skor_aldrette_pasca_anestesi,\n" +
                "user.skor_steward_pasca_anestesi,\n" +
                "user.skor_bromage_pasca_anestesi,\n" +
                "user.penilaian_pre_induksi,\n" +
                "user.hasil_usg_urologi,\n" +
                "user.hasil_usg_gynecologi,\n" +
                "user.hasil_pemeriksaan_ekg,\n" +
                "user.hapus_edit_sep_bpjs,\n" +
                "user.satu_sehat_kirim_diet,\n" +
                "user.satu_sehat_mapping_obat,\n" +
                "user.dapur_ringkasan_pembelian,\n" +
                "user.satu_sehat_mapping_radiologi,\n" +
                "user.satu_sehat_kirim_servicerequest_radiologi,\n" +
                "user.hasil_endoskopi_hidung,\n" +
                "user.satu_sehat_kirim_specimen_radiologi,\n" +
                "user.master_masalah_keperawatan_neonatus,\n" +
                "user.master_rencana_keperawatan_neonatus,\n" +
                "user.penilaian_awal_keperawatan_ranap_neonatus,\n" +
                "user.satu_sehat_kirim_medication,\n" +
                "user.satu_sehat_kirim_observation_radiologi,\n" +
                "user.satu_sehat_kirim_diagnosticreport_radiologi,\n" +
                "user.hasil_endoskopi_telinga,\n" +
                "user.satu_sehat_mapping_lab,\n" +
                "user.satu_sehat_kirim_servicerequest_lab,\n" +
                "user.satu_sehat_kirim_servicerequest_labmb,\n" +
                "user.satu_sehat_kirim_specimen_lab,\n" +
                "user.satu_sehat_kirim_specimen_labmb,\n" +
                "user.satu_sehat_kirim_observation_lab,\n" +
                "user.satu_sehat_kirim_observation_labmb,\n" +
                "user.satu_sehat_kirim_diagnosticreport_lab,\n" +
                "user.satu_sehat_kirim_diagnosticreport_labmb,\n" +
                "user.kepatuhan_kelengkapan_keselamatan_bedah,\n" +
                "user.nilai_piutang_perjenis_bayar_per_bulan,\n" +
                "user.ringkasan_piutang_jenis_bayar,\n" +
                "user.penilaian_pasien_imunitas_rendah,\n" +
                "user.balance_cairan,\n" +
                "user.catatan_observasi_chbp,\n" +
                "user.catatan_observasi_induksi_persalinan,\n" +
                "user.skp_kategori_penilaian,\n" +
                "user.skp_kriteria_penilaian,\n" +
                "user.skp_penilaian,\n" +
                "user.referensi_poli_mobilejknfktp,\n" +
                "user.referensi_dokter_mobilejknfktp,\n" +
                "user.skp_rekapitulasi_penilaian,\n" +
                "user.pembayaran_pihak_ke3_bankmandiri,\n" +
                "user.metode_pembayaran_bankmandiri,\n" +
                "user.bank_tujuan_transfer_bankmandiri,\n" +
                "user.kodetransaksi_tujuan_transfer_bankmandiri,\n" +
                "user.konsultasi_medik,\n" +
                "user.jawaban_konsultasi_medik,\n" +
                "user.pcare_cek_alergi,\n" +
                "user.pcare_cek_prognosa,\n" +
                "user.data_sasaran_usiaproduktif,\n" +
                "user.data_sasaran_usialansia,\n" +
                "user.skrining_perilaku_merokok_sekolah_remaja,\n" +
                "user.skrining_kekerasan_pada_perempuan,\n" +
                "user.skrining_obesitas,\n" +
                "user.skrining_risiko_kanker_payudara,\n" +
                "user.skrining_risiko_kanker_paru,\n" +
                "user.skrining_tbc,\n" +
                "user.skrining_kesehatan_gigi_mulut_remaja,\n" +
                "user.penilaian_awal_keperawatan_ranap_bayi,\n" +
                "user.satu_sehat_kirim_medicationrequest,\n" +
                "user.penatalaksanaan_terapi_okupasi,\n" +
                "user.satu_sehat_kirim_medicationdispense,\n" +
            ...
            System.out.println("query user: "+query_user);
            ps=koneksi.prepareStatement(query_user);
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    user="";
